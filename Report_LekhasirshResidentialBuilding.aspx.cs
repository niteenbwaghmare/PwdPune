...
{
    public partial class Report_LekhasirshResidentialBuilding : System.Web.UI.Page
    {
        ...
        public void subtype()
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select LekhaShirsh from SettingLekhaShirsh where Type='Residential_Building'", con);
        ...
        public void Upvibhag()
        {
            ...
            {
                sda = new SqlDataAdapter("select  Upvibhag FROM BudgetMasterResidentialBuilding Group By Upvibhag", con);
            }

            else
            {
                sda = new SqlDataAdapter("select a.Upvibhag FROM BudgetMasterResidentialBuilding as a join ResidentialBuildingProvision as b on a.WorkID=b.WorkID where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'Group By Upvibhag", con);
            }
        ...
        public void Shakhabhiyanta()
        {
            ...
            ddlshakhaabhiyanta.Items.Add("निवडा");
             ...
             if (ddlReportType.Text == "संपूर्ण")
             {
                 sda = new SqlDataAdapter("select  UpabhyantaName FROM BudgetMasterResidentialBuilding Group By UpabhyantaName", con);
             }
             else
             {
                 sda = new SqlDataAdapter("select a.UpabhyantaName FROM BudgetMasterResidentialBuilding as a join ResidentialBuildingProvision as b on a.WorkID=b.WorkID where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'Group By UpabhyantaName", con);
             }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void WorkId()
        {
            ...
            if (ddlReportType.Text == "संपूर्ण")
            {
                sda = new SqlDataAdapter("select WorkId FROM BudgetMasterResidentialBuilding ", con);
            }

            else
            {
                sda = new SqlDataAdapter("select a.WorkId FROM BudgetMasterResidentialBuilding as a join ResidentialBuildingProvision as b on a.WorkID=b.WorkID where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void Tekedar()
        {
            ...
            ddlthekedar.Items.Add("निवडा");
              ...
              if (ddlReportType.Text == "संपूर्ण")
              {
                  sda = new SqlDataAdapter("select  ThekedaarName FROM BudgetMasterResidentialBuilding Group By ThekedaarName", con);
              }
              else
              {
                  sda = new SqlDataAdapter("select a.ThekedaarName FROM BudgetMasterResidentialBuilding as a join ResidentialBuildingProvision as b on a.WorkID=b.WorkID where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'Group By ThekedaarName", con);
              }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void Sadyasthithi()
        {
            ...
            if (ddlReportType.Text == "संपूर्ण")
            {
                sda = new SqlDataAdapter("select Sadyasthiti FROM BudgetMasterResidentialBuilding Group By Sadyasthiti", con);
            }

            else
            {
                sda = new SqlDataAdapter("select a.Sadyasthiti FROM BudgetMasterResidentialBuilding as a join ResidentialBuildingProvision as b on a.WorkID=b.WorkID where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'Group By Sadyasthiti", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void lekha()
        {
            SqlDataAdapter sda = new SqlDataAdapter("select lekhaShirsh from BudgetMasterResidentialBuilding where lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' ", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
        ...
        public void dataload()
        {
            ...
            if (Btnkam == "संपूर्ण")
            {
                ...
                if (ddlReportType.SelectedItem.Text == "संपूर्ण" || ddlkamacheYear.SelectedItem.Text == "संपूर्ण")
                {
                    ...
                    dt = ObjMPRGridBind.MPRBindGrid(ddlkamacheYear.Text, ddlReportType.Text, whereColumn, WhereColumnValue, query, "BudgetMasterResidentialBuilding");
                }
            ...
            Session["LekhasirshResBuildingRpt"] = GridView1;
        }
        ...
        protected void BtnExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "ResBuilding_MPR_Report.xls"));
        ...
        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            ...
            Session["filename"] = "ResBuilding_MPR_Report.xls";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                {
                    StreamWriter writer = File.AppendText(path + "ResBuilding_MPR_Report.xls");
