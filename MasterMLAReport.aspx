<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterMLAReport.aspx.cs" Inherits="PWdEEBudget.MasterMLAReport" EnableEventValidation="false" %>
            ...
            <div class="container">
                <div id="ListMenu" runat="server" style="margin-top: 20px" class="ddlListHide">
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-6">
                            <asp:DropDownList ID="ddlAmdar" runat="server" CssClass="form-control p" AutoPostBack="True" ForeColor="Black" OnSelectedIndexChanged="ddlAmdar_SelectedIndexChanged">
                                <asp:ListItem>निवडा</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-2">
            ...
            <asp:Panel ID="Panel1" runat="server" BorderStyle="Double">
                <div style="overflow-x: auto">
                    <asp:CheckBoxList ID="chkBuilding" runat="server" BorderStyle="Solid" BorderWidth="4px" RepeatDirection="Horizontal" class="table-bordered" OnSelectedIndexChanged="chkBuilding_SelectedIndexChanged">
                        ...
                        <asp:ListItem Selected="True" Value="a.[Arthsankalpiyyear] as 'अर्थसंकल्पीय बाब क्र./प्रथम समाविष्ट झालेल्या वर्ष'" Enabled="false" runat="server">अर्थसंकल्पीय बाब क्र./प्रथम समाविष्ट झालेल्या वर्ष</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="a.[Upvibhag] as 'उपविभाग'" Enabled="false" runat="server">उपविभाग</asp:ListItem>
                        <asp:ListItem Selected="True" Enabled="false" Value="a.[AmdaracheName] as 'आमदारांचे नाव'" runat="server">आमदारांचे नाव</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="cast(a.[NividaAmt] as decimal(10,2)) as 'निविदा रक्कम % कमी / जास्त'" runat="server">निविदा किंमत</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="b.[ManjurAmt] as 'सन 2017-2018 मधील अपेक्षित खर्च'" runat="server">सन 2017-2018 मधील अपेक्षित खर्च</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="b.[Magilkharch] as 'सन 2016 - 17  06/2016 अखेर खर्च'" runat="server">सन 2016 - 17  06/2016 अखेर खर्च</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="b.[AkunAnudan] as 'वितरीत तरतूद सन 2017-2018'" runat="server">वितरीत तरतूद सन 2017-2018</asp:ListItem>
