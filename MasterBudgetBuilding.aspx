<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" Inherits="PWdEEBudget.NewBudgetMaster" Codebehind="MasterBudgetBuilding.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <table id="Print" class="table table-bordered mar" style="border:2px solid gray">
            ...
            <tr style="text-align:center; background:linear-gradient(gray,white)" >
                 <td style="font-weight: bold; color:black" colspan="30" >
                     <asp:Label ID="Label10" runat="server" Text="Master Budget Building" Font-Bold="True" Font-Size="XX-Large" Height="70px"></asp:Label>
                 </td> 
           </tr>
            <tr>
                 ...
                 <td colspan="6" style="font-weight: bold; text-align:center; color :gray">
                     <asp:Label ID="ddlType" runat="server" class="blink_me" ForeColor="Red" Text ="Budget Building"></asp:Label>
                 </td>
           </tr>
            ...
            <tr>
             ...
             <tr  style="background-color :#dbd7d7">
                 ...
                 <td style="font-weight: bold; color:gray;font-size :18px" colspan="3" ><asp:TextBox ID="txtPrakalpPassword" OnTextChanged="txtPrakalpPassword_TextChanged" TextMode="Password" CssClass="form-control c" runat="server" AutoPostBack="True"></asp:TextBox></td>
               </tr>
               <tr>
                ...
                <tr>
                    ...
                    <td style="font-weight: bold; color:gray" colspan="9">
                     ...
                     <td style="font-weight: bold; color:gray" colspan="3">
                         किंमत रु. लक्ष </td>
                     <td style="font-weight: bold; color:gray" colspan="5">
                         <asp:TextBox ID="txtprashaskiykimat" runat="server" CssClass="form-control c" PlaceHolder="किंमत रु. लक्ष" TabIndex="22" onkeyup="checkDec(this);" required="" >0</asp:TextBox> </td>
                 </tr>
               <tr>
                     ...
                     <td colspan="5" > <asp:TextBox ID="txttantarikkimat" runat="server" CssClass="form-control c" PlaceHolder="किंमत रु. लक्ष" TabIndex="25" onkeyup="checkDec(this);" required="" >0</asp:TextBox> </td>
                     
               </tr>
                <tr  style="background-color :#dbd7d7">
                   <td style="font-weight: bold; color:black;font-size :18px" colspan="27" >निविदा शाखा</td>
                   <td style="font-weight: bold; color:gray;font-size :18px" colspan="3" ><asp:TextBox ID="txtnividashakhaPassword" OnTextChanged="txtnividashakhaPassword_TextChanged" CssClass="form-control c" runat="server" TextMode="Password" AutoPostBack="True"></asp:TextBox></td>
                </tr>
                <tr>
         ...
         <tr>
             ...
             <td colspan="7"><asp:TextBox ID="txtVidyutvitarit" runat="server" CssClass="form-control c" onkeyup="checkDec(this);" AutoPostBack="True" OnTextChanged="txtVidyutvitarit_TextChanged">0</asp:TextBox></td>
              <td colspan="3" style="font-weight: bold; color:gray">इतर खर्च</td>
             <td colspan="4"><asp:TextBox ID="txtitarkhrch" runat="server" CssClass="form-control c" onkeyup="checkDec(this);" AutoPostBack="True" OnTextChanged="txtitarkhrch_TextChanged">0</asp:TextBox></td>
                    </tr>
    ...
    <br />
               <div id="DivBtn">
                        <asp:Button ID="BtnSav" CssClass="btnform" runat="server"  Text="संपादित करा" TabIndex="51" Height="10%" OnClick="BtnSav_Click"/>
