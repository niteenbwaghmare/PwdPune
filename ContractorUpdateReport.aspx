<%@ Page Title="" Language="C#" MasterPageFile="~/Contractor.Master" AutoEventWireup="true" CodeBehind="ContractorUpdateReport.aspx.cs" Inherits="PWdEEBudget.ContractorUpdateReport" %>
            ...
            <div id="Print">
                <asp:Panel ID="Panel1" runat="server">
                    <div style="overflow-x: auto">
                        ...
                        <asp:CheckBox id="chkBuildUpdate" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>
                        ...
                        <%--<asp:CheckBox id="ChkRoad" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkCRF" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkNabard" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkDpdc" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                       ...
                       <%-- <asp:CheckBox id="ChkMla" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkMp" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkAnnuty" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkDeposit" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkGatA" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkGatD" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkGatF" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkGatB" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkGatC" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkRB" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="ChkNRB" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
                        ...
                        <%--<asp:CheckBox id="Chk2515" runat="server" Text="Upload Photo"  Style="margin-left:50%"/>--%>
