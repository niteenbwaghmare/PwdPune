...
namespace PWdEEBudget
{
    ...
    public partial class SubDivisionMasterAllReport : System.Web.UI.Page
    {
        ...
        {
            ViewState["Head"] = null;
            ViewState["WhereCond"] = " where a.ShakhaAbhyantaName=N'" + UserName.ToString() + "' or a.[UpabhyantaName]=N'" + UserName.ToString() + "' and b.[Arthsankalpiyyear]='" + ddlYear.SelectedItem.ToString() + "'  ";
