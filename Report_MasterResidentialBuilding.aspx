<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_MasterResidentialBuilding.aspx.cs" Inherits="PWdEEBudget.Report_MasterResidentialBuilding" %>
        ...
        <ContentTemplate>
            ...
            <div class="container">
                <div class="row" style="border: 3px solid; background-color: gray; margin-top: 10px">
                    <div class="col-md-12" style="text-align: center; color: #fff">
                        <h1>Residential Building Abstract Report</h1>
                    </div>
                </div>
            ...
            <div id="Print" runat="server">
                <div class="col-md-12" style="text-align: center; color: #443030">
                    <h3 style="font-size: 24px;">Residential Building Abstract Report</h3>
                </div>
                <div align="center">
