<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterDepositeFundReport.aspx.cs" Inherits="PWdEEBudget.MasterDepositeFundReport" EnableEventValidation="false"%>
        ...
        <ContentTemplate>
            <div id="ListMenu" runat="server" class="ddlListHide">
                ...
                <div class="row" style="border: 2px solid; background-color: gray;">
                    <div class="col-md-12" style="text-align: center; color: #fff">
                        <h1>Deposite Contribution Fund Master Report</h1>
                    </div>
                </div>
                <div class="row" style="border: 2px solid; background-color: lightgray">
                ...
                ErrorMessage="कामाचे वर्ष निवडा!" InitialValue="निवडा" ForeColor="red"  Font-Size="Larger" Display="Dynamic" CssClass="blink_me" BackColor="Yellow"></asp:RequiredFieldValidator>
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnKamacheYear" runat="server" CssClass="form-control p" Text="OK" OnClick="btnKamacheYear_Click" ValidationGroup="rfvField" />
                ...
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnlekhashirsh" runat="server" CssClass="form-control p" Text="OK" OnClick="btnlekhashirsh_Click" ValidationGroup="rfvField" />
                    </div>
                </div>
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    <div class="col-md-1"></div>
                    <div class="col-md-3">
                        <asp:Label ID="lblvibhag" runat="server" CssClass="form-control p" Text="विभाग:" Font-Bold="True" ForeColor="Black"></asp:Label>
                    </div>
                    <div class="col-md-6">
                        <asp:DropDownList ID="ddlVibhag" runat="server" CssClass="form-control p" AutoPostBack="True" ForeColor="Black">
                            <asp:ListItem>निवडा</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-2">
                        <asp:Button ID="btnVibhag" runat="server" CssClass="form-control p" Text="OK" OnClick="btnVibhag_Click" ValidationGroup="rfvField" />
                    </div>
                </div>
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    <div class="col-md-1"></div>
                    <div class="col-md-3">
                        <asp:Label ID="Label2" runat="server" CssClass="form-control p" Text="उपविभाग:" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </div>                
                    <div class="col-md-6">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnupvibhag" runat="server" CssClass="form-control p" Text="OK" OnClick="btnupvibhag_Click" ValidationGroup="rfvField" />
                    </div>
                </div>
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnjilha" runat="server" CssClass="form-control p" Text="OK" OnClick="btnjilha_Click" ValidationGroup="rfvField" />
                    </div>
                </div>
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btntaluka" runat="server" CssClass="form-control p" Text="OK" OnClick="btntaluka_Click" ValidationGroup="rfvField" />
                    </div>
                </div>
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnworkid" runat="server" CssClass="form-control p" Text="OK" OnClick="btnworkid_Click" ValidationGroup="rfvField" />
                    </div>
                ...
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnabhiyanta" runat="server" CssClass="form-control p" Text="OK" OnClick="btnabhiyanta_Click" ValidationGroup="rfvField" />
                    </div>
                </div>
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnupabhiyanta" runat="server" CssClass="form-control p" Text="OK" OnClick="btnupabhiyanta_Click" ValidationGroup="rfvField"/>
                    </div>
                </div>
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnamdar" runat="server" CssClass="form-control p" Text="OK" OnClick="btnamdar_Click" ValidationGroup="rfvField" />
                    </div>
                </div>
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnkhasdar" runat="server" CssClass="form-control p" Text="OK" OnClick="btnkhasdar_Click" ValidationGroup="rfvField" />
                    </div>
                </div>
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnthekedar" runat="server" CssClass="form-control p" Text="OK" OnClick="btnthekedar_Click" ValidationGroup="rfvField" />
                    </div>
                </div>
                ...
                <div class="row" style="border: 2px solid; background-color: lightgray">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnkamachistiti" runat="server" CssClass="form-control p" Text="OK" OnClick="btnkamachistiti_Click" ValidationGroup="rfvField" />
                    </div>
                </div>
            </div>
            ...
            <div style="overflow-x: auto;width:100%">
                <asp:CheckBoxList ID="chkBuilding" runat="server" BorderStyle="Solid" BorderWidth="4px" RepeatDirection="Horizontal" class="table-bordered"      OnSelectedIndexChanged="chkBuilding_SelectedIndexChanged">
                    ...
                    <asp:ListItem Selected="True" Value="b.ShilakThev as '2017-18 मधील शिल्लक ठेव'" runat="server">2017-18 मधील शिल्लक ठेव</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.VitariThev as '2017-18 वितरीत ठेव'" runat="server">2017-18 वितरीत ठेव</asp:ListItem>
