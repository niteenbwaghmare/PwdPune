<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterResidentialBulidingReport.aspx.cs" Inherits="PWdEEBudget.MasterResidentialBulidingReport" EnableEventValidation="false"%>
                ...
                <div id="ListMenu" runat="server" style="margin-top: 20px" class="ddlListHide">
                    <div class="row" style="border: 2px solid red; background-color: gray;">
                        <div class="col-md-12" style="text-align: center; color: #fff">
                            <h1>Residential Master Report</h1>
                        </div>
                    </div>
           ...
           <div class="ddlList col-lg-1">Show/Hide List</div>
            ...
            <div style="overflow-x: auto; border: double">
                <asp:CheckBoxList ID="chkBuilding" runat="server" BorderStyle="Solid" BorderWidth="4px" RepeatDirection="Horizontal" class="table-bordered"  OnSelectedIndexChanged="chkBuilding_SelectedIndexChanged">
                    ...
                    <asp:ListItem Selected="True" Value="convert(nvarchar(max),a.[UpabhyantaName])+' '+convert(nvarchar(max),a.[UpAbhiyantaMobile]) as 'उपअभियंता नाव'" runat="server">उपअभियंता नाव</asp:ListItem>
                   ...
                   <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'पूर्ण'  THEN 1 ELSE 0 END as decimal(10,0)) as 'C'" runat="server">C</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'सुरू करणे'  THEN 1 ELSE 0 END as decimal(10,0)) as 'NS'" runat="server">NS</asp:ListItem>
                     <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'अंदाजपत्रकिय स्थर ' THEN 1 ELSE 0 END as decimal(10,0)) as'ES'" runat="server">ES</asp:ListItem>  
                        <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'निविदा स्तर' THEN 1 ELSE 0 END as decimal(10,0)) as'TS'" runat="server">TS</asp:ListItem>         
