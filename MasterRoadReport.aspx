<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" EnableViewState="true" AutoEventWireup="true" CodeBehind="MasterRoadReport.aspx.cs" Inherits="PWdEEBudget.MasterRoadReport" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
            ...
            <div style="overflow-x: auto; border: double">
                <asp:CheckBoxList ID="chkBuilding" runat="server" BorderStyle="Solid" BorderWidth="4px" RepeatDirection="Horizontal" class="table-bordered" OnSelectedIndexChanged="chkBuilding_SelectedIndexChanged">
                    <asp:ListItem Selected="True" Enabled="false" Value="a.[WorkId] as 'वर्क आयडी'" style="font-weight: 400;" runat="server">वर्क आयडी</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.PageNo as 'पान क्र'" runat="server">पान क्र</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="b.[MarchEndingExpn] as 'सुरवाती पासून मार्च 2017 अखेरचा खर्च'" runat="server">सुरवाती पासून मार्च 2017 अखेरचा खर्च</asp:ListItem>

                    <asp:ListItem Selected="True" Value="b.[UrvaritAmt] as 'उर्वरित किंमत'" runat="server">उर्वरित किंमत</asp:ListItem>
                    <%--Replace to सन 2017-18 मधील माहे एप्रिल/मे अखेरचा खर्च--%>
                    ...
                    <%--Not Present in given sequense but required so skipped from removing--%>
                    ...
                    <asp:ListItem Selected="True" Value="b.[Takuntwo] as '2017-18 मधील अर्थसंकल्पीय तरतूद जुलै 2017'" runat="server">2017-18 मधील अर्थसंकल्पीय तरतूद जुलै 2017</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="b.[AkunAnudan] as '2017-18 मधील वितरीत तरतूद'" runat="server">2017-18 मधील वितरीत तरतूद</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[Magni] as '2017-18 साठी मागणी'" runat="server">2017-18 साठी मागणी</asp:ListItem>
                ...
                <div id="DivRoot" align="left">
                    ...
                    <div class="Graph1" style="width: 100%">
                        ...
                        <div style="overflow: auto;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                            ...
                            <asp:GridView ID="GridView1" runat="server" DataKeyNames="वर्क आयडी" RowStyle-VerticalAlign="Top" Style="border: 2px solid" Width="100%" AutoGenerateEditButton="true" OnRowEditing="GridView1_RowEditing" AutoGenerateSelectButton="true" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" OnRowDataBound="GridView1_RowDataBound" ShowFooter="true">
                ...
                <div id="popupContact">
                    ...
                    <form id="formpop">
                        <div class="modal-header" style="padding: 35px 50px;">
                            ...
                            <h4><span class="glyphicon glyphicon-lock" style="margin-right: 5px !important; margin-left: 3px !important;"></span>Password</h4>
                        </div>
