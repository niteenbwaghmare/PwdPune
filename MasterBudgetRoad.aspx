<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterBudgetRoad.aspx.cs" Inherits="PWdEEBudget.MasterBudgetSH" %>
                ...
                <table id="Print" class="table table-bordered mar" style="border: 2px solid gray">
                    ...
                    <tr style="text-align: center; background:linear-gradient(gray,white);">
                        <td colspan="23" style="color:black">
                            <asp:Label ID="Label10" runat="server" Text="Master Budget Road" Height="70px" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>Work_ID</td>
...
<ajaxToolkit:AutoCompleteExtender ServiceMethod="GetCompletionList" MinimumPrefixLength="1"  
                    ...
                    ID="AutoCompleteExtender1" runat="server" FirstRowSelected="false" CompletionListCssClass="AutoExtender" CompletionListItemCssClass="AutoExtenderList" CompletionListHighlightedItemCssClass="AutoExtenderHighlight">  
                        ...
                        <td colspan="4" style="text-align: center;">
                            <asp:Label ID="ddlType" runat="server" class="blink_me" ForeColor="Red" Text="Budget Road"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>जिल्हा </td>
                   ...
                   <td style="font-weight: bold; color: #000000" colspan="6"><asp:TextBox ID="txtarthsankalpiybab" runat="server" CssClass="form-control c" PlaceHolder="पृष्ठ क्र." TabIndex="18" required=""></asp:TextBox></td>--%>
                    ...
                    <tr>
                        <td>पेज क्र॰</td>
                        <td colspan="9">
                            <asp:TextBox ID="txtpageno" CssClass="form-control c" runat="server"></asp:TextBox></td>
             ...
             <td colspan="4"><asp:TextBox ID="txtVidyutprama" runat="server" CssClass="form-control c" onkeyup="checkDec(this);" Text="0.00" AutoPostBack="True" OnTextChanged="txtVidyutprama_TextChanged"></asp:TextBox></td>
             <td colspan="2">विद्युतीकरणाचा खर्च</td>
             <td colspan="4"><asp:TextBox ID="txtVidyutvitarit" runat="server" CssClass="form-control c" Text="0.00" AutoPostBack="True" OnTextChanged="txtVidyutvitarit_TextChanged" onkeyup="checkDec(this);"></asp:TextBox></td>
              <td colspan="3">इतर खर्च</td>
             <td ><asp:TextBox ID="txtitarkhrch" runat="server" CssClass="form-control c" Text="0.00" AutoPostBack="True" OnTextChanged="txtitarkhrch_TextChanged" onkeyup="checkDec(this);"></asp:TextBox></td>
