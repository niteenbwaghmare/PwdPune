...
namespace PWdEEBudget
{
    public partial class MonthWiseReport : System.Web.UI.Page
    {
        ...
        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            ...
            Session["filename"] = "MonthWiseReport.xls";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                {
                    StreamWriter writer = File.AppendText(path + "MonthWiseReport.xls");
        ...
        {
            ViewState["WhereCond"] = " where b.Arthsankalpiyyear='" + ddlArthsankalpiyYear.SelectedItem.ToString() + "' and month(convert(date,a.KamPurnDate,105))=" + ddltype.SelectedItem.Value + " and KamPurnDate !='' ";
            AllMethodsGrid();
            //System.Threading.Thread.Sleep(5000);
