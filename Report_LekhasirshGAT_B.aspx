<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_LekhasirshGAT_B.aspx.cs" Inherits="PWdEEBudget.Report_LekhasirshGAT_B" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ListMenu" runat="server" style="margin-top: 20px" class="ddlListHide">
            ...
            <div class="row" style="border: 2px solid; background-color: gray;">
                ...
                <div class="col-md-1">
                    <asp:Button ID="btnKamacheYear" runat="server" CssClass="form-control p btnform" Text="OK" OnClick="btnKamacheYear_Click" />
                </div>
                <div class="col-md-1"></div>
            </div>
            ...
            <div class="row" style="border: 2px solid; background-color: gray;">
                ...
                <div class="col-md-1">
                    <asp:Button ID="ReportTypebtn" runat="server" OnClick="ReportTypebtn_Click" Text="OK" CssClass="form-control p btnform" />
                </div>
                <div class="col-md-1"></div>
            </div>
             <div class="row" style="border: 2px solid; background-color: gray;">
                ...
                <div class="col-md-1">
                    <asp:Button ID="btnUpvibhag" runat="server" OnClick="btnUpvibhag_Click" Text="OK" CssClass="form-control p btnform" />
                </div>
                 <div class="col-md-1"></div>
            </div>
              ...
              <div class="row" style="border: 2px solid; background-color: gray;">
                ...
                <div class="col-md-1">
                    <asp:Button ID="btnShakhaAbhiyanta" runat="server" OnClick="btnShakhaAbhiyanta_Click" Text="OK" CssClass="form-control p btnform" />
                </div>
                  <div class="col-md-1"></div>
            </div>
              <div class="row" style="border: 2px solid; background-color: gray;">
                ...
                <div class="col-md-1">
                    <asp:Button ID="btnWorkId" runat="server"  Text="OK" OnClick="btnWorkId_Click" CssClass="form-control p btnform" />
                </div>
                  <div class="col-md-1"></div>
            </div>
              <div class="row" style="border: 2px solid; background-color: gray;">
                ...
                <div class="col-md-1">
                    <asp:Button ID="btnthekedar" runat="server" Text="OK" OnClick="btnthekedar_Click" CssClass="form-control p btnform" />
                </div>
                  <div class="col-md-1"></div>
            </div>
              <div class="row" style="border: 2px solid; background-color: gray;">
                ...
                <div class="col-md-1">
                    <asp:Button ID="btnkamachisadyasthiti" runat="server"  Text="OK" OnClick="btnkamachisadyasthiti_Click" CssClass="form-control p btnform" />
                </div>
                  <div class="col-md-1"></div>
            </div>
         </div>
                ...
                <div style="overflow: scroll;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AllowSorting="True" OnSorting="GridView1_Sorting" RowStyle-VerticalAlign="Top" Width="100%" Style="border: 2px solid" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound">
                        <Columns>
                            ...
                            <asp:BoundField DataField="kamachenav" HeaderText="2"></asp:BoundField>
                            <asp:BoundField DataField="RastaKr" HeaderText="3"></asp:BoundField>
                            <asp:BoundField DataField="Pasun" HeaderText="4"></asp:BoundField>
                            <asp:BoundField DataField="Pryant" HeaderText="5"></asp:BoundField>
                            <asp:BoundField DataField="Ekun" HeaderText="6"></asp:BoundField>
                            <asp:BoundField DataField="Prustbhag" HeaderText="7"></asp:BoundField>
                            <asp:BoundField DataField="Pikroll" HeaderText="8"></asp:BoundField>
                            <asp:BoundField DataField="navinkhdikarn" HeaderText="9"></asp:BoundField>
                            <asp:BoundField DataField="BMCarpet" HeaderText="10"></asp:BoundField>
                            <asp:BoundField DataField="mmcarpetsah" HeaderText="11"></asp:BoundField>
                            <asp:BoundField DataField="serface" HeaderText="12"></asp:BoundField>
                            <asp:BoundField DataField="rundikarn" HeaderText="13"></asp:BoundField>
                            <asp:BoundField DataField="Pull" HeaderText="14"></asp:BoundField>
                            <asp:BoundField DataField="anya" HeaderText="15"></asp:BoundField>
                            <asp:BoundField DataField="DurustichaKhrch" HeaderText="16"></asp:BoundField>
                            <asp:BoundField DataField="kamchikinmat" HeaderText="17"></asp:BoundField>
                            <asp:BoundField DataField="jobkr" HeaderText="18"></asp:BoundField>
