...
{
    public partial class MasterBudgetDepositFund : System.Web.UI.Page, IHttpHandler, IRequiresSessionState
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["id"] != null)
                {
                    ...
                    akunanudan();
                    BindAll_Lekha_Vibhag_VarishtType("Diposit");
                    Jilha();
                }
                else
                {
        ...
        public void GetID()
        {
            ...
            {
                int i = 1;
                string select = "select top 1 Akrmank from BudgetMasterDepositFund order by Akrmank desc";
        ...
        protected void txtarthsankalpiyyear_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtarthsankalpiyyear.Text != "")
                {
                    ...
                    lblShilakThev.Text = yeartype;
                    lblVitaritThev.Text = yeartype;
        ...
        public void auditdateset()
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select Arthsankalpiyyear from DepositFundProvision where WorkID=N'" + txtWorkID.Text.Trim() + "'", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            if (dt.Rows.Count != 0)
            {
            ...
            {
                SqlDataAdapter sda1 = new SqlDataAdapter("select Arthsankalpiyyear from BudgetMasterDepositFund where WorkID=N'" + txtWorkID.Text.Trim() + "'", con);
        ...
        public void lekhashirsh()
        {
            try
            {
                ...
                SqlDataAdapter sda = new SqlDataAdapter("select code from SettingLekhaShirsh where Type='Diposit'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                foreach (DataRow dr in dt.Rows)
                {
        ...
        public void workidsearch()
        {
            try
            {
                ...
                dt = ObjsqlQueryOrCon.Feach_Master_Data("Dfund", txtWorkID.Text.Trim());
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        ddlVibhagType.SelectedItem.Text = dr["VibhagType"].ToString();
        ...
        {
            return ObjsqlQueryOrCon.GetCompletionListOfWorkID(prefixText, "Dfund");
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter("Select count(*) from DepositFundProvision where Arthsankalpiyyear=N'" + AuditDate.Text.Trim() + "' and Workid=N'" + txtWorkID.Text.Trim() + "'", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
                ...
                {
                    txtShillakThev.Enabled = true;
                    txtVitaritThev.Enabled = true;
                ...
                {
                    txtShillakThev.Enabled = false;
                    txtVitaritThev.Enabled = false;
        ...
        {
            DataTable dt = new DataTable();
            dt = ObjsqlQueryOrCon.FeachProvisionData("Dfund", AuditDate.Text.Trim(), txtWorkID.Text.Trim());
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    txtShillakThev.Text = dr["ShilakThev"].ToString();
                    txtVitaritThev.Text = dr["VitariThev"].ToString();
            ...
            if (dt.Rows.Count == 0)
            {
                ...
                txtShillakThev.Text = 0.ToString();
                txtVitaritThev.Text = 0.ToString();
        ...
        protected void BtnSav_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (conMDB.State != ConnectionState.Open)
                    conMDB.Open();
                SqlDataAdapter sda = new SqlDataAdapter("select Count(*) from BudgetMasterDepositFund WHERE WorkId='" + txtWorkID.Text.Trim() + "'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    {
                        SqlDataAdapter sda1 = new SqlDataAdapter("select Count(*) from DepositFundProvision where Arthsankalpiyyear=N'" + AuditDate.Text.Trim() + "' and WorkId=N'" + txtWorkID.Text.Trim() + "'", con);
                        DataTable dt1 = new DataTable();
                        sda1.Fill(dt1);
                        foreach (DataRow dr1 in dt1.Rows)
                        {
                            string strMasterUpdateQuery = "UPDATE BudgetMasterDepositFund SET [Dist]=N'" + ddldist.SelectedItem.Text + "',[Taluka]=N'" + ddltaluka.SelectedItem.Text + "',[Upvibhag]=N'" + ddlupvibhag.SelectedItem.Text + "',[ShakhaAbhyantaName]=N'" + ddlabhiyanta.SelectedItem.Text + "',[ShakhaAbhiyantMobile]=N'" + txtabhiyantamobile.Text + "',[UpabhyantaName]=N'" + ddlupabhiyanta.SelectedItem.Text + "',[UpAbhiyantaMobile]=N'" + txtupabhiyantamobile.Text + "',[KhasdaracheName]=N'" + ddlkhasdarachename.SelectedItem.Text + "',[AmdaracheName]=N'" + ddlaamdarachename.SelectedItem.Text + "',[SubType]=N'" + ddlsubtype.SelectedItem.Text + "',[VibhagType]=N'" + ddlVibhagType.SelectedItem.Text + "',[LekhaShirsh]=N'" + ddllekhashirsh.SelectedItem.Text + "',[LekhaShirshName]=N'" + lblLekhaName.Text + "',[ArthsankalpiyBab]=N'" + txtarthsankalpiybab.Text + "',[KamacheName]=N'" + txtkamachenav.Text + "',[PrashaskiyKramank]=N'" + txtprashaskiykramank.Text + "',[PrashaskiyDate]=N'" + txtprashaskiydinak.Text + "',[PrashaskiyAmt]=N'" + txtprashaskiykimat.Text + "',[TrantrikKrmank]=N'" + txttantrikkramank.Text + "',[TrantrikDate]=N'" + txttantarikdinak.Text + "',[TrantrikAmt]=N'" + txttantarikkimat.Text + "',[Kamachevav]=N'" + txtkamachavav.Text + "',[ThekedaarName]=N'" + ddlThekedarName.SelectedItem.Text + "',[ThekedarMobile]=N'" + lblThekedarMobNo.Text + "',[NividaKrmank]=N'" + txtNividaKramank.Text + "',[NividaAmt]=N'" + txtNividaKimat.Text + "',[karyarambhadesh]=N'" + txtkaryarambhaadesh.Text + "',[NividaDate]=N'" + txtkaryarambhdinak.Text + "',[kamachiMudat]=N'" + txtkamachimudat.Text + "',[KamPurnDate]=N'" + txtkampurndinak.Text + "',[Sadyasthiti]=N'" + ddlsadyasthiti.Text + "',[Pahanikramank]=N'" + txtpahnikramank.Text + "',[PahaniMudye]=N'" + txtpahnimudye.Text + "',[Shera]=N'" + txtshera.Text + "' WHERE WorkId=N'" + txtWorkID.Text.Trim() + "' and [SubDivision]='PuneEast'";
                            cmd = new SqlCommand(strMasterUpdateQuery, con);
                            cmdMDB = new SqlCommand(strMasterUpdateQuery, conMDB);
                            if (dr1[0].ToString() == 0.ToString())
                            {
                                string strMasterInsertQuery = "INSERT INTO [DepositFundProvision] ([WorkId],[Arthsankalpiyyear],[MudatVadhiDate],[ShilakThev],[VitariThev],[DeyakachiSadyasthiti],[ManjurAmt],[MarchEndingExpn],[UrvaritAmt],[DTakunone],[Takunone],[DTakuntwo],[Takuntwo],[DTakunthree],[Takunthree],[DTakunfour],[Takunfour],[Tartud],[Jan],[Feb],[Mar],[Apr],[May],[Jun],[Jul],[Aug],[Sep],[Oct],[Nov],[Dec],[AkunAnudan],[Chalumonth],[Chalukharch],[Magilmonth],[Magilkharch],[Magni],[VarshbharatilKharch],[AikunKharch] ,[Vidyutprama],[Vidyutvitarit],[Dviguni],[Itarkhrch],[SubDivision]) VALUES('" + txtWorkID.Text.Trim() + "','" + txtarthsankalpiyyear.Text + "',N'" + txtmudatvadhdinak.Text + "',N'" + txtShillakThev.Text + "',N'" + txtVitaritThev.Text + "',N'" + Billpayment.Text + "',N'" + Convert.ToDecimal(txtcost.Text) + "',N'" + Convert.ToDecimal(txtmarchakherkharch.Text) + "',N'" + Convert.ToDecimal(txturvaritamt.Text) + "',N'" + ddlakun1.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun1.Text) + "', N'" + ddlakun2.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun2.Text) + "',N'" + ddlakun3.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun3.Text) + "',N'" + ddlakun4.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun4.Text) + "',N'" + Convert.ToDecimal(txttartud.Text) + "',N'" + Convert.ToDecimal(txtjan.Text) + "',N'" + Convert.ToDecimal(txtfeb.Text) + "',N'" + Convert.ToDecimal(txtmar.Text) + "',N'" + Convert.ToDecimal(txtapr.Text) + "',N'" + Convert.ToDecimal(txtmay.Text) + "',N'" + Convert.ToDecimal(txtjun.Text) + "',N'" + Convert.ToDecimal(txtjul.Text) + "',N'" + Convert.ToDecimal(txtaug.Text) + "',N'" + Convert.ToDecimal(txtsep.Text) + "',N'" + Convert.ToDecimal(txtoct.Text) + "',N'" + Convert.ToDecimal(txtnov.Text) + "',N'" + Convert.ToDecimal(txtdec.Text) + "',N'" + Convert.ToDecimal(txtaikunanudan.Text) + "',N'" + ddlchalukharch.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtchalukharch.Text) + "',N'" + ddlmagilmonth.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtmagilkharch.Text) + "',N'" + Convert.ToDecimal(txtmagni.Text) + "',N'" + Convert.ToDecimal(txtvarshbharatilkharch.Text) + "',N'" + Convert.ToDecimal(txtaikunkharch.Text) + "',N'" + Convert.ToDecimal(txtVidyutprama.Text) + "',N'" + Convert.ToDecimal(txtVidyutvitarit.Text) + "',N'" + txtdnyapane.Text + "',N'" + Convert.ToDecimal(txtitarkhrch.Text) + "','PuneEast')";
                    ...
                    if (cmd.ExecuteNonQuery() > 0 && cmdMDB.ExecuteNonQuery() > 0)
                    {
                        ...
                        else
                        {
                            ...
                            Server.Transfer("MasterBudgetDepositFund.aspx", false);
