  ...
  <%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_LekhasirshGAT_A.aspx.cs" Inherits="PWdEEBudget.Report_LekhasirshGAT_A" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div style="overflow: scroll;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AllowSorting="True" OnSorting="GridView1_Sorting" RowStyle-VerticalAlign="Top" Width="100%" Style="border: 2px solid" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound">
                        <Columns>
                            ...
                            <asp:BoundField DataField="LekhaShirsh" HeaderText="lekhashirsh"></asp:BoundField>
                            <asp:BoundField DataField="LekhaShirshName" HeaderText="LekhashirshName" ItemStyle-Width="35px"></asp:BoundField>
                            <asp:BoundField DataField="dist" HeaderText="2"></asp:BoundField>
                            <asp:BoundField DataField="upvibhag" HeaderText="3"></asp:BoundField>
                            <asp:BoundField DataField="kamchenav" HeaderText="4"></asp:BoundField>
                            <asp:BoundField DataField="worlId" HeaderText="5"></asp:BoundField>
                            <asp:BoundField DataField="adeshkr" HeaderText="6"></asp:BoundField>
                            <asp:BoundField DataField="upshirsh" HeaderText="7"></asp:BoundField>
                            <asp:BoundField DataField="jobkr" HeaderText="8"></asp:BoundField>
                            <asp:BoundField DataField="rakkam" HeaderText="9"></asp:BoundField>
                            <asp:BoundField DataField="TaAdeshkr" HeaderText="10"></asp:BoundField>
                            <asp:BoundField DataField="TaDate" HeaderText="11"></asp:BoundField>
                            <asp:BoundField DataField="Tarakkam" HeaderText="12"></asp:BoundField>
                            <asp:BoundField DataField="DambrichePariman" HeaderText="13"></asp:BoundField>
                            <asp:BoundField DataField="damrichiRakkam" HeaderText="14"></asp:BoundField>
                            <asp:BoundField DataField="Nividaamt" HeaderText="15"></asp:BoundField>
                            <asp:BoundField DataField="ThekdarNav" HeaderText="16"></asp:BoundField>
                            <asp:BoundField DataField="NiAdeshKr" HeaderText="17"></asp:BoundField>
                            <asp:BoundField DataField="nividakr" HeaderText="18"></asp:BoundField>
                            <asp:BoundField DataField="Kamachimudat" HeaderText="19"></asp:BoundField>
                            <asp:BoundField DataField="C" HeaderText="20"></asp:BoundField>
                            <asp:BoundField DataField="P" HeaderText="21"></asp:BoundField>
                            <asp:BoundField DataField="O" HeaderText="22"></asp:BoundField>
                            <asp:BoundField DataField="kamPurndate" HeaderText="23"></asp:BoundField>
                            <asp:BoundField DataField="kampurnzalyadate" HeaderText="24"></asp:BoundField>
                            <asp:BoundField DataField="vibhagatdeyak" HeaderText="25"></asp:BoundField>
                            <asp:BoundField DataField="vibhagtParit" HeaderText="26"></asp:BoundField>
                            <asp:BoundField DataField="kamvrzalelakhrch" HeaderText="27"></asp:BoundField>
                            <asp:BoundField DataField="dambrichakhrch" HeaderText="28"></asp:BoundField>
                            <asp:BoundField DataField="ekunkhrch" HeaderText="29"></asp:BoundField>
                            <asp:BoundField DataField="shilakdayitv" HeaderText="30"></asp:BoundField>
                            <asp:BoundField DataField="DayitvAvshyakYesNo" HeaderText="31"></asp:BoundField>
                            <asp:BoundField DataField="DayitvAmt" HeaderText="32"></asp:BoundField>
                            <asp:BoundField DataField="vaperdaPariman" HeaderText="33"></asp:BoundField>
                            <asp:BoundField DataField="ShakhaName" HeaderText="34"></asp:BoundField>
                            <asp:BoundField DataField="upabhyanta" HeaderText="35"></asp:BoundField>
                            <%--<asp:BoundField DataField="" HeaderText="31"></asp:BoundField>
                        <asp:BoundField DataField="" HeaderText="32"></asp:BoundField>
                        <asp:BoundField DataField="" HeaderText="33"></asp:BoundField>
                        <asp:BoundField DataField="" HeaderText="34"></asp:BoundField>
                        <asp:BoundField DataField="" HeaderText="35"></asp:BoundField>
                        <asp:BoundField DataField="" HeaderText="36"></asp:BoundField>
                        <asp:BoundField DataField="" HeaderText="37"></asp:BoundField>--%>

                            <asp:BoundField DataField="shera" HeaderText="38"></asp:BoundField>
    ...
    <div align="center">
        ...
        <asp:Button ID="Button4" runat="server" Text="Back" CssClass="btn btn-danger btnform" OnClientClick="JavaScript:window.history.back(1); return false;" Height="40px" Width="100px" />
