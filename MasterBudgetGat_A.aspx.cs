...
{
    public partial class MasterBudgetGat_A : System.Web.UI.Page, IHttpHandler, IRequiresSessionState
    {
       ...
       static SqlQueryOrConnection ObjsqlQueryOrCon = new SqlQueryOrConnection();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["id"] != null)
                {
                    ...
                    GetID();
                    akunanudan();
                    BindAll_Lekha_Vibhag_VarishtType("3054_Gat_A");
        ...
        public void GetID()
        {
            ...
            {
                int i = 1;
                string select = "select top 1 Akrmank from BudgetMasterGAT_A order by Akrmank desc";
        ...
        public void auditdateset()
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select Arthsankalpiyyear from GAT_AProvision where WorkID=N'" + txtWorkID.Text.Trim() + "'", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            if (dt.Rows.Count != 0)
            {
            ...
            {
                SqlDataAdapter sda1 = new SqlDataAdapter("select Arthsankalpiyyear from BudgetMasterGAT_A where WorkID=N'" + txtWorkID.Text.Trim() + "'", con);
        ...
        public void workidsearch()
        {
            try
            {
                ...
                dt = ObjsqlQueryOrCon.Feach_Master_Data("Gat_A", txtWorkID.Text.Trim());
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        txtAadeshKramank.Text = dr["GAadeshKramank"].ToString();
                        txtUpshirsh.Text = dr["GUpshirsh"].ToString();
                        txtJobKramank.Text = dr["GJobKramank"].ToString();
                        txtJobRakkam.Text = dr["GJobRakkam"].ToString();
                        txtDambarichepariman.Text = dr["GDambarichePariman"].ToString();
                        txtDambarichiRakkm.Text = dr["GDambarichiRakkam"].ToString();
                        txtDurustichaPrakar.Text = dr["GDurustichaprakar"].ToString();
                        txtVaprDambarichepariman.Text = dr["GVaperDambarichePariman"].ToString();
                        txtKamPurnKaranyachaDinak.Text = dr["GKampurnKarnyachaDinak"].ToString();
                        txtKamPurnJhalyachaDinak.Text = dr["GKampurnJhalyachaDinak"].ToString();
                        txtDeyakKelyachaDinak.Text = dr["GDeyakSadarKelyachaDinak"].ToString();
                        txtDeyakParitDinak.Text = dr["GParitKelyachaDinak"].ToString();
                ...
                else
                {
                    ...
                    txtprashaskiykimat.Text = "0.0";
                    txttantrikkramank.Text = "";
                    txttantarikdinak.Text = "";
                    txttantarikkimat.Text = "0.0";
                    ddlThekedarName.SelectedIndex = 0;
                    lblThekedarMobNo.Text = "";
                    txtNividaKramank.Text = "";
                    txtNividaKimat.Text = "0.0";
                    txtkaryarambhaadesh.Text = "";
                    txtkaryarambhdinak.Text = "";
                    txtkamachimudat.Text = "";
                    txtkampurndinak.Text = "";
                    txtAadeshKramank.Text = "";
                    txtUpshirsh.Text = "";
                    txtJobKramank.Text = "";
                    txtJobRakkam.Text = "0.0";
                    txtDambarichepariman.Text = "0";
                    txtDambarichiRakkm.Text = "0.0";
                    txtDurustichaPrakar.Text = "";
                    txtVaprDambarichepariman.Text = "0.0";
                    txtKamPurnKaranyachaDinak.Text = "";
                    txtKamPurnJhalyachaDinak.Text = "";
                    txtDeyakKelyachaDinak.Text = "";
                    txtDeyakParitDinak.Text = "";
        ...
        {
            return ObjsqlQueryOrCon.GetCompletionListOfWorkID(prefixText, "Gat_A");
        }
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter("Select count(*) from GAT_AProvision where Arthsankalpiyyear=N'" + AuditDate.Text.Trim() + "' and Workid=N'" + txtWorkID.Text.Trim() + "'", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
                ...
                {
                    txtMudatVadhiDate.Enabled = true;
                    txtcost.Enabled = true;
                    // txtShilakDayitv.Enabled = true;
                    txtmarchakherkharch.Enabled = true;
                    txtDayitvAvshyak.Enabled = true;
                    txtDayitavAmt.Enabled = true;
                    ...
                    txtDambarichaExpens.Enabled = true;
                    txtVidyutprama.Enabled = true;
                    txtVidyutvitarit.Enabled = true;
                    ...
                    //GAT A SECTION
                    txtAadeshKramank.Enabled = true;
                    txtUpshirsh.Enabled = true;
                    txtJobKramank.Enabled = true;
                    txtJobRakkam.Enabled = true;
                    txtDambarichepariman.Enabled = true;
                    txtDambarichiRakkm.Enabled = true;
                    txtDurustichaPrakar.Enabled = true;
                    txtVaprDambarichepariman.Enabled = true;
                    txtKamPurnKaranyachaDinak.Enabled = true;
                    txtKamPurnJhalyachaDinak.Enabled = true;
                    txtDeyakKelyachaDinak.Enabled = true;
                    txtDeyakParitDinak.Enabled = true;
                }
                else
                {
                    txtMudatVadhiDate.Enabled = false;
                    //  txtShilakDayitv.Enabled = false;
                    txtcost.Enabled = false;
                    txtmarchakherkharch.Enabled = false;
                    txtDayitvAvshyak.Enabled = false;
                    txtDayitavAmt.Enabled = false;
                    ...
                    txtDambarichaExpens.Enabled = false;
                    txtVidyutprama.Enabled = false;
                    txtVidyutvitarit.Enabled = false;
                    ...
                    //GAT A SECTION
                    txtAadeshKramank.Enabled = false;
                    txtUpshirsh.Enabled = false;
                    txtJobKramank.Enabled = false;
                    txtJobRakkam.Enabled = false;
                    txtDambarichepariman.Enabled = false;
                    txtDambarichiRakkm.Enabled = false;
                    txtDurustichaPrakar.Enabled = false;
                    txtVaprDambarichepariman.Enabled = false;
                    txtKamPurnKaranyachaDinak.Enabled = false;
                    txtKamPurnJhalyachaDinak.Enabled = false;
                    txtDeyakKelyachaDinak.Enabled = false;
                    txtDeyakParitDinak.Enabled = false;
                }
            }
        }
        ...
        {
            DataTable dt = new DataTable();
            dt = ObjsqlQueryOrCon.FeachProvisionData("Gat_A", AuditDate.Text.Trim(), txtWorkID.Text.Trim());
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    txtMudatVadhiDate.Text = dr["MudatVadhiDate"].ToString();
                    txtShilakDayitv.Text = dr["ShilakDayitvAmt"].ToString();
                    ...
                    txtDayitvAvshyak.Text = dr["DayitvAvshyakYesNo"].ToString();
                    txtDayitavAmt.Text = dr["DayitvAmt"].ToString();
                    ...
                    txtVidyutprama.Text = dr["VidyutikaranAmt"].ToString();
                    txtVidyutvitarit.Text = dr["VidyutikaranExpen"].ToString();
                    txtDambarichaExpens.Text = dr["DambarichaExpen"].ToString();
            ...
            if (dt.Rows.Count == 0)
            {
                txtMudatVadhiDate.Text = 0.ToString();
                txtShilakDayitv.Text = 0.ToString();
                txtcost.Text = 0.ToString();
                txtmarchakherkharch.Text = 0.ToString();
                txturvaritamt.Text = 0.ToString();
                txtDayitvAvshyak.Text = 0.ToString();
                txtDayitavAmt.Text = 0.ToString();
                ...
                txtDambarichaExpens.Text = 0.ToString();
        ...
        protected void txtarthsankalpiyyear_TextChanged(object sender, EventArgs e)
        {
            try
            {
                txtarthsankalpiyyear.Text = ConvertDigits(txtarthsankalpiyyear.Text);
        ...
        protected void txtkamachimudat_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //DateTime before3days = Convert.ToDateTime(txtkaryarambhdinak.Text).AddMonths(Convert.ToInt32(txtkamachimudat.Text));
                    //txtkampurndinak.Text = before3days.ToString("MM/dd/yyyy");
        ...
        protected void BtnSav_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtAadeshKramank.Text = ConvertDigits(txtAadeshKramank.Text);
                txtUpshirsh.Text = ConvertDigits(txtUpshirsh.Text);
                txtJobKramank.Text = ConvertDigits(txtJobKramank.Text);
                txtJobRakkam.Text = ConvertDigits(txtJobRakkam.Text);
                txtDambarichepariman.Text = ConvertDigits(txtDambarichepariman.Text);
                txtDambarichiRakkm.Text = ConvertDigits(txtDambarichiRakkm.Text);
                txtDurustichaPrakar.Text = ConvertDigits(txtDurustichaPrakar.Text);
                txtVaprDambarichepariman.Text = ConvertDigits(txtVaprDambarichepariman.Text);
                txtKamPurnKaranyachaDinak.Text = ConvertDigits(txtKamPurnKaranyachaDinak.Text);
                txtDeyakKelyachaDinak.Text = ConvertDigits(txtDeyakKelyachaDinak.Text);
                txtDeyakParitDinak.Text = ConvertDigits(txtDeyakParitDinak.Text);
                txtMudatVadhiDate.Text = ConvertDigits(txtMudatVadhiDate.Text);
                txtShilakDayitv.Text = ConvertDigits(txtShilakDayitv.Text);
                Billpayment.Text = ConvertDigits(Billpayment.Text);
                txtDayitavAmt.Text = ConvertDigits(txtDayitavAmt.Text);
                txtmagni.Text = ConvertDigits(txtmagni.Text);
                txtpahnikramank.Text = ConvertDigits(txtpahnikramank.Text);
                txtDambarichaExpens.Text = ConvertDigits(txtDambarichaExpens.Text);
                ...
                txtKamPurnJhalyachaDinak.Text = ConvertDigits(txtKamPurnJhalyachaDinak.Text);
                ...
                if (conMDB.State != ConnectionState.Open)
                    conMDB.Open();
                SqlDataAdapter sda = new SqlDataAdapter("select Count(*) from BudgetMasterGAT_A WHERE WorkId='" + txtWorkID.Text.Trim() + "'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    if (dr[0].ToString() == 0.ToString())
                    {
                        string strMasterInsertQuery = "Insert Into [BudgetMasterGAT_A] ([WorkId],[Arthsankalpiyyear],[Akrmank],[Type] ,[Dist],[Taluka],[ArthsankalpiyBab],[Upvibhag],[LekhaShirsh],[LekhaShirshName],[SubType],[ShakhaAbhyantaName],[ShakhaAbhiyantMobile],[UpabhyantaName],[UpAbhiyantaMobile],[KhasdaracheName],[AmdaracheName],[KamacheName],[Kamachevav],[PrashaskiyKramank],[PrashaskiyDate] ,[PrashaskiyAmt],[TrantrikKrmank],[TrantrikDate],[TrantrikAmt],[ThekedaarName] ,[ThekedarMobile],[NividaKrmank],[NividaAmt],[karyarambhadesh],[NividaDate],[kamachiMudat],[KamPurnDate],[GAadeshKramank],[GUpshirsh],[GJobKramank],[GJobRakkam],[GDambarichePariman],[GDambarichiRakkam],[GDurustichaprakar],[GVaperDambarichePariman],[GKampurnKarnyachaDinak],[GKampurnJhalyachaDinak],[GDeyakSadarKelyachaDinak] ,[GParitKelyachaDinak],[Sadyasthiti],[Pahanikramank],[PahaniMudye],[Shera],[SubDivision]) Values (N'" + txtWorkID.Text.Trim() + "',N'" + txtarthsankalpiyyear.Text + "',N'" + Convert.ToInt32(lblId.Text) + "',N'GAT_A',N'" + ddldist.SelectedItem.Text + "',N'" + ddltaluka.SelectedItem.Text + "',N'" + txtarthsankalpiybab.Text + "',N'" + ddlupvibhag.SelectedItem.Text + "',N'" + ddllekhashirsh.SelectedItem.Text + "',N'" + lblLekhaName.Text + "',N'" + ddlsubtype.SelectedItem.Text + "',N'" + ddlabhiyanta.SelectedItem.Text + "',N'" + txtabhiyantamobile.Text + "',N'" + ddlupabhiyanta.SelectedItem.Text + "',N'" + txtupabhiyantamobile.Text + "',N'" + ddlkhasdarachename.SelectedItem.Text + "',N'" + ddlaamdarachename.SelectedItem.Text + "',N'" + txtkamachenav.Text + "',N'" + txtkamachavav.Text + "',N'" + txtprashaskiykramank.Text + "',N'" + txtprashaskiydinak.Text + "',N'" + txtprashaskiykimat.Text + "',N'" + txttantrikkramank.Text + "',N'" + txttantarikdinak.Text + "',N'" + Convert.ToDecimal(txttantarikkimat.Text) + "',N'" + ddlThekedarName.SelectedItem.Text + "',N'" + lblThekedarMobNo.Text + "',N'" + txtNividaKramank.Text + "',N'" + txtNividaKimat.Text + "',N'" + txtkaryarambhaadesh.Text + "',N'" + txtkaryarambhdinak.Text + "',N'" + txtkamachimudat.Text + "',N'" + txtkampurndinak.Text + "',N'" + txtAadeshKramank.Text + "',N'" + txtUpshirsh.Text + "',N'" + txtJobKramank.Text + "',N'" + txtJobRakkam.Text + "',N'" + txtDambarichepariman.Text + "',N'" + txtDambarichiRakkm.Text + "',N'" + txtDurustichaPrakar.Text + "',N'" + txtVaprDambarichepariman.Text + "',N'" + txtKamPurnKaranyachaDinak.Text + "',N'" + txtKamPurnJhalyachaDinak.Text + "',N'" + txtDeyakKelyachaDinak.Text + "',N'" + txtDeyakParitDinak.Text + "',N'" + ddlsadyasthiti.SelectedItem.Text + "',N'" + txtpahnikramank.Text + "',N'" + txtpahnimudye.Text + "',N'" + txtshera.Text + "','PuneEast')";
                        string strProvisionInsertQuery = "INSERT INTO [GAT_AProvision] ([WorkId],[Arthsankalpiyyear],[MudatVadhiDate],[ShilakDayitvAmt],[ManjurAmt],[MarchEndingExpn],[UrvaritAmt],[DayitvAvshyakYesNo],[DayitvAmt],[DTakunone],[Takunone],[DTakuntwo],[Takuntwo],[DTakunthree],[Takunthree],[DTakunfour],[Takunfour],[Tartud],[Jan],[Feb],[Mar],[Apr],[May],[Jun],[Jul],[Aug],[Sep],[Oct],[Nov],[Dec],[AkunAnudan],[Chalumonth],[Chalukharch],[Magilmonth],[Magilkharch],[Magni],[VarshbharatilKharch],[AikunKharch] ,[VidyutikaranAmt],[VidyutikaranExpen],[DambarichaExpen],[Dviguni],[Itarkhrch],[SubDivision]) VALUES('" + txtWorkID.Text.Trim() + "','" + txtarthsankalpiyyear.Text + "',N'" + txtMudatVadhiDate.Text + "',N'" + Convert.ToDecimal(txtShilakDayitv.Text) + "',N'" + Convert.ToDecimal(txtcost.Text) + "',N'" + Convert.ToDecimal(txtmarchakherkharch.Text) + "',N'" + Convert.ToDecimal(txturvaritamt.Text) + "',N'" + txtDayitvAvshyak.Text + "',N'" + Convert.ToDecimal(txtDayitavAmt.Text) + "',N'" + ddlakun1.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun1.Text) + "', N'" + ddlakun2.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun2.Text) + "',N'" + ddlakun3.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun3.Text) + "',N'" + ddlakun4.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun4.Text) + "',N'" + Convert.ToDecimal(txttartud.Text) + "',N'" + Convert.ToDecimal(txtjan.Text) + "',N'" + Convert.ToDecimal(txtfeb.Text) + "',N'" + Convert.ToDecimal(txtmar.Text) + "',N'" + Convert.ToDecimal(txtapr.Text) + "',N'" + Convert.ToDecimal(txtmay.Text) + "',N'" + Convert.ToDecimal(txtjun.Text) + "',N'" + Convert.ToDecimal(txtjul.Text) + "',N'" + Convert.ToDecimal(txtaug.Text) + "',N'" + Convert.ToDecimal(txtsep.Text) + "',N'" + Convert.ToDecimal(txtoct.Text) + "',N'" + Convert.ToDecimal(txtnov.Text) + "',N'" + Convert.ToDecimal(txtdec.Text) + "',N'" + Convert.ToDecimal(txtaikunanudan.Text) + "',N'" + ddlchalukharch.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtchalukharch.Text) + "',N'" + ddlmagilmonth.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtmagilkharch.Text) + "',N'" + Convert.ToDecimal(txtmagni.Text) + "',N'" + Convert.ToDecimal(txtvarshbharatilkharch.Text) + "',N'" + Convert.ToDecimal(txtaikunkharch.Text) + "',N'" + Convert.ToDecimal(txtVidyutprama.Text) + "',N'" + Convert.ToDecimal(txtVidyutvitarit.Text) + "',N'" + Convert.ToDecimal(txtDambarichaExpens.Text) + "',N'" + txtdnyapane.Text + "',N'" + Convert.ToDecimal(txtitarkhrch.Text) + "','PuneEast')";
                    ...
                    {
                        SqlDataAdapter sda1 = new SqlDataAdapter("select Count(*) from GAT_AProvision where Arthsankalpiyyear=N'" + AuditDate.Text.Trim() + "' and WorkId=N'" + txtWorkID.Text.Trim() + "'", con);
                        DataTable dt1 = new DataTable();
                        sda1.Fill(dt1);
                        foreach (DataRow dr1 in dt1.Rows)
                        {
                            string strMasterUpdateQuery = "UPDATE [BudgetMasterGAT_A] SET [Dist]=N'" + ddldist.SelectedItem.Text + "',[Taluka]=N'" + ddltaluka.SelectedItem.Text + "',[Upvibhag]=N'" + ddlupvibhag.SelectedItem.Text + "',[ShakhaAbhyantaName]=N'" + ddlabhiyanta.SelectedItem.Text + "',[ShakhaAbhiyantMobile]=N'" + txtabhiyantamobile.Text + "',[UpabhyantaName]=N'" + ddlupabhiyanta.SelectedItem.Text + "',[UpAbhiyantaMobile]=N'" + txtupabhiyantamobile.Text + "',[KhasdaracheName]=N'" + ddlkhasdarachename.SelectedItem.Text + "',[AmdaracheName]=N'" + ddlaamdarachename.SelectedItem.Text + "',[SubType]=N'" + ddlsubtype.SelectedItem.Text + "',[LekhaShirsh]=N'" + ddllekhashirsh.SelectedItem.Text + "',[LekhaShirshName]=N'" + lblLekhaName.Text + "',[ArthsankalpiyBab]=N'" + txtarthsankalpiybab.Text + "',[KamacheName]=N'" + txtkamachenav.Text + "',[PrashaskiyKramank]=N'" + txtprashaskiykramank.Text + "',[PrashaskiyDate]=N'" + txtprashaskiydinak.Text + "',[PrashaskiyAmt]=N'" + txtprashaskiykimat.Text + "',[TrantrikKrmank]=N'" + txttantrikkramank.Text + "',[TrantrikDate]=N'" + txttantarikdinak.Text + "',[TrantrikAmt]=N'" + Convert.ToDecimal(txttantarikkimat.Text) + "',[Kamachevav]=N'" + txtkamachavav.Text + "',[ThekedaarName]=N'" + ddlThekedarName.SelectedItem.Text + "',[ThekedarMobile]=N'" + lblThekedarMobNo.Text + "',[NividaKrmank]=N'" + txtNividaKramank.Text + "',[NividaAmt]=N'" + txtNividaKimat.Text + "',[karyarambhadesh]=N'" + txtkaryarambhaadesh.Text + "',[NividaDate]=N'" + txtkaryarambhdinak.Text + "',[kamachiMudat]=N'" + txtkamachimudat.Text + "',[KamPurnDate]=N'" + txtkampurndinak.Text + "',[GAadeshKramank]=N'" + txtAadeshKramank.Text + "',[GUpshirsh]=N'" + txtUpshirsh.Text + "',[GJobKramank]=N'" + txtJobKramank.Text + "',[GJobRakkam]=N'" + txtJobRakkam.Text + "',[GDambarichePariman]=N'" + txtDambarichepariman.Text + "',[GDambarichiRakkam]=N'" + txtDambarichiRakkm.Text + "',[GDurustichaprakar]=N'" + txtDambarichiRakkm.Text + "',[GVaperDambarichePariman]=N'" + txtVaprDambarichepariman.Text + "',[GKampurnKarnyachaDinak]=N'" + txtKamPurnKaranyachaDinak.Text + "',[GKampurnJhalyachaDinak]=N'" + txtKamPurnJhalyachaDinak.Text + "',[GDeyakSadarKelyachaDinak]=N'" + txtDeyakKelyachaDinak.Text + "' ,[GParitKelyachaDinak]=N'" + txtDeyakParitDinak.Text + "',[Sadyasthiti]=N'" + ddlsadyasthiti.Text + "',[Pahanikramank]=N'" + txtpahnikramank.Text + "',[PahaniMudye]=N'" + txtpahnimudye.Text + "',[Shera]=N'" + txtshera.Text + "' WHERE WorkId=N'" + txtWorkID.Text.Trim() + "' and [SubDivision]='PuneEast'";
                            cmd = new SqlCommand(strMasterUpdateQuery, con);
                            cmdMDB = new SqlCommand(strMasterUpdateQuery, conMDB);
                            
                            if (dr1[0].ToString() == 0.ToString())
                            {
                                string strMasterInsertQuery = "INSERT INTO [GAT_AProvision] ([WorkId],[Arthsankalpiyyear],[MudatVadhiDate],[ShilakDayitvAmt],[ManjurAmt],[MarchEndingExpn],[UrvaritAmt],[DayitvAvshyakYesNo],[DayitvAmt],[DTakunone],[Takunone],[DTakuntwo],[Takuntwo],[DTakunthree],[Takunthree],[DTakunfour],[Takunfour],[Tartud],[Jan],[Feb],[Mar],[Apr],[May],[Jun],[Jul],[Aug],[Sep],[Oct],[Nov],[Dec],[AkunAnudan],[Chalumonth],[Chalukharch],[Magilmonth],[Magilkharch],[Magni],[VarshbharatilKharch],[AikunKharch],[VidyutikaranAmt],[VidyutikaranExpen],[DambarichaExpen],[Dviguni],[Itarkhrch],[SubDivision]) VALUES('" + txtWorkID.Text.Trim() + "','" + txtarthsankalpiyyear.Text + "',N'" + txtMudatVadhiDate.Text + "',N'" + Convert.ToDecimal(txtShilakDayitv.Text) + "',N'" + Convert.ToDecimal(txtcost.Text) + "',N'" + Convert.ToDecimal(txtmarchakherkharch.Text) + "',N'" + Convert.ToDecimal(txturvaritamt.Text) + "',N'" + txtDayitvAvshyak.Text + "',N'" + Convert.ToDecimal(txtDayitavAmt.Text) + "',N'" + ddlakun1.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun1.Text) + "', N'" + ddlakun2.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun2.Text) + "',N'" + ddlakun3.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun3.Text) + "',N'" + ddlakun4.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun4.Text) + "',N'" + Convert.ToDecimal(txttartud.Text) + "',N'" + Convert.ToDecimal(txtjan.Text) + "',N'" + Convert.ToDecimal(txtfeb.Text) + "',N'" + Convert.ToDecimal(txtmar.Text) + "',N'" + Convert.ToDecimal(txtapr.Text) + "',N'" + Convert.ToDecimal(txtmay.Text) + "',N'" + Convert.ToDecimal(txtjun.Text) + "',N'" + Convert.ToDecimal(txtjul.Text) + "',N'" + Convert.ToDecimal(txtaug.Text) + "',N'" + Convert.ToDecimal(txtsep.Text) + "',N'" + Convert.ToDecimal(txtoct.Text) + "',N'" + Convert.ToDecimal(txtnov.Text) + "',N'" + Convert.ToDecimal(txtdec.Text) + "',N'" + Convert.ToDecimal(txtaikunanudan.Text) + "',N'" + ddlchalukharch.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtchalukharch.Text) + "',N'" + ddlmagilmonth.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtmagilkharch.Text) + "',N'" + Convert.ToDecimal(txtmagni.Text) + "',N'" + Convert.ToDecimal(txtvarshbharatilkharch.Text) + "',N'" + Convert.ToDecimal(txtaikunkharch.Text) + "',N'" + Convert.ToDecimal(txtVidyutprama.Text) + "',N'" + Convert.ToDecimal(txtVidyutvitarit.Text) + "',N'" + Convert.ToDecimal(txtDambarichaExpens.Text) + "',N'" + txtdnyapane.Text + "',N'" + Convert.ToDecimal(txtitarkhrch.Text) + "','PuneEast')";
                            ...
                            {
                                strMasterUpdateQuery = "UPDATE [GAT_AProvision] SET [MudatVadhiDate]=N'" + txtMudatVadhiDate.Text + "',[ShilakDayitvAmt]=N'" + Convert.ToDecimal(txtShilakDayitv.Text) + "',[ManjurAmt]=N'" + txtcost.Text + "',[MarchEndingExpn]=N'" + Convert.ToDecimal(txtmarchakherkharch.Text) + "',[UrvaritAmt]=N'" + txturvaritamt.Text + "',[DayitvAvshyakYesNo]=N'" + txtDayitvAvshyak.Text + "',[DayitvAmt]=N'" + Convert.ToDecimal(txtDayitavAmt.Text) + "',[DTakunone]=N'" + ddlakun1.SelectedItem.Text + "',[Takunone]=N'" + Convert.ToDecimal(txtakun1.Text) + "',[DTakuntwo]=N'" + ddlakun2.SelectedItem.Text + "',[Takuntwo]=N'" + Convert.ToDecimal(txtakun2.Text) + "',[DTakunthree]=N'" + ddlakun3.SelectedItem.Text + "',[Takunthree]=N'" + Convert.ToDecimal(txtakun3.Text) + "',[DTakunfour]=N'" + ddlakun4.Text + "',[Takunfour]=N'" + Convert.ToDecimal(txtakun4.Text) + "',[Tartud]=N'" + Convert.ToDecimal(txttartud.Text) + "',[Jan]=N'" + Convert.ToDecimal(txtjan.Text) + "',[Feb]=N'" + Convert.ToDecimal(txtfeb.Text) + "',[Mar]=N'" + Convert.ToDecimal(txtmar.Text) + "',[Apr]=N'" + Convert.ToDecimal(txtapr.Text) + "',[May]=N'" + Convert.ToDecimal(txtmay.Text) + "',[Jun]=N'" + Convert.ToDecimal(txtjun.Text) + "',[Jul]=N'" + Convert.ToDecimal(txtjul.Text) + "',[Aug]=N'" + Convert.ToDecimal(txtaug.Text) + "',[Sep]=N'" + Convert.ToDecimal(txtsep.Text) + "',[Oct]=N'" + Convert.ToDecimal(txtoct.Text) + "',[Nov]=N'" + Convert.ToDecimal(txtnov.Text) + "',[Dec]=N'" + Convert.ToDecimal(txtdec.Text) + "',[AkunAnudan]=N'" + Convert.ToDecimal(txtaikunanudan.Text) + "',[Chalumonth]=N'" + ddlchalukharch.SelectedItem.Text + "',[Chalukharch]=N'" + Convert.ToDecimal(txtchalukharch.Text) + "',[Magilmonth]=N'" + ddlmagilmonth.SelectedItem.Text + "',[Magilkharch]=N'" + Convert.ToDecimal(txtmagilkharch.Text) + "',[Magni]=N'" + Convert.ToDecimal(txtmagni.Text) + "',[VarshbharatilKharch]=N'" + Convert.ToDecimal(txtvarshbharatilkharch.Text) + "',[AikunKharch]=N'" + Convert.ToDecimal(txtaikunkharch.Text) + "',[VidyutikaranAmt]=N'" + Convert.ToDecimal(txtVidyutprama.Text) + "',[VidyutikaranExpen]=N'" + Convert.ToDecimal(txtVidyutvitarit.Text) + "',[DambarichaExpen]=N'" + txtDambarichaExpens.Text + "',[Dviguni]=N'" + txtdnyapane.Text + "',[Itarkhrch]=N'" + Convert.ToDecimal(txtitarkhrch.Text) + "' where Arthsankalpiyyear=N'" + AuditDate.Text + "' and WorkId=N'" + txtWorkID.Text.Trim() + "' and [SubDivision]='PuneEast'";
                    ...
                    if (cmd.ExecuteNonQuery() > 0 && cmdMDB.ExecuteNonQuery() > 0)
                    {
                        ...
                        SMSobj.mudatvaddate = txtMudatVadhiDate.Text.Trim();
                        ...
                        else
                        {
                            ...
                            Server.Transfer("MasterBudgetGat_A.aspx", false);
        ...
        protected void txtGatASecPass_TextChanged(object sender, EventArgs e)
        {
            if (txtGatASecPass.Text == FormPassword.ToString())
            {
                //GAT A SECTION
                txtAadeshKramank.Enabled = true;
                txtUpshirsh.Enabled = true;
