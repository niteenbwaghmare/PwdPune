<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="SReport17Columns.aspx.cs" Inherits="PWdEEBudget.SReport17Columns" enableEventValidation ="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Label ID="lblsadyProcess" runat="server" Text="Label" Visible="false"></asp:Label>
              ...
              <div id="ListMenu" class="container" style="margin-top: 10px;" runat="server">
                ...
                <table class="table table-bordered" style="border: 2px groove">
                    <tr>
                        <th colspan="3">
                            <h2>Master Individual Report</h2>
                        </th>
                    </tr>
                ...
                ErrorMessage="अर्थसंकल्पीय वर्ष निवडा!" InitialValue="Select" ForeColor="red"  Font-Size="Larger" Display="Dynamic" CssClass="blink_me" BackColor="Yellow"></asp:RequiredFieldValidator>
                        ...
                        <td>
                            <asp:Button ID="ArthsankalpiyYearbtn" runat="server" OnClick="ArthsankalpiyYearbtn_Click"
                    ...
                    <tr>
                        <td style="width: 30%">
                            <asp:Label ID="Label2" runat="server" Text="प्रकार:" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </td>
                        <td style="width: 60%">
                            <asp:DropDownList ID="ddltype" runat="server" Style="width: 50%" CssClass="form-control p">
                                <asp:ListItem>.....Select.....</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td style="width: 20%">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="लेखाशीर्ष:" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlLekhashirsh" runat="server" Style="width: 50%" CssClass="form-control p">
                                <asp:ListItem>.....Select.....</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Button ID="lekhashirshbtn" runat="server" OnClick="lekhashirshbtn_Click" Text="OK"
                                CssClass="form-control" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="उपविभाग:" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlUpvibhag" runat="server" Style="width: 50%" CssClass="form-control p">
                                <asp:ListItem>.....Select.....</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Button ID="Upvibhagbtn" runat="server" OnClick="Upvibhagbtn_Click" Text="OK"
                                CssClass="form-control" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label13" runat="server" Text="शाखा अभियंता:" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlShakhaAbhiyanta" runat="server" Style="width: 50%" CssClass="form-control p">
                                <asp:ListItem>.....Select.....</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Button ID="ShakhaAbhiyantabtn" runat="server" OnClick="ShakhaAbhiyantabtn_Click"
                                Text="OK" CssClass="form-control" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label18" runat="server" Text="उपअभियंता:" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlShakhUpAbhiyanta" runat="server" Style="width: 50%" CssClass="form-control p">
                                <asp:ListItem>.....Select.....</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Button ID="ShakhUpAbhiyanta" runat="server" OnClick="ShakhUpAbhiyanta_Click"
                                Text="OK" CssClass="form-control" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label19" runat="server" Text="तालुका:" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlTaluka" runat="server" Style="width: 50%" CssClass="form-control p">
                                <asp:ListItem>Select</asp:ListItem>
                        ...
                        <td>
                            <asp:Button ID="Talukabtn" runat="server" OnClick="Talukabtn_Click" Text="OK" CssClass="form-control" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label20" runat="server" Text="आमदार:" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlAmdar" runat="server" Style="width: 50%" CssClass="form-control p">
                                <asp:ListItem>.....Select.....</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Button ID="Amdarbtn" runat="server" OnClick="Amdarbtn_Click" Text="OK" CssClass="form-control" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label21" runat="server" Text="खासदार:" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlKhasdar" runat="server" Style="width: 50%" CssClass="form-control p">
                                <asp:ListItem>.....Select.....</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Button ID="Khasdarbtn" runat="server" OnClick="Khasdarbtn_Click" Text="OK" CssClass="form-control" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label22" runat="server" Text="ठेकेदाराचे नाव:" Font-Bold="True" ForeColor="Black"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlThekedarecheName" runat="server" Style="width: 50%" CssClass="form-control p">
                                <asp:ListItem>.....Select.....</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Button ID="ThekedarecheNamebtn" runat="server" OnClick="ThekedarecheNamebtn_Click"
                                Text="OK" CssClass="form-control" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label24" runat="server" Text="कामाची सद्यस्थिती:" Font-Bold="True"
                                ForeColor="Black"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlKamachiSadyStiti" runat="server" Style="width: 50%" CssClass="form-control p">
                                <asp:ListItem>Select</asp:ListItem>
                                <asp:ListItem>चालू</asp:ListItem>
                                <asp:ListItem>अपूर्ण</asp:ListItem>
                                <asp:ListItem>पूर्ण</asp:ListItem>
                                <asp:ListItem>सुरु करणे</asp:ListItem>
                                <asp:ListItem>अंदाजपत्रकिय स्थर </asp:ListItem>
                                <asp:ListItem>निविदा स्थर</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Button ID="KamachiSadyStiti" runat="server" OnClick="KamachiSadyStiti_Click"
                                Text="OK" CssClass="form-control" />
                        </td>
                    </tr>
                </table>
            ...
            <br />            
           <%-- <div align="center">
                <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="true" Text="Edit(Update Record)/Select(Send SMS)" Font-Bold="True" ForeColor="White" OnCheckedChanged="CheckBox1_CheckedChanged" />
            </div>--%>
           </div>
            <hr />
            ...
            <div id="Print">
                <asp:Panel ID="Panel1" runat="server">
                    <div style="overflow-x: auto">
                        ...
                        <%--<div align="center">
       <asp:Button ID="Button3" runat="server" Text="Print" CssClass="btn btn-primary" Height="40px" Width="100px" OnClick="btnPrint_Click" />
                            <asp:Button ID="btnBuildExl" runat="server" Text="Excel" CssClass="btn btn-success" Height="40px" Width="100px" OnClick="btnBuildExl_Click" />
                        </div>--%>
