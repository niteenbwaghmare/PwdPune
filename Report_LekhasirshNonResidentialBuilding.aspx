<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_LekhasirshNonResidentialBuilding.aspx.cs" Inherits="PWdEEBudget.Report_LekhasirshNonResidentialBuilding" %>
            ...
            <div id="ListMenu" runat="server" style="margin-top: 20px" class="ddlListHide">
                ...
                <div class="row" style="border: 2px solid; background-color: gray;">
                    <div class="col-md-12" style="text-align: center; color: #fff">
                        <h1>Non Residential Building Report</h1>
                    </div>
                </div>
