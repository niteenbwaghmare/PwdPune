<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterBudgetDepositFund.aspx.cs" Inherits="PWdEEBudget.MasterBudgetDepositFund" %>
     ...
     <table id="Print" class="table table-bordered mar" style="border:2px solid gray">
            ...
            <tr style="text-align:center; background:linear-gradient(gray,white);">
                 <td style="font-weight: bold; color:black" colspan="30" >
                     <asp:Label ID="Label10" runat="server" Text="Master Budget Deposite Contribution Fund" Height="70px" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
                 </td> 
           </tr>
            <tr>
                 <td  style="font-weight: bold; color: #000000" colspan="3">Work_ID</td> 
                 <td  style="font-weight: bold; color: #000000" colspan="5"> <asp:TextBox ID="txtWorkID" CssClass ="form-control c" runat ="server"  required="" PlaceHolder="नंबर" AutoPostBack="True" OnTextChanged="txtWorkID_TextChanged" TabIndex="1"></asp:TextBox>
                 ...
                 <td colspan="6" style="font-weight: bold; text-align:center; color : #000000">
                     <asp:Label ID="ddlType" runat="server" class="blink_me" ForeColor="Red" Text ="Budget Deposit Fund"></asp:Label>
                 </td>
           </tr>
             <tr><td style="font-weight: bold; color: #000000" colspan="3" >जिल्हा </td>
                 <td colspan="5" >
                 ...
                 <td colspan="7" style="font-weight: bold; color: #000000">
                  ...
                  <td style="font-weight: bold; color: #000000" colspan="2">अर्थसंकल्प बाब क्र./पृष्ठ क्र </td>
                   <td style="font-weight: bold; color: #000000" colspan="6"><asp:TextBox ID="txtarthsankalpiybab" runat="server" CssClass="form-control c" PlaceHolder="पृष्ठ क्र." TabIndex="18" ></asp:TextBox></td>
                 <td style="font-weight: bold; color: #000000" colspan="1">
                     उपविभाग
                 </td>
                 <td colspan="4" style="font-weight: bold; color: #000000">
                ...
                <tr>
                   ...
                   <td style="font-weight: bold; color: #000000" colspan="6"> 
                        <asp:DropDownList ID="ddlVibhagType" runat="server" CssClass="form-control c" Width="334px" AutoPostBack="True" TabIndex="16">
                            <asp:ListItem></asp:ListItem>
                        </asp:DropDownList>
                     </td>
            ...
            <tr>
                ...
                <td style="font-weight: bold; color: #000000" colspan="6">भ्रमणध्वनी क्रमांक</td>
                <td style="font-weight: bold; color: #000000" colspan="5"><asp:TextBox ID="txtupabhiyantamobile" runat="server" CssClass="form-control c" PlaceHolder="भ्रमणध्वनी क्रमांक"  TabIndex="10" MaxLength="10" TextMode="Phone"></asp:TextBox> </td>
            </tr>
           
            <tr>
                <td style="font-weight: bold; color: #000000" colspan="3">खासदार नाव </td>
                <td style="font-weight: bold; color: #000000" colspan="16">
                ...
                <td style="font-weight: bold; color: #000000" colspan="6">आमदार नाव</td>
                <td style="font-weight: bold; color: #000000" colspan="5">
             ...
             <tr  style="background-color :#dbd7d7">
                 ...
                 <td style="font-weight: bold; color: #000000;font-size :18px" colspan="3" ><asp:TextBox ID="txtPrakalpPassword" AutoPostBack="true" OnTextChanged="txtPrakalpPassword_TextChanged" TextMode="Password" CssClass="form-control c" runat="server"></asp:TextBox></td>
               </tr>
               <tr>
                ...
                <tr>
                    ...
                    <td style="font-weight: bold; color: #000000" colspan="9">
                     ...
                     <td style="font-weight: bold; color: #000000;text-align:center" colspan="1">
                         दिनांक </td>
                     <td style="font-weight: bold; color: #000000" colspan="9">
                     ...
                     <td style="font-weight: bold; color: #000000" colspan="3">
                         किंमत रु. लक्ष </td>
                     <td style="font-weight: bold; color: #000000" colspan="5">
                         <asp:TextBox ID="txtprashaskiykimat" runat="server" CssClass="form-control c" PlaceHolder="किंमत रु. लक्ष" TabIndex="22" >0</asp:TextBox> </td>
                 </tr>
               <tr>
                     <td style="font-weight: bold; color: #000000" colspan="3" >तांत्रिक मान्यता क्रमांक </td>
                     <td style="font-weight: bold; color: #000000" colspan="9" ><asp:TextBox ID="txttantrikkramank" runat="server" CssClass="form-control c" PlaceHolder="मान्यता क्रमांक" TabIndex="23" ></asp:TextBox></td>
                     <td style="font-weight: bold; color: #000000;text-align:center" colspan="1" >दिनांक </td>
                     <td colspan="9" ><asp:TextBox ID="txttantarikdinak" runat="server" CssClass="form-control c" PlaceHolder="दिनांक" TabIndex="24" ></asp:TextBox>
                     ...
                     <td colspan="5" > <asp:TextBox ID="txttantarikkimat" runat="server" CssClass="form-control c" PlaceHolder="किंमत रु. लक्ष" TabIndex="25" required="" >0</asp:TextBox> </td>
                     
               </tr>
                <tr  style="background-color :#dbd7d7">
                   <td style="font-weight: bold; color: #000000;font-size :18px" colspan="27" >निविदा शाखा</td>
                   <td style="font-weight: bold; color: #000000;font-size :18px" colspan="3" ><asp:TextBox ID="txtnividashakha" AutoPostBack="true" TextMode="Password" OnTextChanged="txtnividashakha_TextChanged" CssClass="form-control c" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr>
                   ...
                   <td style="font-weight: bold; color: #000000" colspan="10" ><asp:TextBox ID="txtkaryarambhdinak" CssClass="form-control c" runat="server" PlaceHolder="दिनांक" AutoPostBack="True" OnTextChanged="txtkaryarambhdinak_TextChanged" TabIndex="31"></asp:TextBox> 
                     ...
                     <td colspan="3" style="font-weight: bold; color: #000000">
                         कामाची मुदत </td>
                     <td colspan="8" style="font-weight: bold; color: #000000"><asp:TextBox ID="txtkamachimudat" runat="server" AutoPostBack="True" CssClass="form-control c" OnTextChanged="txtkamachimudat_TextChanged" PlaceHolder="करारनामा क्रमांक" TabIndex="32" onkeyup="checkDec(this);">0</asp:TextBox>
                    </td>
         ...
         <tr>
              <td style="font-weight: bold; color: #000000" colspan="5"> <asp:Label ID="lblShilakThev" runat="server"></asp:Label> मधील शिल्लक ठेव</td>
              <td style="font-weight: bold; color: #000000" colspan="10"><asp:TextBox ID="txtShillakThev" runat="server" CssClass="form-control c" TabIndex="33" >0</asp:TextBox></td>
              <td style="font-weight: bold; color: #000000" colspan="5"> <asp:Label ID="lblVitaritThev" runat="server"></asp:Label> वितरीत ठेव</td>
             <td style="font-weight: bold; color: #000000" colspan="10">  <asp:TextBox ID="txtVitaritThev" runat="server" CssClass="form-control c" TabIndex="33" >0</asp:TextBox></td>
            

         </tr>
               <tr>
                   <td style="font-weight: bold; color: #000000">कामाच्या मुदत वाढीचा दिनांक </td>
                   <td style="font-weight: bold; color: #000000" colspan="6"><asp:TextBox ID="txtmudatvadhdinak" runat="server" CssClass="form-control c" PlaceHolder="मुदत वाढीचा दिनांक" TabIndex="33"></asp:TextBox>
               ...
               <tr>
                   <td colspan="10" style="font-weight: bold; color: #000000" rowspan="2">
                       <table class="table table-bordered">
                           <tr>
                               <td colspan="2" style="font-weight: bold; color: #000000"; class="profile_picture">
                                   वर्ष
               ...
               <tr>
                   ...
                   <td colspan="7" style="font-weight: bold; color: #000000">
                    ...
                    <td colspan="3" style="font-weight: bold; color: #000000"><asp:Label ID="lekhayearchalu" runat="server"></asp:Label>
         ...
         <tr>
             ...
             <td colspan="7"><asp:TextBox ID="txtVidyutvitarit" runat="server" CssClass="form-control c" AutoPostBack="True" OnTextChanged="txtVidyutvitarit_TextChanged">0</asp:TextBox></td>
             <td colspan="3">इतर खर्च</td>
             <td colspan="4"><asp:TextBox ID="txtitarkhrch" runat="server" CssClass="form-control c" AutoPostBack="True" OnTextChanged="txtitarkhrch_TextChanged">0</asp:TextBox></td>
                    </tr>
               ...
               <tr>
                   ...
                   <td style="font-weight: bold; color: #000000" colspan="5">हस्तांतरण दिनांक / उपयोगिता प्रमाणपत्र बाबत</td>
                   <td style="font-weight: bold; color: #000000" colspan="7"><asp:TextBox ID="txtpahnikramank" runat="server" CssClass="form-control c" PlaceHolder="दिनांक" TabIndex="48" ></asp:TextBox>
          ...
          <tr>
                  <td style="font-weight: bold; color: #000000" colspan="7">पाहणी अहवाल मुद्ये</td>
                   <td style="font-weight: bold; color: #000000" colspan="23"><asp:TextBox ID="txtpahnimudye" runat="server" CssClass="form-control" style="font-size:16px;font-weight:bold" Width="100%" PlaceHolder="पाहणी अहवाल मुद्ये" TextMode="MultiLine" TabIndex="49" ></asp:TextBox> 
                   </td>
               </tr>
              
               <tr>
                   <td style="font-weight: bold; color: #000000" colspan="7">शेरा</td>
                   <td style="font-weight: bold; color: #000000" colspan="23"><asp:TextBox ID="txtshera" runat="server" CssClass="form-control" style="font-size:16px;font-weight:bold" Width="100%" PlaceHolder="शेरा" Height="40px" TextMode="MultiLine" TabIndex="50" ></asp:TextBox> </td>
               </tr>
       ...
       <br />
               ...
               <div>
                        <asp:Button ID="BtnSav" runat="server"  Text="संपादित करा" TabIndex="51" Height="10%" OnClick="BtnSav_Click" CssClass="btnform"/>
