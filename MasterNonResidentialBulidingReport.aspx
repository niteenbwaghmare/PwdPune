<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterNonResidentialBulidingReport.aspx.cs" Inherits="PWdEEBudget.MasterNonResidentialBulidingReport" EnableEventValidation="false"%>
        ...
        <ContentTemplate>
            <div class="container">
                <div id="ListMenu" runat="server" style="margin-top: 20px" class="ddlListHide">
                    <div class="row" style="border: 2px solid red; background-color: gray;">
                        <div class="col-md-12" style="text-align: center; color: #fff">
                            <h1>NonResidential Master Report</h1>
                        </div>
                    </div>
                ...
                ErrorMessage="कामाचे वर्ष निवडा!" InitialValue="निवडा" ForeColor="red"  Font-Size="Larger" Display="Dynamic" CssClass="blink_me" BackColor="Yellow"></asp:RequiredFieldValidator>
                    ...
                    <div class="row" style="border: 2px solid; background-color: gray; height: 50px">
                        <div class="col-md-1"></div>
                        <div class="col-md-3">
