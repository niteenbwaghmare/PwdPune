<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterGat_AReport.aspx.cs" Inherits="PWdEEBudget.MasterGat_AReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <hr />
            <div style="overflow-x: auto; border: 2px double">
                <asp:CheckBoxList ID="chkBuilding" runat="server" BorderStyle="Solid" BorderWidth="4px" RepeatDirection="Horizontal" class="table-bordered"  OnSelectedIndexChanged="chkBuilding_SelectedIndexChanged">
                    ...
                    <asp:ListItem Selected="True" Enabled="false" Value="a.[ArthsankalpiyBab] as 'अर्थसंकल्पीय बाब'" runat="server">अर्थसंकल्पीय बाब</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="a.[Kamachevav] as 'कामाचा वाव'" runat="server">कामाचा वाव</asp:ListItem>
                     <asp:ListItem Selected="True" Value="convert(nvarchar(max),a.[NividaKrmank])+' '+convert(nvarchar(max),a.[NividaDate])as 'कार्यारंभ आदेश'" runat="server">कार्यारंभ आदेश</asp:ListItem>
                   ...
                   <asp:ListItem Selected="True" Value="b.[Chalukharch] as 'चालू खर्च'" runat="server">चालू खर्च</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="b.[Magni] as 'मागणी'" runat="server">मागणी</asp:ListItem>
                     ...
                     <asp:ListItem Selected="True" Value="b.[VidyutikaranAmt] as 'विद्युतीकरण कामाची किंमत'" runat="server">विद्युतीकरण कामाची किंमत</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[VidyutikaranExpen] as 'विद्युतीकरणाचा खर्च'" runat="server">विद्युतीकरणाचा खर्च</asp:ListItem>

                    <asp:ListItem Selected="True" Value="a.[GAadeshKramank] as 'आदेश क्र'" runat="server">आदेश क्र </asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GUpshirsh] as 'उपशिर्ष'" runat="server">उपशिर्ष </asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GJobKramank] as 'जॉब क्र'" runat="server">जॉब क्र </asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GJobRakkam] as 'जॉब रक्कम'" runat="server">जॉब रक्कम </asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GDambarichePariman] as 'डांबरीचे परिमाण'" runat="server">डांबरीचे परिमाण  </asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GDambarichiRakkam] as 'डांबरीची रक्कम'" runat="server">डांबरीची रक्कम </asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GDurustichaprakar] as 'दुरुस्तीचा प्रकार'" runat="server">दुरुस्तीचा प्रकार  </asp:ListItem>
                    <asp:ListItem Selected="True" Value="cast(a.[GVaperDambarichePariman] as decimal(10,2)) as 'वापर डांबरीचे परिमाण'" runat="server">वापर डांबरीचे परिमाण </asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GKampurnKarnyachaDinak] as 'डांबरीचे काम पूर्ण दिनांक'" runat="server">डांबरीचे काम पूर्ण दिनांक </asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GKampurnJhalyachaDinak] as 'डांबरीचे काम पूर्ण झाल्याच्या दिनांक'" runat="server">डांबरीचे काम पूर्ण झाल्याच्या दिनांक </asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GDeyakSadarKelyachaDinak] as 'विभागात देयक सादर दिनांक'" runat="server">विभागात देयक सादर दिनांक </asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GParitKelyachaDinak] as 'विभागात देयक पारित दिनांक'" runat="server">विभागात देयक पारित दिनांक </asp:ListItem>
                    
                    <asp:ListItem Selected="True" Value="b.[ShilakDayitvAmt] as 'शिल्लक दायित्व रु'" runat="server">शिल्लक दायित्व रु</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[DayitvAvshyakYesNo] as 'दायित्व आवश्यकता आहे / नाही'" runat="server"> दायित्व आवश्यकता आहे / नाही</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[DayitvAmt] as 'दायित्व असल्यास रक्कम रु'" runat="server"> दायित्व असल्यास रक्कम रु</asp:ListItem>
                   
                    <asp:ListItem Selected="True" Value="b.[DambarichaExpen] as 'डांबरीचा खर्च'" runat="server">डांबरीचा खर्च</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[Itarkhrch] as 'इतर खर्च'" runat="server">इतर खर्च</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[Dviguni] as 'द्वीगुणी'" runat="server">द्वीगुणी</asp:ListItem>
                    
                    <asp:ListItem Selected="True" Value="a.[Pahanikramank] as 'पाहणीक्रमांक'" runat="server">पाहणीक्रमांक</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'चालू'  THEN 1 ELSE 0 END as decimal(10,0)) as 'P'" runat="server">P</asp:ListItem>
                    <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'Not Started'  THEN 1 ELSE 0 END as decimal(10,0)) as 'NS'" runat="server">NS</asp:ListItem>
                     <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'अंदाजपत्रकीय स्तर' THEN 1 ELSE 0 END as decimal(10,0)) as'ES'" runat="server">ES</asp:ListItem>  
                ...
                <div id="DivRoot" align="left">
                    <asp:Panel ID="Panel1" runat="server">
                        <div align="center">
                            ...
                            <asp:Label ID="lblGat" runat="server" Text='गट "अ"' Font-Bold="true" Font-Size="24px"></asp:Label>
                        </div>
                    </asp:Panel>
