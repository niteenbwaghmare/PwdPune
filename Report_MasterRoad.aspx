<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_MasterRoad.aspx.cs" Inherits="PWdEEBudget.Report_MasterRoad" %>
        ...
        <ContentTemplate>
            ...
            <div id="PrintDiv" runat="server">
                <div class="col-md-12" style="text-align: center; color: #443030">
                    <h3 style="font-size: 24px;">Road Abstract Report</h3>
                </div>
                <div align="center">

                    <asp:Label ID="lblPrintLekhaSirsh" Font-Bold="true" Font-Size="18px" runat="server"></asp:Label><br />
                ...
                <div id="DivRoot" align="left" style="width: 100%">
                    <div style="width: 100%">
                        ...
                        <div style="overflow: auto; width: 100%" onscroll="OnScrollDiv(this)" id="DivMainContent">
                            ...
                            <asp:GridView ID="GridView1" runat="server" RowStyle-VerticalAlign="Top" Width="100%" Caption='' DataKeyNames="WorkId" EmptyDataText="No Record Found" AutoGenerateColumns="false" ShowHeader="true" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound">
                                <%--  --%>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblNoWorks" runat="server" Text='<%# Eval("no of works") %>' />
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblBudgetHead" runat="server" Text='<%# Eval("Budget Head") %>' />
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:Label ID="lblTotalBudgetHead" runat="server" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <HeaderTemplate>
                                            Upvibhag
                                      <%--  <asp:Label ID="lbllekha" runat="server" Text="Lekhasirsh"></asp:Label>--%>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblMarProvi" runat="server" Text='<%# Eval("March Provision") %>' />
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <FooterStyle HorizontalAlign="Center" />
                                        <HeaderTemplate>
                                            <asp:Label ID="lblProvision7" runat="server"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lbljulProvi" runat="server" Text='<%# Eval("jul Provision") %>' />
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:Label ID="lblTotaljulProvi" runat="server" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
