<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterGAT_BReport.aspx.cs" Inherits="PWdEEBudget.MasterGAT_BReport" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="txtno" runat="server" Text="" Visible="False"></asp:Label>
        ...
        <ContentTemplate>
            <div class="container" style="margin-top: 20px">
                <div id="ListMenu" runat="server" class="ddlListHide">
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray;">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnKamacheYear" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btnKamacheYear_Click" Width="100px" />
                        </div>
                    </div>
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnlekhashirsh" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btnlekhashirsh_Click" Width="100px" />
                        </div>
                    </div>
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnupvibhag" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btnupvibhag_Click" Width="100px" />
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1 "></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnjilha" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btnjilha_Click" Width="100px" />
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btntaluka" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btntaluka_Click" Width="100px" />
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnworkid" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btnworkid_Click" Width="100px" />
                        </div>
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnabhiyanta" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btnabhiyanta_Click" Width="100px" />
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnupabhiyanta" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btnupabhiyanta_Click" Width="100px" />
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnamdar" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btnamdar_Click" Width="100px" />
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1 "></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnkhasdar" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btnkhasdar_Click" Width="100px" />
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnthekedar" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btnthekedar_Click" Width="100px" />
                        </div>
                    </div>
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray; height: 50px">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnkamachistiti" runat="server" ValidationGroup="rfvField" CssClass="form-control " Text="OK" OnClick="btnkamachistiti_Click" Width="100px" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="overflow-x: auto; border: double">
                <asp:CheckBoxList ID="chkBuilding" runat="server" BorderStyle="Solid" BorderWidth="4px" RepeatDirection="Horizontal" class="table-bordered" OnSelectedIndexChanged="chkBuilding_SelectedIndexChanged">
                    <asp:ListItem Selected="True" Enabled="false" Value="a.[WorkId] as 'वर्क आयडी'" runat="server">वर्क आयडी</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="a.Type as 'योजनेचे नाव'" runat="server">योजनेचे नाव</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[KamacheName] as 'कामाचे नाव'" runat="server">कामाचे नाव</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[LekhaShirshName] as 'लेखाशीर्ष नाव'" runat="server" Enabled="false">लेखाशीर्ष नाव</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="a.[KamPurnDate] as 'काम पूर्ण तारीख'" runat="server">काम पूर्ण तारीख </asp:ListItem>
                    <asp:ListItem Selected="True" Value="CAST(CASE WHEN b.[MudatVadhiDate] = ' ' or b.[MudatVadhiDate] = '0' THEN N'होय' ELSE N'नाही' END as nvarchar(max)) as 'मुदतवाढ बाबत'" runat="server">मुदतवाढ बाबत</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GJobKramank] as 'जॉब क्रमांक'" runat="server">जॉब क्रमांक</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GRoadKramank] as 'रस्ता संवर्ग/ क्रमांक'" runat="server">रस्ता संवर्ग/ क्रमांक</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GRoadPrushthbhag] as 'अस्तीत्वातील रस्त्याचा पृष्ठभाग'" runat="server">अस्तीत्वातील रस्त्याचा पृष्ठभाग</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GRoll] as 'पीक व रोल'" runat="server">पीक व रोल</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GlengthStarted] as 'लांबी किमी. पासून'" runat="server">लांबी किमी. पासून</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GlengthUpto] as 'लांबी किमी. पर्यंत'" runat="server">लांबी किमी. पर्यंत</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GlengthTotal] as 'लांबी किमी. एकूण'" runat="server">लांबी किमी. एकूण</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GNewKhadikaran] as 'नवीन खडीकरण'" runat="server">नवीन खडीकरण</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GBM_Carpet] as 'बी एम व कारपेट सिलकोट सह'" runat="server">बी एम व कारपेट सिलकोट सह</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[G20_MM] as '20 मीमी कारपेटसिलकोट सह'" runat="server">20 मीमी कारपेटसिलकोट सह</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GSurface] as 'सरफेस ड्रेसिंग'" runat="server">सरफेस ड्रेसिंग</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GRundikaran] as 'रुंदी करण'" runat="server">रुंदी करण</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GBridge_Morya] as 'पूल/ मो-या'" runat="server">पूल/ मो-या</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GRepairExpn] as 'दुरुस्तीचा प्रती खर्च'" runat="server">दुरुस्तीचा प्रती खर्च</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[GAnya] as 'अन्य'" runat="server">अन्य</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[KamachiKimat] as 'कामाची किंमत'" runat="server">कामाची किंमत</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="b.[Chalukharch] as 'चालू खर्च'" runat="server">चालू खर्च</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[VarshbharatilKharch] as 'सन 2017-18 मधील माहे एप्रिल/मे अखेरचा खर्च'" runat="server">सन 2017-18 मधील माहे एप्रिल/मे अखेरचा खर्च</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[AikunKharch] as 'एकुण कामावरील खर्च'" runat="server">एकुण कामावरील खर्च</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[Takunone] as 'प्रथम तिमाही तरतूद'" runat="server">प्रथम तिमाही तरतूद</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="b.[Tartud]as 'अर्थसंकल्पीय तरतूद'" runat="server">अर्थसंकल्पीय तरतूद</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[AkunAnudan] as 'वितरित तरतूद'" runat="server">वितरित तरतूद</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[Magni] as 'मागणी'" runat="server">मागणी</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[VidyutikaranAmt] as 'विद्युतीकरणावरील प्रमा'" runat="server">विद्युतीकरणावरील प्रमा</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[VidyutikaranExpen] as 'विद्युतीकरणावरील वितरित'" runat="server">विद्युतीकरणावरील वितरित</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="a.[PahaniMudye] as 'पाहणीमुद्ये'" runat="server">पाहणीमुद्ये</asp:ListItem>
                     <asp:ListItem Selected="True" Value="a.[Pahanikramank] as 'पाहणी क्रमांक'" runat="server">पाहणी क्रमांक</asp:ListItem>
                     <asp:ListItem Selected="True" Value="b.[Sadyasthiti] as 'देयकाची सद्यस्थिती'" runat="server">देयकाची सद्यस्थिती</asp:ListItem>                   
                    ...
                    <asp:ListItem Selected="True" Value="convert(nvarchar(max),a.[Sadyasthiti])+' '+convert(nvarchar(max),a.[Shera]) as 'शेरा'" runat="server">शेरा</asp:ListItem>
                ...
                <div id="DivRoot" align="left">
                    <asp:Panel ID="Panel1" runat="server">
                        <div align="center">
                            ...
                            <asp:Label ID="lblGat" runat="server" Text='गट "ब"' Font-Bold="true" Font-Size="24px"></asp:Label>
                   ...
                   <div class="Graph1" style="width: 100%">
                        ...
                        <div style="overflow: auto;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                            ...
                            <asp:GridView ID="GridView1" HeaderStyle-Height="150px" DataKeyNames="वर्क आयडी" runat="server" RowStyle-VerticalAlign="Top" Style="border: 2px solid" Width="100%" AutoGenerateEditButton="true" OnRowEditing="GridView1_RowEditing" AutoGenerateSelectButton="True" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" OnRowDataBound="GridView1_RowDataBound" ShowFooter="true">
                ...
                <div id="popupContact">
                    ...
                    <form id="formpop">
                        ...
                        <div class="modal-body" style="padding: 40px 50px; background: linear-gradient(#ccc,#fae8bd);">
                            ...
                            <asp:Button ID="btnSubmit" runat="server" class="btn btn-success btn-block" Text="Submit" OnClick="btnSubmit_Click1" Style="margin-left: 0 !important;" />
                        </div>
                    </form>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding: 40px 50px;">
                        <form role="form">
                            ...
                            <asp:Button ID="btnSubmit" runat="server" class="btn btn-success btn-block" Text="Submit" OnClick="btnSubmit_Click1" />
                        </form>
                    </div>
    ...
    <%--<div class="loading" align="center">
        ...
        <br />
        <img id="loaderimg" runat="server" src="loader.gif" alt="" />
    </div>--%>
