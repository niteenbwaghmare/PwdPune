<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_MasterDPDC.aspx.cs" Inherits="PWdEEBudget.Report_MasterDPDC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="container">
                ...
                <div class="row" style="border-bottom: 2px solid; background-color: gray; height: 45px">
                    <div class="col-md-1"></div>
                    <div class="col-md-3">
            ...
            <br />
            <hr />
            <div id="PrintDiv1" runat="server">
                <div class="col-md-12" style="text-align: center; color: #443030;">
                    <h3 style="font-size: 24px;">DPDC Abstract Report</h3>
                </div>
                <div align="center">
    ...
    <script type="text/javascript">
        function PrintGridData() {
            var prtGrid = document.getElementById('<%=PrintDiv1.ClientID %>');
            prtGrid.border = 0;
