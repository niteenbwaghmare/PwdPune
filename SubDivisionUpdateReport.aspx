<%@ Page Title="" Language="C#" MasterPageFile="~/SubDivision.Master" AutoEventWireup="true" CodeBehind="SubDivisionUpdateReport.aspx.cs" Inherits="PWdEEBudget.SubDivisionUpdateReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        .navbar-default .navbar-nav > li > a.updatePage {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br />
            <hr />
             <div id="divHeadBtn" runat="server" class="btn-group" align="center" style="padding: 1% 0% 1% 0%;width: 100%;background: linear-gradient(#ccc,#fae8bd);">
                ...
                <asp:Panel ID="Panel1" runat="server">
                    <div style="overflow-x: auto">
                        <div align="center">
                         ...
                         <asp:CheckBox id="chkBuildUpdate" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>
                        ...
                        <div id="DivRoot" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRow">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                    <asp:GridView ID="GridBuilding" runat="server" Width="100%"   Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" OnRowDataBound="GridBuilding_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                        ...
                        <%--<asp:CheckBox id="ChkRoad" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRoot1" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRow1">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv2(this)" id="DivMainContent1">
                                    <asp:GridView ID="GridRoad" runat="server" Width="100%"  Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridRoad_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <Columns>
                                        </Columns>
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                       ...
                       <%-- <asp:CheckBox id="ChkCRF" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootCRF" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowCRF">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv3(this)" id="DivMainContentCRF">
                                    <asp:GridView ID="GridCRF" runat="server" Width="100%" Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridCRF_RowDataBound" DataKeyNames="WorkId" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                       ...
                       <%-- <asp:CheckBox id="ChkNabard" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootNabard" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowNabard">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv4(this)" id="DivMainContentNabard">
                                    <asp:GridView ID="GridNabard" runat="server" Width="100%" Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridNabard_RowDataBound" DataKeyNames="Work Id" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <%--<asp:CheckBox id="ChkDpdc" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootDPDC" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowDPDC">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv5(this)" id="DivMainContentDPDC">
                                    <asp:GridView ID="GridDPDC" runat="server" Width="100%"  Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridDPDC_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <%--<asp:CheckBox id="ChkMla" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootMLA" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowMLA">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv6(this)" id="DivMainContentMLA">
                                    <asp:GridView ID="GridMLA" runat="server" Width="100%" Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridMLA_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <%--<asp:CheckBox id="ChkMp" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootMP" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowMP">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv7(this)" id="DivMainContentMP">
                                    <asp:GridView ID="GridMP" runat="server" Width="100%"   Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridMP_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <%--<asp:CheckBox id="ChkAnnuty" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootAunty" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowAunty">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv8(this)" id="DivMainContentAunty">
                                    <asp:GridView ID="GridAunty" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridAunty_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                       ...
                       <%-- <asp:CheckBox id="ChkDeposit" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                            <div id="DivRootDepositFund" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowDepositFund">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv1(this)"  id="DivMainContentDepositFund">
                                    <asp:GridView ID="GridDepositFund" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridDepositFund_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                       ...
                       <%-- <asp:CheckBox id="ChkGatA" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootGatA" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowGatA">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv9(this)" id="DivMainContentGatA">
                                    <asp:GridView ID="GridGatA" runat="server" Width="100%"      Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" OnRowDataBound="GridGatA_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <%--<asp:CheckBox id="ChkGatD" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootGatD" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowGatD">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv10(this)" id="DivMainContentGatD">
                                    <asp:GridView ID="GridGatD" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridGatD_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <%--<asp:CheckBox id="ChkGatF" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootGatF" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowGatF">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv11(this)" id="DivMainContentGatF">
                                    <asp:GridView ID="GridGatF" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridGatF_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <%--<asp:CheckBox id="ChkGatB" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootGatB" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowGatB">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv12(this)" id="DivMainContentGatB">
                                    <asp:GridView ID="GridGatB" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridGatB_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <%--<asp:CheckBox id="ChkGatC" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootGatC" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowGatC">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv13(this)" id="DivMainContentGatC">
                                    <asp:GridView ID="GridGatC" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="GridGatC_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <%--<asp:CheckBox id="ChkRB" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootResidentialBuilding" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowResidentialBuilding">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv14(this)" id="DivMainContentResidentialBuilding">
                                    <asp:GridView ID="GridResidentialBuilding" Width="100%" runat="server"      Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" OnRowDataBound="GridResidentialBuilding_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <%--<asp:CheckBox id="ChkNRB" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRootNonResidentialbuilding" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRowNonResidentialbuilding">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv15(this)" id="DivMainContentNonResidentialbuilding">
                                    <asp:GridView ID="GridNonResidentialbuilding" Width="100%" runat="server"      Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" OnRowDataBound="GridNonResidentialbuilding_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <%--<asp:CheckBox id="Chk2515" runat="server" Text="Edit Remark and Upload Photo"  Style="margin-left:50%"/>--%>
                        <div id="DivRoot2515" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                <div style="overflow: hidden; width: 99%" id="DivHeaderRow2515">
                                </div>
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv16(this)" id="DivMainContent2515">
                                    <asp:GridView ID="Grid2515" runat="server" Width="100%" Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top"  OnRowDataBound="Grid2515_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
