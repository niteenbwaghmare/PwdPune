<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_LekhasirshGAT_D.aspx.cs" Inherits="PWdEEBudget.Report_LekhasirshGAT_D" %>
        ...
        <div id="Print">
            ...
            <%--<div align="center">
                    <asp:Label ID="lekhashirshcode" Style="font-weight: bold; font-size: 30px;" runat="server"></asp:Label>
                     <asp:Label ID="lblName" Text="----- यांच्याकडुन प्राप्त झालेल्या ब्लॅक स्पॉट/जंक्शन सुधारणा / रस्त्यावर सुचना फलक लावणे याची यादी  (गट-ड)	" Style="font-weight: bold; font-size: 20px;" runat="server"></asp:Label>
                </div>--%>
                ...
                <div style="overflow: scroll;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AllowSorting="True" OnSorting="GridView1_Sorting" RowStyle-VerticalAlign="Top" Width="100%" Style="border: 2px solid" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Sasnanenemundilele" HeaderText="4"></asp:BoundField>
                            <asp:BoundField DataField="Pradeshikvibhag" HeaderText="5"></asp:BoundField>
                            <asp:BoundField DataField="pasun" HeaderText="6"></asp:BoundField>
                            <asp:BoundField DataField="pryant" HeaderText="7"></asp:BoundField>
                            <asp:BoundField DataField="kamachenav" HeaderText="8"></asp:BoundField>
                            <asp:BoundField DataField="varnan" HeaderText="9"></asp:BoundField>
                            <asp:BoundField DataField="ApghatKaryvahi" HeaderText="10"></asp:BoundField>
                            <asp:BoundField DataField="kamachikinmat" HeaderText="11"></asp:BoundField>
                            <asp:BoundField DataField="sadyastiti" HeaderText="12"></asp:BoundField>
                            <asp:BoundField DataField="zalelakhrch" HeaderText="13"></asp:BoundField>
                            <asp:BoundField DataField="nidhi" HeaderText="14"></asp:BoundField>
                            <asp:BoundField DataField="shera" HeaderText="15"></asp:BoundField>
