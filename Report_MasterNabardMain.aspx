<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_MasterNabardMain.aspx.cs" Inherits="PWdEEBudget.Report_MasterNabardMain" %>
        ...
        <ContentTemplate>
            ...
            <div class="container">
                ...
                <div class="row" style="border-bottom: 2px solid; background-color: gray;">
                    ...
                    <div class="col-md-6">
                        <asp:DropDownList ID="ddlArthsankalpiyYear" runat="server" Style="width: 100%;" CssClass="form-control " ForeColor="Black">
                ...
                <div class="row" style="border-bottom: 2px solid; background-color: gray;">
                    ...
                    <div class="col-md-6">
                        <asp:DropDownList ID="ddlKamacheYr" runat="server" Style="width: 100%;" CssClass="form-control " ForeColor="Black">
                            <asp:ListItem>निवडा</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="row" style="border-bottom: 2px solid; background-color: gray;">
                    <div class="col-md-1"></div>
                    <div class="col-md-3">
                        <asp:Label ID="Label1" runat="server" ForeColor="Black" Text="Budget Provision upto:" Font-Bold="True" CssClass="form-control "></asp:Label>
                    </div>
                    <div class="col-md-6">
                        <asp:DropDownList ID="ddlExpMonth" runat="server" CssClass="form-control " Style="width: 100%;" ForeColor="Black">
                            <asp:ListItem>निवडा</asp:ListItem>
                    ...
                    <div class="col-md-2">
                        <%--<asp:Button ID="Button1" runat="server" OnClick="ReportTypebtn_Click" Text="OK" CssClass="form-control" />--%>
                    </div>
                </div>
                <div class="row" style="border-bottom: 2px solid; background-color: gray;">
                    <div class="col-md-1"></div>
                    ...
                    <div class="col-md-6">
                        <asp:DropDownList ID="ddlReportType" runat="server" CssClass="form-control " Style="width: 100%;" ForeColor="Black">
                            <asp:ListItem>निवडा</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-2">
            ...
            <div id="PrintDiv" runat="server">
                <div class="col-md-12" style="text-align: center; color: #443030">
                    <h3 style="font-size: 24px;">Nabard Abstract Report</h3>
                </div>
                <div align="center">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%--<asp:Label ID="lblSadhyasisthP" runat="server" Text="Inprogress" Style="display: none;"></asp:Label>--%>
                                        </ItemTemplate>
                                        <FooterTemplate>
