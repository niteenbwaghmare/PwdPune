<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterAuntyReport.aspx.cs" Inherits="PWdEEBudget.MasterAuntyReport" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
                ...
                <div id="ListMenu" runat="server" style="margin-top: 20px" class="ddlListHide">
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray; margin-top: 2px">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:RequiredFieldValidator ID="RFVArthYear" runat="server" ControlToValidate="ddlArthYear" ValidationGroup="rfvField" ErrorMessage="अर्थसंकल्पीय वर्ष निवडा!" InitialValue="निवडा" ForeColor="red" Font-Size="Larger" Display="Dynamic" CssClass="blink_me" BackColor="Yellow"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-2">
                            <%--<strong>
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:RequiredFieldValidator ID="RFVKamcheyear" runat="server" ControlToValidate="ddlKamacheyear" ValidationGroup="rfvField" ErrorMessage="कामाचे वर्ष निवडा!" InitialValue="निवडा" ForeColor="red" Font-Size="Larger" Display="Dynamic" CssClass="blink_me" BackColor="Yellow"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button Width="100px" ID="btnlekhashirsh" runat="server"  ValidationGroup="rfvField" CssClass="form-control" Text="OK" OnClick="btnlekhashirsh_Click" />
                        </div>
                    </div>
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button Width="100px" ID="btnupvibhag" runat="server" CssClass="form-control" Text="OK" OnClick="btnupvibhag_Click" ValidationGroup="rfvField"/>
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1 "></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button Width="100px" ID="btnjilha" runat="server" CssClass="form-control" Text="OK" OnClick="btnjilha_Click" ValidationGroup="rfvField"/>
                        </div>
                    </div>
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button Width="100px" ID="btntaluka" runat="server" CssClass="form-control" Text="OK" OnClick="btntaluka_Click" ValidationGroup="rfvField"/>
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button Width="100px" ID="btnworkid" runat="server" CssClass="form-control" Text="OK" OnClick="btnworkid_Click" ValidationGroup="rfvField" />
                        </div>
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button Width="100px" ID="btnabhiyanta" runat="server" CssClass="form-control" Text="OK" OnClick="btnabhiyanta_Click" ValidationGroup="rfvField"/>
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button Width="100px" ID="btnupabhiyanta" runat="server" CssClass="form-control" Text="OK" OnClick="btnupabhiyanta_Click" ValidationGroup="rfvField" />
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button Width="100px" ID="btnamdar" runat="server" CssClass="form-control" Text="OK" OnClick="btnamdar_Click" ValidationGroup="rfvField" />
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1 "></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button Width="100px" ID="btnkhasdar" runat="server" CssClass="form-control" Text="OK" OnClick="btnkhasdar_Click" ValidationGroup="rfvField"/>
                        </div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button Width="100px" ID="btnthekedar" runat="server" CssClass="form-control" Text="OK" OnClick="btnthekedar_Click" ValidationGroup="rfvField" />
                        </div>
                    </div>
                     ...
                     <div class="row" style="border-bottom: 2px solid; background-color: gray; height: 50px">
                        ...
                        <div class="col-md-2">
                            <asp:Button Width="100px" ID="btnkamachistiti" runat="server" CssClass="form-control" Text="OK" OnClick="btnkamachistiti_Click" ValidationGroup="rfvField" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="overflow-x: auto; width: 100%">
                <asp:CheckBoxList ID="chkBuilding" runat="server" BorderStyle="Solid" BorderWidth="4px" RepeatDirection="Horizontal" class="table-bordered" OnSelectedIndexChanged="chkBuilding_SelectedIndexChanged">
                    ...
                    <asp:ListItem Selected="True" Value="a.PageNo as 'पेज क्र'" runat="server">पेज क्र</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.ArthsankalpiyBab as 'बाब क्र'" runat="server">बाब क्र</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.JulyBab as 'जुलै/ बाब क्र./पान क्र.'" runat="server">जुलै/ बाब क्र./पान क्र.</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="b.[Takunone] as'2017-18 मधील अर्थसंकल्पीय तरतूद मार्च 2017'" runat="server">2017-18 मधील अर्थसंकल्पीय तरतूद मार्च 2017</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[Takuntwo] as '2016-17 मधील अर्थसंकल्पीय तरतूद जुलै 2016'" runat="server">2016-17 मधील अर्थसंकल्पीय तरतूद जुलै 2016</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="b.[Tartud] as 'एकूण अर्थसंकल्पीय तरतूद'" runat="server">एकूण अर्थसंकल्पीय तरतूद</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[AkunAnudan] as '2016-17 मधील वितरीत तरतूद'" runat="server">2016-17 मधील वितरीत तरतूद</asp:ListItem>
                    <asp:ListItem Selected="True" Value="b.[Magni] as '2016-17 साठी मागणी'" runat="server">2016-17 साठी मागणी'</asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = 'Not Started'  THEN 1 ELSE 0 END as decimal(10,0)) as 'NS'" runat="server">NS</asp:ListItem>
                     <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = 'Estimated Stage' THEN 1 ELSE 0 END as decimal(10,0)) as'ES'" runat="server">ES</asp:ListItem>  
                        <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = 'Tender Stage' THEN 1 ELSE 0 END as decimal(10,0)) as'TS'" runat="server">TS</asp:ListItem>    
            ...
            <div id="Print">
                <div id="DivRoot" align="left">
                    <asp:Panel ID="Panel1" runat="server">
                        <div align="center">
                            <asp:Label ID="Label5" runat="server" Text="" Style="font-weight: bold; font-size: 24px;"></asp:Label><br />
                            <asp:Label ID="Label3" runat="server" Text="जोडपत्र ड" Style="font-weight: bold; font-size: 24px;"></asp:Label><br />
                            <asp:Label ID="Label4" runat="server" Text="" Style="font-weight: bold; font-size: 24px;"></asp:Label><br />
                        </div>
                    </asp:Panel>
                    <div class="Graph1" style="width: 100%">
                        ...
                        <div style="overflow: scroll;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                            ...
                            <asp:GridView ID="GridView1" runat="server" RowStyle-VerticalAlign="Top" Style="border: 2px solid" Width="100%" AutoGenerateEditButton="true" OnRowEditing="GridView1_RowEditing" DataKeyNames="वर्क आयडी" AutoGenerateSelectButton="true" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" OnRowDataBound="GridView1_RowDataBound" ShowFooter="true">
