<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_MasterDepositFund.aspx.cs" Inherits="PWdEEBudget.Report_MasterDepositFund" %>
        ...
        <ContentTemplate>
            ...
            <div class="container">
                <div class="row" style="border: 3px solid; background-color: gray; margin-top: 10px">
                    <div class="col-md-12" style="text-align: center; color: #fff">
                        <h1>Deposit Fund Abstract Report</h1>
                    </div>
                </div>
            ...
            <div id="PrintDiv" runat="server">
                <div class="col-md-12" style="text-align: center; color: #443030">
                    <h3 style="font-size: 24px;">Deposit Fund Abstract Report</h3>
                </div>
                <div align="center">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%-- <asp:Label ID="lblSadhyasisthP" runat="server" Text="चालू" Style="display: none;"></asp:Label>--%>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%-- <asp:Label ID="lblSadhyasisthIncomplete" runat="server" Text="अपूर्ण" Style="display: none;"></asp:Label>--%>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%--<asp:Label ID="lblSadhyasisthTenderStage" runat="server" Text="निविदा स्तर" Style="display: none;"></asp:Label>--%>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblEstimatedStage" runat="server" Text="0"></asp:Label>
                                            <%--<asp:Label ID="lblSadhyasisthEstimatedStage" runat="server" Text="अंदाजपत्रकीय स्तर" Style="display: none;"></asp:Label>--%>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:Label ID="lblSadhyasisthEstimatedStage1" Text="0" runat="server" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemStyle HorizontalAlign="left" />
