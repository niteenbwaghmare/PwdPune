<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Master2515Report.aspx.cs" Inherits="PWdEEBudget.Master2515Report" EnableEventValidation="false" %>
                ...
                <div id="ListMenu" runat="server" class="ddlListHide">
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray; margin-top: 2px">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:RequiredFieldValidator ID="RFVArthYear" runat="server" ControlToValidate="ddlArthYear" ErrorMessage="अर्थसंकल्पीय वर्ष निवडा!" InitialValue="निवडा" ForeColor="red" Font-Size="Larger" Display="Dynamic" CssClass="blink_me" BackColor="Yellow" ValidationGroup="rfvField2515"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-1">
                            <%--  <strong>
                        <asp:Button ID="btnworkidview" runat="server" Text="View" Style="border: 2px solid; font-size: 1.1em; color: darkblue" Font-Bold="True" CssClass="form-control" OnClientClick="PrintGrid()" Width="100px" /></strong>--%>
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:RequiredFieldValidator ID="RFVKamcheyear" runat="server" ControlToValidate="ddlKamacheyear" ErrorMessage="कामाचे वर्ष निवडा!" InitialValue="निवडा" ForeColor="red" Font-Size="Larger" Display="Dynamic" CssClass="blink_me" BackColor="Yellow" ValidationGroup="rfvField2515"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-1">
                            <asp:Button ID="btnKamacheYear" runat="server" CssClass="form-control" Text="OK" OnClick="btnKamacheYear_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-1">
                            <asp:Button ID="btnlekhashirsh" runat="server" CssClass="form-control" Text="OK" OnClick="btnlekhashirsh_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-1">
                            <asp:Button ID="btnupvibhag" runat="server" CssClass="form-control" Text="OK" OnClick="btnupvibhag_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-1">
                            <asp:Button ID="btnjilha" runat="server" CssClass="form-control" Text="OK" OnClick="btnjilha_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-1">
                            <asp:Button ID="btntaluka" runat="server" CssClass="form-control " Text="OK" OnClick="btntaluka_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-1">
                            <asp:Button ID="btnworkid" runat="server" CssClass="form-control " Text="OK" OnClick="btnworkid_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-1">
                            <asp:Button ID="btnabhiyanta" runat="server" CssClass="form-control " Text="OK" OnClick="btnabhiyanta_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-1">
                            <asp:Button ID="btnupabhiyanta" runat="server" CssClass="form-control " Text="OK" OnClick="btnupabhiyanta_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-1">
                            <asp:Button ID="btnamdar" runat="server" CssClass="form-control " Text="OK" OnClick="btnamdar_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-1">
                            <asp:Button ID="btnkhasdar" runat="server" CssClass="form-control " Text="OK" OnClick="btnkhasdar_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-1">
                            <asp:Button ID="btnthekedar" runat="server" CssClass="form-control " Text="OK" OnClick="btnthekedar_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray; height: 50px">
                        ...
                        <div class="col-md-1">
                            <asp:Button ID="btnkamachistiti" runat="server" CssClass="form-control " Text="OK" OnClick="btnkamachistiti_Click" Width="100px" ValidationGroup="rfvField2515" />
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                </div>
            ...
            <asp:Panel ID="Panel1" runat="server" BorderStyle="Double">
                <div style="overflow-x: auto;">
                    <asp:CheckBoxList ID="chkBuilding" runat="server" BorderStyle="Solid" BorderWidth="4px" RepeatDirection="Horizontal" class="table-bordered" OnSelectedIndexChanged="chkBuilding_SelectedIndexChanged">
                        ...
                        <asp:ListItem Selected="True" Value="a.[LekhaShirshName] as 'लेखाशीर्ष नाव'" runat="server">लेखाशीर्ष नाव</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Enabled="false" Value="a.[Taluka] as 'तालुका'" runat="server">तालुका</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="b.[ManjurAmt] as 'मंजूर किंमत'" runat="server">मंजूर किंमत</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="b.[VarshbharatilKharch] as 'सन 2017-2018 मधील माहे एप्रिल/मे अखेर खर्च'" runat="server">सन 2017-2018 मधील माहे एप्रिल/मे अखेर खर्च</asp:ListItem>
        ...
        function MakeStaticHeader(gridId, height, width, headerHeight, isFooter) {
            ...
            if (tbl) {
                ...
                if (str.slice(0, 4).toString() == "Year") {
                    DivHR.style.height = '147px';
                }
                else {
                    DivHR.style.height = '265px';
                }
                ...
                if (str.slice(0, 4).toString() == "Year") {
                    DivMC.style.top = -147 + 'px';
                }
                else {
                    DivMC.style.top = -265 + 'px';
                }
