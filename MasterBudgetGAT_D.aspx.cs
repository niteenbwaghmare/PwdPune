...
{
    public partial class MasterBudgetGAT_D : System.Web.UI.Page, IHttpHandler, IRequiresSessionState
    {
       ...
       static SqlQueryOrConnection ObjsqlQueryOrCon = new SqlQueryOrConnection();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["id"] != null)
                {
                    ...
                    GetID();                    
                    akunanudan();
                    BindAll_Lekha_Vibhag_VarishtType("3054_Gat_D");
        ...
        public void GetID()
        {
            ...
            {
                int i = 1;
                string select = "select top 1 Akrmank from BudgetMasterGAT_D order by Akrmank desc";
        ...
        public void auditdateset()
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select Arthsankalpiyyear from GAT_DProvision where WorkID=N'" + txtWorkID.Text.Trim() + "'", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            if (dt.Rows.Count != 0)
            {
            ...
            {
                SqlDataAdapter sda1 = new SqlDataAdapter("select Arthsankalpiyyear from BudgetMasterGAT_D where WorkID=N'" + txtWorkID.Text.Trim() + "'", con);
        ...
        public void workidsearch()
        {
            try
            {
                ...
                dt = ObjsqlQueryOrCon.Feach_Master_Data("Gat_D", txtWorkID.Text.Trim());
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        txtPradeshikVibhasathicheLaksh.Text = dr["ForDepartment"].ToString();
                        txtNichitKeleleLaksh.Text = dr["DepartmentDecided"].ToString();
                        txtAccidentPasun.Text = dr["FromAccident"].ToString();
                        txtAccodentParyant.Text = dr["AccidentExecuted"].ToString();
                ...
                else
                {
                    ...
                    txtPradeshikVibhasathicheLaksh.Text = 0.ToString();
                    txtNichitKeleleLaksh.Text = 0.ToString();
                    txtAccidentPasun.Text = 0.ToString();
                    txtAccodentParyant.Text = 0.ToString();
                    ddlsadyasthiti.SelectedIndex = 0;
                    txtpahnikramank.Text = 0.ToString();
                    txtpahnimudye.Text = "";
                    txtshera.Text = "";
                }
                yearfetchdata();
        ...
        {
            return ObjsqlQueryOrCon.GetCompletionListOfWorkID(prefixText, "Gat_D");
        }
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter("Select count(*) from GAT_DProvision where Arthsankalpiyyear=N'" + AuditDate.Text.Trim() + "' and Workid=N'" + txtWorkID.Text.Trim() + "'", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
                if (dr[0].ToString() == 0.ToString())
                {
                    ...
                    //GAT D Section
                    txtPradeshikVibhasathicheLaksh.Enabled = true;
                    txtNichitKeleleLaksh.Enabled = true;
                    txtAccidentPasun.Enabled = true;
                    txtAccodentParyant.Enabled = true;
                ...
                else
                {
                    ...
                    //GAT D Section
                    txtPradeshikVibhasathicheLaksh.Enabled = false;
                    txtNichitKeleleLaksh.Enabled = false;
                    txtAccidentPasun.Enabled = false;
                    txtAccodentParyant.Enabled = false;
        ...
        {
            DataTable dt = new DataTable();
            dt = ObjsqlQueryOrCon.FeachProvisionData("Gat_D", AuditDate.Text.Trim(), txtWorkID.Text.Trim());
        ...
        protected void BtnSav_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtPradeshikVibhasathicheLaksh.Text = ConvertDigits(txtPradeshikVibhasathicheLaksh.Text);
                txtNichitKeleleLaksh.Text = ConvertDigits(txtNichitKeleleLaksh.Text);
                txtAccidentPasun.Text = ConvertDigits(txtAccidentPasun.Text);
                txtAccodentParyant.Text = ConvertDigits(txtAccodentParyant.Text);
                TextBox3.Text = ConvertDigits(TextBox3.Text);
                ...
                if (conMDB.State != ConnectionState.Open)
                    conMDB.Open();
                SqlDataAdapter sda = new SqlDataAdapter("select Count(*) from BudgetMasterGAT_D WHERE WorkId='" + txtWorkID.Text.Trim() + "'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    if (dr[0].ToString() == 0.ToString())
                    {
                        string strMasterInsertQuery = "Insert Into [BudgetMasterGAT_D] ([WorkId],[Arthsankalpiyyear],[Akrmank],[Type] ,[Dist],[Taluka],[ArthsankalpiyBab],[Upvibhag],[LekhaShirsh],[LekhaShirshName],[SubType],[ShakhaAbhyantaName],[ShakhaAbhiyantMobile],[UpabhyantaName],[UpAbhiyantaMobile],[KhasdaracheName],[AmdaracheName],[KamacheName],[Kamachevav],[PrashaskiyKramank],[PrashaskiyDate] ,[PrashaskiyAmt],[TrantrikKrmank],[TrantrikDate],[TrantrikAmt],[ThekedaarName] ,[ThekedarMobile],[NividaKrmank],[NividaAmt],[karyarambhadesh],[NividaDate],[kamachiMudat],[KamPurnDate],[ForDepartment],[DepartmentDecided],[FromAccident],[AccidentExecuted],[Sadyasthiti],[Pahanikramank],[PahaniMudye],[Shera],[SubDivision]) Values (N'" + txtWorkID.Text.Trim() + "',N'" + txtarthsankalpiyyear.Text + "',N'" + Convert.ToInt32(lblId.Text) + "',N'GAT_D',N'" + ddldist.SelectedItem.Text + "',N'" + ddltaluka.SelectedItem.Text + "',N'" + txtarthsankalpiybab.Text + "',N'" + ddlupvibhag.SelectedItem.Text + "',N'" + ddllekhashirsh.SelectedItem.Text + "',N'" + lblLekhaName.Text + "',N'" + ddlsubtype.SelectedItem.Text + "',N'" + ddlabhiyanta.SelectedItem.Text + "',N'" + txtabhiyantamobile.Text + "',N'" + ddlupabhiyanta.SelectedItem.Text + "',N'" + txtupabhiyantamobile.Text + "',N'" + ddlkhasdarachename.SelectedItem.Text + "',N'" + ddlaamdarachename.SelectedItem.Text + "',N'" + txtkamachenav.Text + "',N'" + txtkamachavav.Text + "',N'" + txtprashaskiykramank.Text + "',N'" + txtprashaskiydinak.Text + "',N'" + txtprashaskiykimat.Text + "',N'" + txttantrikkramank.Text + "',N'" + txttantarikdinak.Text + "',N'" + txttantarikkimat.Text + "',N'" + ddlThekedarName.SelectedItem.Text + "',N'" + lblThekedarMobNo.Text + "',N'" + txtNividaKramank.Text + "',N'" + txtNividaKimat.Text + "',N'" + txtkaryarambhaadesh.Text + "',N'" + txtkaryarambhdinak.Text + "',N'" + txtkamachimudat.Text + "',N'" + txtkampurndinak.Text + "',N'" + txtPradeshikVibhasathicheLaksh.Text + "',N'" + txtNichitKeleleLaksh.Text + "',N'" + txtAccidentPasun.Text + "',N'" + Convert.ToDecimal(txtAccodentParyant.Text) + "',N'" + ddlsadyasthiti.SelectedItem.Text + "',N'" + txtpahnikramank.Text + "',N'" + txtpahnimudye.Text + "',N'" + txtshera.Text + "','PuneEast')";
                        string strProvisionInsertQuery = "INSERT INTO [GAT_DProvision] ([WorkId],[Arthsankalpiyyear],[MudatVadhiDate],[ManjurAmt],[MarchEndingExpn],[UrvaritAmt],[DTakunone],[Takunone],[DTakuntwo],[Takuntwo],[DTakunthree],[Takunthree],[DTakunfour],[Takunfour],[Tartud],[Jan],[Feb],[Mar],[Apr],[May],[Jun],[Jul],[Aug],[Sep],[Oct],[Nov],[Dec],[AkunAnudan],[Chalumonth],[Chalukharch],[Magilmonth],[Magilkharch],[VidyutikaranAmt],[VidyutikaranExpen],[Magni],[VarshbharatilKharch],[AikunKharch],[Dviguni],[Itarkhrch],[SubDivision]) VALUES('" + txtWorkID.Text.Trim() + "','" + txtarthsankalpiyyear.Text + "',N'" + txtMudatVadhiDate.Text + "',N'" + Convert.ToDecimal(txtcost.Text) + "',N'" + Convert.ToDecimal(txtmarchakherkharch.Text) + "',N'" + Convert.ToDecimal(txturvaritamt.Text) + "',N'" + ddlakun1.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun1.Text) + "', N'" + ddlakun2.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun2.Text) + "',N'" + ddlakun3.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun3.Text) + "',N'" + ddlakun4.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtakun4.Text) + "',N'" + Convert.ToDecimal(txttartud.Text) + "',N'" + Convert.ToDecimal(txtjan.Text) + "',N'" + Convert.ToDecimal(txtfeb.Text) + "',N'" + Convert.ToDecimal(txtmar.Text) + "',N'" + Convert.ToDecimal(txtapr.Text) + "',N'" + Convert.ToDecimal(txtmay.Text) + "',N'" + Convert.ToDecimal(txtjun.Text) + "',N'" + Convert.ToDecimal(txtjul.Text) + "',N'" + Convert.ToDecimal(txtaug.Text) + "',N'" + Convert.ToDecimal(txtsep.Text) + "',N'" + Convert.ToDecimal(txtoct.Text) + "',N'" + Convert.ToDecimal(txtnov.Text) + "',N'" + Convert.ToDecimal(txtdec.Text) + "',N'" + Convert.ToDecimal(txtaikunanudan.Text) + "',N'" + ddlchalukharch.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtchalukharch.Text) + "',N'" + ddlmagilmonth.SelectedItem.Text + "',N'" + Convert.ToDecimal(txtmagilkharch.Text) + "',N'" + Convert.ToDecimal(txtVidyutprama.Text) + "',N'" + Convert.ToDecimal(txtVidyutvitarit.Text) + "',N'" + Convert.ToDecimal(txtmagni.Text) + "',N'" + Convert.ToDecimal(txtvarshbharatilkharch.Text) + "',N'" + Convert.ToDecimal(txtaikunkharch.Text) + "',N'" + txtdnyapane.Text + "',N'" + Convert.ToDecimal(txtitarkhrch.Text) + "','PuneEast')";
                    ...
                    if (cmd.ExecuteNonQuery() > 0 && cmdMDB.ExecuteNonQuery() > 0)
                    {
                        ...
                        else
                        {
                            ...
                            Server.Transfer("MasterBudgetGAT_D.aspx", false);
        ...
        protected void txtGatDsecPass_TextChanged(object sender, EventArgs e)
        {
            if (txtGatDsecPass.Text == FormPassword.ToString())
            {
                //GAT D Section
                txtPradeshikVibhasathicheLaksh.Enabled = true;
                txtNichitKeleleLaksh.Enabled = true;
