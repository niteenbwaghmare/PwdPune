<%@ Page Title="" Language="C#" MasterPageFile="~/Contractor.Master" AutoEventWireup="true" CodeBehind="ContractorMasterAllReport.aspx.cs" Inherits="PWdEEBudget.ContractorMasterAllReport" EnableEventValidation = "false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br />
            <hr />
             <div class="btn-group" align="center" style="padding: 1% 0% 1% 0%;width: 100%;background: linear-gradient(#ccc,#fae8bd);">
            ...
            <div id="Print">
                <asp:Panel ID="Panel1" runat="server">
                    <div style="overflow-x: auto">
                        ...
                        <asp:CheckBox id="chkBuildUpdate" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRoot" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                    <asp:GridView ID="GridBuilding" runat="server" Width="100%" ShowFooter="true"  Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" OnRowDataBound="GridBuilding_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                        ...
                        <asp:CheckBox id="CheckBox1" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRoot1" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv2(this)" id="DivMainContent1">
                                    <asp:GridView ID="GridRoad" runat="server" Width="100%"  Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridRoad_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <Columns>
                                        </Columns>
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                        ...
                        <asp:CheckBox id="CheckBox2" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootCRF" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv3(this)" id="DivMainContentCRF">
                                    <asp:GridView ID="GridCRF" runat="server" Width="100%" Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridCRF_RowDataBound" DataKeyNames="WorkId" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox3" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootNabard" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv4(this)" id="DivMainContentNabard">
                                    <asp:GridView ID="GridNabard" runat="server" Width="100%" Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridNabard_RowDataBound" DataKeyNames="Work Id" CssClass="HideColumn">
                                        <Columns>
                                        </Columns>
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                        ...
                        <asp:CheckBox id="CheckBox4" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootDPDC" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv5(this)" id="DivMainContentDPDC">
                                    <asp:GridView ID="GridDPDC" runat="server" Width="100%"  Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridDPDC_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox5" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootMLA" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv6(this)" id="DivMainContentMLA">
                                    <asp:GridView ID="GridMLA" runat="server" Width="100%" Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridMLA_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox6" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootMP" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv7(this)" id="DivMainContentMP">
                                    <asp:GridView ID="GridMP" runat="server" Width="100%"   Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridMP_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox7" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootAunty" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv8(this)" id="DivMainContentAunty">
                                    <asp:GridView ID="GridAunty" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridAunty_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox8" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                            ...
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv1(this)"  id="DivMainContentDepositFund">
                                    <asp:GridView ID="GridDepositFund" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridDepositFund_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox9" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootGatA" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv9(this)" id="DivMainContentGatA">
                                    <asp:GridView ID="GridGatA" runat="server" Width="100%" ShowFooter="true"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" OnRowDataBound="GridGatA_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox10" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootGatD" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv10(this)" id="DivMainContentGatD">
                                    <asp:GridView ID="GridGatD" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridGatD_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox11" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootGatF" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv11(this)" id="DivMainContentGatF">
                                    <asp:GridView ID="GridGatF" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridGatF_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox12" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootGatB" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv12(this)" id="DivMainContentGatB">
                                    <asp:GridView ID="GridGatB" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridGatB_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox13" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootGatC" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv13(this)" id="DivMainContentGatC">
                                    <asp:GridView ID="GridGatC" runat="server" Width="100%"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="GridGatC_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox14" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootResidentialBuilding" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv14(this)" id="DivMainContentResidentialBuilding">
                                    <asp:GridView ID="GridResidentialBuilding" Width="100%" runat="server" ShowFooter="true"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" OnRowDataBound="GridResidentialBuilding_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox15" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRootNonResidentialbuilding" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv15(this)" id="DivMainContentNonResidentialbuilding">
                                    <asp:GridView ID="GridNonResidentialbuilding" Width="100%" runat="server" ShowFooter="true"     Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" OnRowDataBound="GridNonResidentialbuilding_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
                        ...
                        <asp:CheckBox id="CheckBox16" runat="server" Text="Upload Photo"  Style="margin-left:50%" Visible="false"/>
                        <div id="DivRoot2515" align="left" runat="server" style="width: 100%">
                            <div style="width: 100%">
                                ...
                                <div style="overflow: scroll; width: 100%" onscroll="OnScrollDiv16(this)" id="DivMainContent2515">
                                    <asp:GridView ID="Grid2515" runat="server" Width="100%" Font-Size="16px" Style="border: 2px solid" CaptionAlign="Top" ShowFooter="true" OnRowDataBound="Grid2515_RowDataBound" DataKeyNames="वर्क आयडी" CssClass="HideColumn">
                                        <EmptyDataTemplate>
                                            No Matching Record Found....!!!!!
                                        </EmptyDataTemplate>
                                        <EmptyDataRowStyle ForeColor="Red" Font-Size="Medium" />
