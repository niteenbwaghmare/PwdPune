<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterGAT_DReport.aspx.cs" Inherits="PWdEEBudget.MasterGAT_DReport" EnableEventValidation="false"%>
        ...
        <ContentTemplate>
            ...
            <div style="overflow-x: auto; border: double">
                <asp:CheckBoxList ID="chkBuilding" runat="server" BorderStyle="Solid" BorderWidth="4px" RepeatDirection="Horizontal" class="table-bordered"  OnSelectedIndexChanged="chkBuilding_SelectedIndexChanged">
                    ...
                    <asp:ListItem Selected="True" Value="a.[LekhaShirshName] as 'लेखशीर्ष नाव'" runat="server" Enabled="false">लेखाशीर्ष नाव</asp:ListItem>
                   ...
                   <asp:ListItem Selected="True" Value="b.[Chalukharch] as 'चालू खर्च'" runat="server">चालू खर्च </asp:ListItem>
                    ...
                    <asp:ListItem Selected="True" Value="a.[ForDepartment] as 'शासनाने नेमुन दिलेले प्रादेशिक विभागासाठीचे लक्ष'" runat="server">शासनाने नेमुन दिलेले प्रादेशिक विभागासाठीचे लक्ष</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[DepartmentDecided] as 'प्रादेशिक विभागाने निश्चित केलेले लक्ष'" runat="server">प्रादेशिक विभागाने निश्चित केलेले लक्ष</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[FromAccident] as 'अपघात प्रवण ठिकाण पासुन'" runat="server">अपघात प्रवण ठिकाण पासुन</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[AccidentExecuted] as 'अपघात प्रवण ठिकाण पर्यंत'" runat="server">अपघात प्रवण ठिकाण पर्यंत</asp:ListItem>
                    <asp:ListItem Selected="True" Value="a.[AccidentKaryvahi] as 'अपघात कार्यवाही'" runat="server">अपघात कार्यवाही</asp:ListItem>
                ...
                <div id="DivRoot" align="left">
                    <asp:Panel ID="Panel1" runat="server">
                        <div align="center">
                            ...
                            <asp:Label ID="lblGat" runat="server" Text='गट "ड"' Font-Bold="true" Font-Size="24px"></asp:Label>
                        </div>
                    </asp:Panel>
