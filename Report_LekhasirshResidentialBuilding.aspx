<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_LekhasirshResidentialBuilding.aspx.cs" Inherits="PWdEEBudget.Report_LekhasirshResidentialBuilding" %>
            ...
            <div id="ListMenu" runat="server" style="margin-top: 20px" class="ddlListHide">
                ...
                <div class="row" style="border: 2px solid; background-color: gray;">
                    <div class="col-md-12" style="text-align: center; color: #fff">
                        <h1>Residential Building Report</h1>
                    </div>
                </div>
