<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_MasterMLA.aspx.cs" Inherits="PWdEEBudget.Report_MasterMLA" %>
        ...
        <ContentTemplate>
            ...
            <div class="container">
                ...
                <div class="row" style="border-bottom: 2px solid; background-color: gray;">
                    <div class="col-md-1"></div>
                    <div class="col-md-3">
                        <asp:Label ID="Label2" runat="server" ForeColor="Black" Text="आमदार:" Font-Bold="True" CssClass="form-control p"></asp:Label>
                    </div>
                    <div class="col-md-6">
            ...
            <div id="PrintDiv" runat="server">
                <div class="col-md-12" style="text-align: center; color: #443030">
                    <h3 style="font-size: 24px;">MLA Abstract Report</h3>
                </div>
                <div align="center">

                    <asp:Label ID="lblPrintAmdar" Font-Bold="true" Font-Size="18px" runat="server"></asp:Label><br />                  
                ...
                <div id="DivRoot" align="left" style="width: 100%">
                    <div style="width: 100%">
                        ...
                        <div style="overflow: auto; width: 100%" onscroll="OnScrollDiv(this)" id="DivMainContent">
                            ...
                            <asp:GridView ID="GridView1" runat="server" RowStyle-VerticalAlign="Top" Width="100%" EmptyDataText="No Record Found" AutoGenerateColumns="false" ShowHeader="true" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Sr.No" HeaderStyle-Width="5%" HeaderStyle-HorizontalAlign="Left">
                                     ...
                                     <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblAmdarName" runat="server" Text='<%# Eval("AdmdarName") %>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lbl4515MLA" runat="server" Text='<%# Eval("4515 MLA") %>' />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblSadhyasisthNS" runat="server" Text="निविदा स्तर" Style="display: none;"></asp:Label>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblSadhyasisthAstar" runat="server" Text="अं स्तर " Style="display: none;"></asp:Label>
