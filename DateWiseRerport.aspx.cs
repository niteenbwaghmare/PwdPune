...
{
    public partial class DateWiseRerport : System.Web.UI.Page
    {
        int totalroad = 0;
        int totalNbard = 0;
        int totalbuild = 0;
        ...
        public void GATF()
        {
            ...
            string whereCondi = ViewState["WhereCond"].ToString() + " and Type=N'गट एफ' ";
        ...
        public void GATB()
        {
            ...
            string GroupByOrderBy = " group by a.[Upvibhag]  order by a.[Upvibhag],a.[Arthsankalpiyyear],a.[Taluka] ";
            string whereCondi = ViewState["WhereCond"].ToString() + " and Type=N'गट बी' ";
            string CompleteQuery = allreport.GatFBC(whereCondi, GroupByOrderBy);
        ...
        public void GATC()
        {
            ...
            string GroupByOrderBy = " group by a.[Upvibhag]  order by a.[Upvibhag],a.[Arthsankalpiyyear],a.[Taluka]";
            string whereCondi = ViewState["WhereCond"].ToString() + "  and Type=N'गट सी'  ";
            string CompleteQuery = allreport.GatFBC(whereCondi, GroupByOrderBy);
        ...
        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            ...
            Session["filename"] = "DateWiseReport.xls";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                {
                    StreamWriter writer = File.AppendText(path + "DateWiseReport.xls");
        ...
        protected void GridResidentialBuilding_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (e.Row.Cells[1].Text == "Total")
                {
                    ...
                    if (data.DataView.Table.Columns["चालु खर्च"] != null)
                    {
                        resibuildgrandtotal.Chalukharch += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "चालु खर्च"));
                    }
                    if (data.DataView.Table.Columns["मागणी"] != null)
                    {
                    ...
                    if (data.DataView.Table.Columns["सन 2017-2018 मधील माहे एप्रिल/मे अखेरचा खर्च"] != null)
                    {
                        resibuildgrandtotal.YearExp += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "सन 2017-2018 मधील माहे एप्रिल/मे अखेरचा खर्च"));
                    }
                    if (data.DataView.Table.Columns["विद्युतीकरणावरील प्रमा"] != null)
                    {
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[resibuildgrandtotal.Chalukharch_index].Text = resibuildgrandtotal.Chalukharch.ToString();
        ...
        protected void Grid2515_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (e.Row.Cells[1].Text == "Total")
                {
                    ...
                    if (data.Row.Table.Columns["सन 2017-2018 मधील माहे एप्रिल/मे अखेरचा खर्च"] != null)
                    {
                        grand2515total.YearExp += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "सन 2017-2018 मधील माहे एप्रिल/मे अखेरचा खर्च"));
                    }
                    if (data.Row.Table.Columns["विद्युतीकरणावरील प्रमा"] != null)
                    {
                    ...
                    if (data.DataView.Table.Columns["मंजूर अंदाजित किंमत"] != null)
                    {
                        grand2515total.ManjurAmt += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "मंजूर अंदाजित किंमत"));
                    }
                    if (data.DataView.Table.Columns["उर्वरित किंमत"] != null)
                    {
        ...
        {
            string StartDate = ViewState["SD"].ToString();
            string EndDate = ViewState["ED"].ToString();
            ViewState["WhereCond"] = " where b.Arthsankalpiyyear='" + ddlArthsankalpiyYear.SelectedItem.ToString() + "' and convert(date,KamPurnDate,105) between CONVERT(date,'" + StartDate + "',105) and CONVERT(date,'" + EndDate + "',105)  ";
            AllMethodsGrid();
            //System.Threading.Thread.Sleep(5000);
        ...
        {
            DateTime dos = DateTime.Parse(txtStartDate.Text.Trim());
            StartDate = dos.ToString("dd/MM/yyyy");
            ViewState["SD"] = StartDate;
        }

        protected void txtEndDate_TextChanged(object sender, EventArgs e)
        {
            DateTime doe = DateTime.Parse(txtEndDate.Text.Trim());
            Enddate = doe.ToString("dd/MM/yyyy");
            ViewState["ED"] = Enddate;
        }
