<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterBuildingReport.aspx.cs" Inherits="PWdEEBudget.MasterBuildingReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                ErrorMessage="कामाचे वर्ष निवडा!" InitialValue="निवडा" ForeColor="red"  Font-Size="Larger" Display="Dynamic" CssClass="blink_me" BackColor="Yellow" ValidationGroup="rfvField"></asp:RequiredFieldValidator>
                    ...
                    <div class="row" style="border: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-6">
                            ...
                            <%-- <asp:RequiredFieldValidator ID="RFVLekhashirsh" runat="server" ControlToValidate="ddlLekhashirsh"
                ErrorMessage="लेखाशीर्ष निवडा!" InitialValue="निवडा" ForeColor="red"  Font-Size="Larger" Display="Dynamic" CssClass="blink_me"></asp:RequiredFieldValidator>--%>
                        </div>
                        <div class="col-md-2">
                            <asp:Button ID="btnlekhashirsh" runat="server" CssClass="form-control " Text="OK" OnClick="btnlekhashirsh_Click" Width="100px" />
                        </div>
                    ...
                    <div class="row" style="border: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnupvibhag" runat="server" CssClass="form-control " Text="OK" OnClick="btnupvibhag_Click" Width="100px" />
                        </div>
                    ...
                    <div class="row" style="border: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnjilha" runat="server" CssClass="form-control " Text="OK" OnClick="btnjilha_Click" Width="100px" />
                        </div>
                    </div>
                    <div class="row" style="border: 2px solid; background-color: gray">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btntaluka" runat="server" CssClass="form-control " Text="OK" OnClick="btntaluka_Click" Width="100px" />
                        </div>
                    ...
                    <div class="row" style="border: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnworkid" runat="server" CssClass="form-control " Text="OK" OnClick="btnworkid_Click" Width="100px" />
                        </div>
                    ...
                    <div class="row" style="border: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnabhiyanta" runat="server" CssClass="form-control " Text="OK" OnClick="btnabhiyanta_Click" Width="100px" />
                        </div>
                    </div>
                    <div class="row" style="border: 2px solid; background-color: gray">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnupabhiyanta" runat="server" CssClass="form-control " Text="OK" OnClick="btnupabhiyanta_Click" Width="100px" />
                        </div>
                    ...
                    <div class="row" style="border: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnamdar" runat="server" CssClass="form-control " Text="OK" OnClick="btnamdar_Click" Width="100px" />
                        </div>
                    ...
                    <div class="row" style="border: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnkhasdar" runat="server" CssClass="form-control " Text="OK" OnClick="btnkhasdar_Click" Width="100px" />
                        </div>
                    ...
                    <div class="row" style="border: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnthekedar" runat="server" CssClass="form-control " Text="OK" OnClick="btnthekedar_Click" Width="100px" />
                        </div>

                    </div>

                    <div class="row" style="border: 2px solid; background-color: gray; height: 60px">
                        <div class="col-md-1"></div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnkamachistiti" runat="server" CssClass="form-control " Text="OK" OnClick="btnkamachistiti_Click" Width="100px" />
                        </div>
            ...
            <br />
            <%--<asp:Button runat="server" Text="Show/Hide List" ID="btnHideList" CssClass="ddlList" />--%>
            ...
            <asp:Panel ID="Panel2" runat="server" BorderStyle="Double">
                <div style="overflow-x: auto;">
                    <asp:CheckBoxList ID="chkBuilding" runat="server" BorderStyle="Solid" BorderWidth="4px" RepeatDirection="Horizontal" class="table-bordered"  OnSelectedIndexChanged="chkBuilding_SelectedIndexChanged">
                        ...
                        <asp:ListItem Selected="True" Enabled="false" Value="a.[LekhaShirshName] as 'लेखाशीर्ष नाव'" runat="server">लेखाशीर्ष नाव</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="a.[Taluka] as 'तालुका'" runat="server">तालुका</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="convert(nvarchar(max),a.[UpabhyantaName])+' '+convert(nvarchar(max),a.[UpAbhiyantaMobile]) as 'उपअभियंता नाव'" runat="server">उपभियंताचे नाव</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="convert(nvarchar(max),a.[NividaKrmank])+' '+convert(nvarchar(max),a.[NividaDate])as 'कार्यारंभ आदेश दिनांक'" runat="server">कार्यारंभ आदेश दिनांक</asp:ListItem>
                        <asp:ListItem Selected="True" Value="a.[NividaAmt] as 'निविदा रक्कम % कमी / जास्त'"  runat="server">निविदा रक्कम % कमी / जास्त</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="a.[KamPurnDate] as 'काम पूर्ण तारीख'" runat="server">काम पूर्ण तारीख </asp:ListItem>
                         <asp:ListItem Selected="True" Value="CAST(CASE WHEN b.[MudatVadhiDate] = ' ' or b.[MudatVadhiDate] = '0' THEN N'होय' ELSE N'नाही' END as nvarchar(max)) as 'मुदतवाढ बाबत'" runat="server">मुदतवाढ बाबत</asp:ListItem>
                          <asp:ListItem Selected="True" Value="b.[ManjurAmt] as 'मंजूर अंदाजित किंमत'" runat="server">मंजूर अंदाजित किंमत</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="b.[UrvaritAmt] as 'उर्वरित किंमत'" runat="server">उर्वरित किंमत</asp:ListItem>
                        <asp:ListItem Selected="True" Value="b.[Chalukharch] as 'चालु खर्च'" runat="server">चालु खर्च</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="convert(nvarchar(max),a.[Sadyasthiti])+' '+convert(nvarchar(max),a.[Shera]) as 'शेरा / कामाची सद्यस्थिती'" runat="server">शेरा / कामाची सद्यस्थिती</asp:ListItem>  
                               
                        <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'पूर्ण'  THEN 1 ELSE 0 END as decimal(10,0)) as 'C'" runat="server">C</asp:ListItem>
                    <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'प्रगतीत'  THEN 1 ELSE 0 END as decimal(10,0)) as 'P'" runat="server">P</asp:ListItem>
                    <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'सुरू करणे'  THEN 1 ELSE 0 END as decimal(10,0)) as 'NS'" runat="server">NS</asp:ListItem>
                     <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'अंदाजपत्रकिय स्थर ' THEN 1 ELSE 0 END as decimal(10,0)) as'ES'" runat="server">ES</asp:ListItem>  
                        <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[Sadyasthiti] = N'निविदा स्तर' THEN 1 ELSE 0 END as decimal(10,0)) as'TS'" runat="server">ST</asp:ListItem>         
    ...
    <br />
    <div align="center">
        <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" Text="Edit(Update Record)/Select(Send SMS)" Style="color: black; border-radius: 25%;" OnCheckedChanged="CheckBox1_CheckedChanged" />
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
                ...
                <div id="DivRoot" align="left" style="width: 100%">
                    ...
                    <div class="Graph1" style="width: 100%">
                        ...
                        <div style="overflow: auto; width: 100%" onscroll="OnScrollDiv(this)" id="DivMainContent">
                            ...
                            <asp:GridView ID="GridView1" runat="server" DataKeyNames="वर्क आयडी" Width="100%" Style="border: 2px solid;" AutoGenerateEditButton="true" OnRowEditing="GridView1_RowEditing" AutoGenerateSelectButton="True" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" OnRowDeleting="GridView1_RowDeleting" OnRowDataBound="GridView1_RowDataBound" ShowFooter="true">


                                <Columns>
                                    <asp:CommandField ShowDeleteButton="true" ControlStyle-ForeColor="blue" />
                                   <%-- <asp:HyperLinkField NavigateUrl="~/UploadImage.aspx" Text="UploadImage" />--%>
                                    <%--                                    <asp:TemplateField HeaderText="Delete" HeaderStyle-Width="5%" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
            ...
            <div id="abc" class="modal fade" style="opacity: 3.95 !important;">
             ...
             <div class="col-lg-12 col-md-12 col-sm-12 Graph2" style="text-align: center;">
                        <div style="height: 100%; width: 100%;">


                            <asp:Chart ID="Chart2" runat="server" Height="500px" Width="800px" Compression="1" CssClass="img-responsive MasterRptChart popbtn1"  Palette="None">
    ...
    //    }
       ...
       // function AddTHEAD() {
          //  var table = document.getElementById('<%= pnlForm.ClientID %>');
          ///  if (table != null) {
     ...
     //   function printform() {
            //var prtContent = document.getElementById('<%= pnlForm.ClientID %>');
         ...
         //   var windowName = 'Print' + uniqueName.getTime();
            ...
            //var head = document.createElement("THEAD");
            //head.style.display = "table-header-group";         
            //head.appendChild("nitin");
            //head.appendChild(tbl.cloneNode(true));
            //alert(head.innerHTML);
          //  prtContent.insertBefore(head, prtContent.childNodes[0]);
        //    var WinPrint = window.open('', '', 'left=0,top=0,width=1000,height=600,tollbar=0,scrollbars=1,status=0,resizable=1');
