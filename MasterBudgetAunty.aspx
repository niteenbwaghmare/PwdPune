<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterBudgetAunty.aspx.cs" Inherits="PWdEEBudget.MasterBudgetAunty" %>
                ...
                <table id="Print" class="table table-bordered mar" style="border: 2px solid gray">
                    ...
                    <tr style="text-align: center; background:linear-gradient(gray,white);">
                        <td colspan="23" style="color:black">
                            <asp:Label ID="Label10" runat="server" Text="Master Budget Annuity" Height="70px" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>Work_ID</td>
                   ...
                   <td style="font-weight: bold; color: #000000" colspan="6"><asp:TextBox ID="txtarthsankalpiybab" runat="server" CssClass="form-control c" PlaceHolder="पृष्ठ क्र." TabIndex="18" required=""></asp:TextBox></td>--%>
                    ...
                    <tr style="background-color: #dbd7d7">
                        ...
                        <td>
                            <asp:TextBox ID="txtPrakalpPassword" CssClass="form-control c" runat="server" AutoPostBack="true" TextMode="Password" OnTextChanged="txtPrakalpPassword_TextChanged"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>कामाचे नाव </td>
                        <td colspan="10">
                    ...
                    <tr style="background-color: #dbd7d7">
                        ...
                        <td>
                            <asp:TextBox ID="txtnividashakha" CssClass="form-control c" runat="server" AutoPostBack="true" TextMode="Password" OnTextChanged="txtnividashakha_TextChanged"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>ठेकेदाराचे नाव
                        </td>
