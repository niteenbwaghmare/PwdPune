<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_Lekhasirsh2515.aspx.cs" Inherits="PWdEEBudget.Report_Lekhasirsh2515" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div style="overflow: auto;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AllowSorting="True" OnSorting="GridView1_Sorting" RowStyle-VerticalAlign="Top" Style="border: 2px solid;" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="prashaskiy" HeaderText="3"></asp:BoundField>
                            <asp:BoundField DataField="tantrik" HeaderText="4"></asp:BoundField>
                            ...
                            <asp:BoundField DataField="akndan" HeaderText="11"></asp:BoundField>
                            <asp:BoundField DataField="magch" HeaderText="12"></asp:BoundField>
                            <asp:BoundField DataField="chalch" HeaderText="13"></asp:BoundField>
                            <asp:BoundField DataField="aknkharch" HeaderText="14"></asp:BoundField>
                            <asp:BoundField DataField="mudatvadh" HeaderText="15"></asp:BoundField>
                            <asp:BoundField DataField="vidprama" HeaderText="16"></asp:BoundField>
                            <asp:BoundField DataField="vidtarit" HeaderText="17"></asp:BoundField>
                            <asp:BoundField DataField="dvini" HeaderText="18"></asp:BoundField>
                            <asp:BoundField DataField="pankr" HeaderText="19"></asp:BoundField>
                            <asp:BoundField DataField="shera" HeaderText="20"></asp:BoundField>
                            <asp:BoundField DataField="abhiyanta" HeaderText="21"></asp:BoundField>
                        </Columns>
                        <EmptyDataTemplate>
    ...
    <div align="center">
        ...
        <asp:Button ID="btnBack" runat="server" Text="Back" class="btn btn-default btnform" BackColor="#660000" OnClientClick="JavaScript:window.history.back(1); return false;" Height="40px" Width="100px" />
    </div>
