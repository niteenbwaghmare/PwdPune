<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterMPReport.aspx.cs" Inherits="PWdEEBudget.MasterMPReport" EnableEventValidation="false" %>
            ...
            <div class="container">
                <div id="ListMenu" runat="server" style="margin-top: 20px" class="ddlListHide">
                    ...
                    <div class="row" style="border-bottom: 2px solid; background-color: gray">
                        ...
                        <div class="col-md-6">
                            <asp:DropDownList ID="ddlKhasdar" runat="server" CssClass="form-control p" AutoPostBack="True" ForeColor="Black" OnSelectedIndexChanged="ddlKhasdar_SelectedIndexChanged">
                                <asp:ListItem>निवडा</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-2">
            ...
            <asp:Panel ID="Panel1" runat="server" BorderStyle="Double">
                ...
                <div style="overflow-x: auto">
                    <asp:CheckBoxList ID="chkBuilding" runat="server" BorderStyle="Solid" BorderWidth="4px" RepeatDirection="Horizontal" class="table-bordered" OnSelectedIndexChanged="chkBuilding_SelectedIndexChanged">
                        ...
                        <asp:ListItem Selected="True" Enabled="false" Value="a.[KhasdaracheName] as 'खासदारांचे नाव'" runat="server">खासदारांचे नाव</asp:ListItem>
                        <asp:ListItem Selected="True" Enabled="false" Value="a.[Arthsankalpiyyear] as 'अर्थसंकल्पीय बाब क्र./प्रथम समाविष्ट झालेल्या वर्ष'" runat="server">अर्थसंकल्पीय बाब क्र./प्रथम समाविष्ट झालेल्या वर्ष</asp:ListItem>
                        <asp:ListItem Selected="True" Enabled="false" Value="a.[PageNo] as 'प्रकार'" runat="server">प्रकार</asp:ListItem>
                        <asp:ListItem Selected="True" Value="a.[Type] as 'जिल्हा/योजना'" runat="server">जिल्हा/योजना</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="convert(nvarchar(max),a.[NividaKrmank])+' '+convert(nvarchar(max),a.[NividaDate])as 'कार्यांरभ आदेश/दिनांक'" runat="server">कार्यांरभ आदेश/दिनांक</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="CAST(CASE WHEN a.[LekhaShirsh] = N'५०५४४२४६'  THEN 1 ELSE 0 END as decimal(10,0)) as 'एकूण कामे'" runat="server">एकूण कामे</asp:ListItem>
                        <asp:ListItem Selected="True" Value="b.[MudatVadhiDate] as 'मुदतवाढ दिनांक'" runat="server">मुदतवाढ दिनांक</asp:ListItem>
                        <asp:ListItem Selected="True" Value="b.[ManjurAmt] as 'सन 2017-18 मधील अपेक्षित खर्च'" runat="server">सन 2017-18 मधील अपेक्षित खर्च</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="b.[UrvaritAmt] as 'उर्वरित किंमत (6-(8+9))'" runat="server">उर्वरित किंमत (6-(8+9))</asp:ListItem>
                        <asp:ListItem Selected="True" Value="b.[Chalukharch] as 'एकुण उपलब्ध अनुदान'" runat="server">एकुण उपलब्ध अनुदान</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="b.[AikunKharch] as 'एकुण खर्च'" runat="server">एकुण खर्च</asp:ListItem>
                        ...
                        <asp:ListItem Selected="True" Value="b.[Magni] as 'मागणी  2017-18'" runat="server">मागणी  2017-18</asp:ListItem>

                        <asp:ListItem Selected="True" Value="b.[Vidyutprama] as 'विद्युतप्रमा'" runat="server">विद्युतप्रमा</asp:ListItem>
                        <asp:ListItem Selected="True" Value="b.[Vidyutvitarit] as 'विद्युत वितरीत'" runat="server">विद्युत वितरीत</asp:ListItem>
            ...
            <div id="Print">
                <div id="DivRoot" align="left">
                    <asp:Panel ID="Panel2" runat="server">
                        <div align="center">
                            <asp:Label ID="Label3" runat="server" Style="font-weight: bold; font-size: 24px;"></asp:Label><br />
                            <asp:Label ID="Label4" runat="server" Text="" Style="font-weight: bold; font-size: 24px;"></asp:Label><br />
                            <asp:Label ID="Label5" runat="server" Style="font-weight: bold; font-size: 24px;"></asp:Label><br />
                        </div>
                    </asp:Panel>
                    <div class="Graph1" style="width: 100%">
                        ...
                        <div style="overflow: auto;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                            ...
                            <asp:GridView ID="GridView1" runat="server" DataKeyNames="वर्क आयडी" RowStyle-VerticalAlign="Top" Style="border: 2px solid" Width="100%" OnRowDataBound="GridView1_RowDataBound" AutoGenerateEditButton="true" OnRowEditing="GridView1_RowEditing" AutoGenerateSelectButton="true" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" ShowFooter="true">
