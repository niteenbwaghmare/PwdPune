<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterBudget2515.aspx.cs" Inherits="PWdEEBudget.MasterBudget2515" %>
     ...
     <table id="Print" class="table table-bordered mar" style="border:2px solid gray">
            ...
            <tr style="text-align:center; background:linear-gradient(gray,white);">
                 <td colspan="23" style="color:black">
                     <asp:Label ID="Label10" runat="server" Text="Master Budget Gramvikas-2515" Font-Bold="True" Height="70px" Font-Size="XX-Large"></asp:Label>
                 </td> 
           </tr>
            <tr>
                 <td>Work_ID</td> 
                 <td colspan="4"> <asp:TextBox ID="txtWorkID" CssClass ="form-control c" runat ="server"  required="" PlaceHolder="नंबर" AutoPostBack="True" OnTextChanged="txtWorkID_TextChanged" TabIndex="1"></asp:TextBox>
                 ...
                 <td colspan="4" style="text-align:center;">
                     <asp:Label ID="ddltype" runat="server" Text="Gramvikas-2515"></asp:Label>
                 </td>
           </tr>
             <tr><td >जिल्हा </td>
                 <td colspan="4" >
             ...
             <tr>
                 ...
                 <td colspan="9">
                    ...
                    <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="prakar" runat="server" ErrorMessage="उपभोक्ता विभाग निवडा" SetFocusOnError="true" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator> --%>
                 </td>
                 <td colspan="2">बाब क्र॰</td>
                 <td colspan="8"><asp:TextBox ID="txtarthsankalpiybab" CssClass="form-control c" runat="server"></asp:TextBox></td>
                 <td colspan="1">जुलै २०१६. बाब क्र॰ / पेज क्र॰</td>
                 <td colspan="2"><asp:TextBox ID="txtjulybab" CssClass="form-control c" runat="server"></asp:TextBox></td>
             </tr>
                <tr>
            ...
            <tr>
                ...
                <td colspan="6">भ्रमणध्वनी क्रमांक</td>
                <td colspan="3"><asp:TextBox ID="txtupabhiyantamobile" runat="server" CssClass="form-control c" PlaceHolder="भ्रमणध्वनी क्रमांक"  TabIndex="10" MaxLength="10" TextMode="Phone"></asp:TextBox> </td>
            </tr>
            <tr>
                <td>खासदार नाव </td>
                <td colspan="13">
             ...
             <tr  style="background-color :#dbd7d7">
                   ...
                   <td ><asp:TextBox ID="txtPrakalpPassword" AutoPostBack="true" OnTextChanged="txtPrakalpPassword_TextChanged" TextMode="Password" CssClass="form-control c" runat="server"></asp:TextBox></td>
               </tr>
               <tr>
                   <td>कामाचे नाव </td>
                   <td colspan="10"><asp:TextBox ID="txtkamachenav" runat="server" CssClass="form-control" style="font-size:16px;font-weight:bold" Width="100%" PlaceHolder="कामाचे नाव" TabIndex="19" TextMode="MultiLine"></asp:TextBox> </td>
                ...
                <tr>
                    ...
                    <td colspan="7">
                     ...
                     <td colspan="3">
                         किंमत रु. लक्ष </td>
                     <td colspan="3">
                         <asp:TextBox ID="txtprashaskiykimat" runat="server" CssClass="form-control c" PlaceHolder="किंमत रु. लक्ष" TabIndex="22" onkeyup="checkDec(this);">0</asp:TextBox> </td>
                 </tr>
               <tr>
                     <td >तांत्रिक मान्यता क्रमांक </td>
                     <td colspan="7" ><asp:TextBox ID="txttantrikkramank" runat="server" CssClass="form-control c" PlaceHolder="मान्यता क्रमांक" TabIndex="23"></asp:TextBox></td>
                     <td colspan="1" >दिनांक </td>
                     <td colspan="8" ><asp:TextBox ID="txttantarikdinak" runat="server" CssClass="form-control c" PlaceHolder="दिनांक" TabIndex="24"></asp:TextBox>
                     ...
                     <td colspan="3" > <asp:TextBox ID="txttantarikkimat" runat="server" CssClass="form-control c" PlaceHolder="किंमत रु. लक्ष" TabIndex="25" onkeyup="checkDec(this);">0</asp:TextBox> </td>
                     
               </tr>
                <tr  style="background-color :#dbd7d7">
                   <td style="font-size :18px" colspan="22" >निविदा शाखा</td>
                   <td ><asp:TextBox ID="txtnividashakha" AutoPostBack="true" OnTextChanged="txtnividashakha_TextChanged" TextMode="Password" CssClass="form-control c" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                   <td>ठेकेदाराचे नाव</td>
                     <td colspan="13">
                ...
                <tr>
                   ...
                   <td colspan="8" ><asp:TextBox ID="txtkaryarambhdinak" CssClass="form-control c" runat="server" PlaceHolder="दिनांक" AutoPostBack="True" OnTextChanged="txtkaryarambhdinak_TextChanged" TabIndex="31"></asp:TextBox> 
                     ...
                     <td colspan="2">
                         कामाची मुदत </td>
                     <td colspan="8"><asp:TextBox ID="txtkamachimudat" runat="server" AutoPostBack="True" CssClass="form-control c" OnTextChanged="txtkamachimudat_TextChanged" PlaceHolder="करारनामा क्रमांक" TabIndex="32" onkeyup="checkDec(this);">0</asp:TextBox>
                    </td>
               ...
               <tr>
                   ...
                   <td colspan="5"><asp:TextBox ID="txtmudatvadhdinak" runat="server" CssClass="form-control c" PlaceHolder="मुदत वाढीचा दिनांक" TabIndex="33"></asp:TextBox>
                   ...
                   <td colspan="2"> सन <asp:Label ID="apekshitkharch" runat="server"></asp:Label> मधील अपेक्षित खर्च </td>
                   <td colspan="5">
                   ...
                   <td><asp:TextBox ID="txturvaritamt" CssClass="form-control c" runat="server" Enabled="False" onkeyup="checkDec(this);">0</asp:TextBox></td>
                   
                    
                    </tr>
              <tr>
                  <td>सद्यस्थिती</td>
                  <td colspan="6"><asp:TextBox ID="Billpayment" runat="server" CssClass="form-control c" TabIndex="33">0</asp:TextBox></td>
                  <td colspan="16" rowspan="2">
                      <table align="center" class="table table-bordered">
                          ...
                          <tr>
                              ...
                              <td colspan="4">
                                  <asp:TextBox ID="txtaikunanudan" runat="server" CssClass="form-control c" Enabled="False" PlaceHolder="एकुण वितरीत अनुदान" TabIndex="42" onkeyup="checkDec(this);">0</asp:TextBox>
                              </td>
                          </tr>
                      </table>
                  </td>
               ...
               <tr>
                   <td colspan="7" rowspan="2">
                       <table class="table table-bordered">
                           <tr>
                               <td colspan="2" class="profile_picture">
                                   वर्ष
               ...
               <tr>
                   ...
                   <td colspan="7">
                    ...
                    <td colspan="3"><asp:Label ID="lekhayearchalu" runat="server"></asp:Label>
            ...
            <tr>
             ...
             <td colspan="2">विद्युतीकरणाचा खर्च</td>
             ...
             <td colspan="4"><asp:TextBox ID="txtdnyapane" runat="server" CssClass="form-control c">0</asp:TextBox></td>
               </tr>
               <tr>
                   ...
                   <td colspan="4">काम पूर्ण होण्याचा दिनांक</td>
                   <td colspan="6"><asp:TextBox ID="txtpahnikramank" runat="server" CssClass="form-control c" PlaceHolder="पाहणी अहवाल क्रमांक" TabIndex="48" ></asp:TextBox> </td>
                        <ajaxtoolkit:calendarextender ID="cal1" runat="server" BehaviorID="txtpahnikramank" TargetControlID="txtpahnikramank" Format="dd/MM/yyyy" ></ajaxtoolkit:calendarextender>
                   <td colspan="4">पाहणी अहवाल मुद्ये</td>
                   <td colspan="4"><asp:TextBox ID="txtpahnimudye" runat="server" CssClass="form-control" style="font-size:16px;font-weight:bold" Width="100%" PlaceHolder="पाहणी अहवाल मुद्ये" TextMode="MultiLine" TabIndex="49" ></asp:TextBox> 
                   </td>
               ...
               <tr>
                   ...
                   <td colspan="19"><asp:TextBox ID="txtshera" runat="server" CssClass="form-control" style="font-size:16px;font-weight:bold" Width="100%" PlaceHolder="शेरा" Height="40px" TextMode="MultiLine" TabIndex="50" ></asp:TextBox> </td>
               </tr>
