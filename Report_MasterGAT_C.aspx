<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_MasterGAT_C.aspx.cs" Inherits="PWdEEBudget.Report_MasterGAT_C" %>
        ...
        <ContentTemplate>
            ...
            <div class="container">
                ...
                <div class="row" style="border-bottom: 2px solid; background-color: gray;">
                    ...
                    <div class="col-md-6">
                        <asp:DropDownList ID="ddlArthsankalpiyYear" runat="server" CssClass="form-control p" ForeColor="Black">
                ...
                <div class="row" style="border-bottom: 2px solid; background-color: gray;">
                    ...
                    <div class="col-md-6">
                        <asp:DropDownList ID="ddlKamacheYr" runat="server" CssClass="form-control p" ForeColor="Black">
                            <asp:ListItem>निवडा</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-2">
