<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_MasterNonResidentialBuilding.aspx.cs" Inherits="PWdEEBudget.Report_MasterNonResidentialBuilding" %>
        ...
        <ContentTemplate>
            ...
            <div class="container">
                <div class="row" style="border: 3px solid; background-color: gray; margin-top: 10px">
                    <div class="col-md-12" style="text-align: center; color: #fff">
                        <h1>NonResidential Building Abstract Report</h1>
                    </div>
                </div>
            ...
            <asp:Button ID="btnworkid" runat="server" CssClass="form-control p" Text="OK" />
                ...
                <div class="row" style="border-bottom: 2px solid; background-color: gray;">
                    <div class="col-md-1"></div>
                    <div class="col-md-3">
                        <asp:Label ID="Label2" runat="server" ForeColor="Black" Text="उपविभाग" Font-Bold="True" CssClass="form-control p"></asp:Label>
                    </div>
                    <div class="col-md-6">
            ...
            <div id="Print" runat="server">
                <div class="col-md-12" style="text-align: center; color: #443030">
                    <h3 style="font-size: 24px;">NonResidential Building Abstract Report</h3>
                </div>
                 <div align="center">
                            ...
                            <asp:UpdatePanel ID="up" runat="server">
                                <ContentTemplate>
                                    <div style="height: auto; width: 100%; overflow: auto;">
                                        <asp:GridView ID="GridView1" runat="server" RowStyle-VerticalAlign="Top" EmptyDataText="No record found" Width="100%" Caption='' AutoGenerateColumns="false" ShowHeader="true" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblUpvibhagName" runat="server" Text='<%# Eval("Upvibhag") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        एकूण
                                                    </FooterTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                       ...
                                                       <%-- <asp:Label ID="lblSadhyasisthAstar1" runat="server" Text="अंदाजपत्रकिय स्थर " Style="display: none;"></asp:Label>--%>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblSadhyasisthAstar1" runat="server" />
                                                    </FooterTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <asp:Label ID="lblSadhyasisthNStar" runat="server" Text="निविदा स्तर" Style="display: none;"></asp:Label>--%>
                                                       ...
                                                       <%-- <asp:Label ID="lblSadhyasisthNS1" runat="server" Text="निविदा स्तर" Style="display: none;"></asp:Label>--%>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <asp:Label ID="lblSadhyasisthPragatit" runat="server" Text="चालू" Style="display: none;"></asp:Label>--%>
                                                      ...
                                                      <%--  <asp:Label ID="lblSadhyasisthP1" runat="server" Text="प्रगतीत" Style="display: none;"></asp:Label>--%>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <asp:Label ID="lblSadhyasisthPurn" runat="server" Text="पूर्ण" Style="display: none;"></asp:Label>--%>
                                                        ...
                                                        <%--<asp:Label ID="lblSadhyasisthC1" runat="server" Text="पूर्ण" Style="display: none;"></asp:Label>--%>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <%--<asp:Label ID="lblSadhyasisthNOTS1" runat="server" Text="सुरू करणे" Style="display: none;"></asp:Label>--%>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
