...
{
    public partial class CostWiseReport : System.Web.UI.Page
    {
        int totalroad = 0;
        int totalNbard = 0;
        int totalbuild = 0;
        ...
        string StartCost = string.Empty;
        string EndCost = string.Empty;
        ...
        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            ...
            Session["filename"] = "CostWiseReport.xls";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                {
                    StreamWriter writer = File.AppendText(path + "CostWiseReport.xls");
        ...
        {
            //System.Threading.Thread.Sleep(5000);
            ViewState["WhereCond"] = " where a.Arthsankalpiyyear='" + ddlArthsankalpiyYear.SelectedItem.ToString() + "' and CONVERT(DECIMAL(20,2),b.[ManjurAmt])  between CONVERT(DECIMAL(20,2),'" + txtStastCost.Text.Trim() + "') and CONVERT(DECIMAL(20,2),'" + txtEndCost.Text.Trim() + "')  ";
