...
{
    public partial class Report_Lekhasirsh2515 : System.Web.UI.Page
    {
        ...
        public void subtype()
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select LekhaShirsh from SettingLekhaShirsh where Type='2515_GramVikas'", con);
        ...
        public void Upvibhag()
        {
            ...
            {
                sda = new SqlDataAdapter("select  Upvibhag FROM BudgetMaster2515 Group By Upvibhag", con);
            }

            else
            {
                sda = new SqlDataAdapter("select a.Upvibhag FROM [BudgetMaster2515] as a join [2515Provision] as b on a.Workid=b.Workid where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "'  and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'Group By Upvibhag", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void Shakhabhiyanta()
        {
            ...
            if (ddlReportType.Text == "संपूर्ण")
            {
                sda = new SqlDataAdapter("select  UpabhyantaName FROM BudgetMaster2515 Group By UpabhyantaName", con);
            }
            else
            {
                sda = new SqlDataAdapter("select a.UpabhyantaName FROM [BudgetMaster2515] as a join [2515Provision] as b on a.Workid=b.Workid where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'Group By UpabhyantaName", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void WorkId()
        {
            ...
            if (ddlReportType.Text == "संपूर्ण")
            {
                sda = new SqlDataAdapter("select WorkId FROM BudgetMaster2515 ", con);
            }
            else
            {
                sda = new SqlDataAdapter("select a.WorkId FROM [BudgetMaster2515] as a join [2515Provision] as b on a.Workid=b.Workid where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "'  and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void Tekedar()
        {
            ...
            if (ddlReportType.Text == "संपूर्ण")
            {
                sda = new SqlDataAdapter("select  ThekedaarName FROM BudgetMaster2515 Group By ThekedaarName", con);
            }
            else
            {
                sda = new SqlDataAdapter("select a.ThekedaarName FROM [BudgetMaster2515] as a join [2515Provision] as b on a.Workid=b.Workid where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "'  and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'Group By ThekedaarName", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void Sadyasthithi()
        {
            ...
            if (ddlReportType.Text == "संपूर्ण")
            {
                sda = new SqlDataAdapter("select Sadyasthiti FROM BudgetMaster2515 Group By Sadyasthiti", con);
            }

            else
            {

                sda = new SqlDataAdapter("select a.Sadyasthiti FROM [BudgetMaster2515] as a join [2515Provision] as b on a.Workid=b.Workid where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "'  and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'Group By Sadyasthiti", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void lekha()
        {
            SqlDataAdapter sda = new SqlDataAdapter("select lekhaShirsh from [BudgetMaster2515] where lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' ", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
        ...
        protected void BtnExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "GramVikas2515_MPR_Report.xls"));
        ...
        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            ...
            Session["filename"] = "GramVikas2515_MPR_Report.xls";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                {
                    StreamWriter writer = File.AppendText(path + "GramVikas2515_MPR_Report.xls");
