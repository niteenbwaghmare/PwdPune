<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterBudgetNonResidentialBuilding.aspx.cs" Inherits="PWdEEBudget.MasterBudgetNonResidentialBuilding" %>
     ...
     <table id="Print" class="table table-bordered mar" style="border:2px solid gray">
            ...
            <tr style="text-align:center; background:linear-gradient(gray,white)" >
                 <td style="font-weight: bold; color:black" colspan="30" >
                     <asp:Label ID="Label10" runat="server" Text="Master Budget Non Residential Building" Font-Bold="True" Font-Size="XX-Large" Height="70px"></asp:Label>
                 </td> 
           </tr>
            <tr>
                 ...
                 <td colspan="6" style="font-weight: bold; text-align:center; color :gray">
                     <asp:Label ID="ddlType" runat="server" class="blink_me" ForeColor="Red" Text ="Non-Residential Building"></asp:Label>
                 </td>
           </tr>
            ...
            <tr>
             ...
             <tr  style="background-color :#dbd7d7">
                 ...
                 <td style="font-weight: bold; color:gray;font-size :18px" colspan="3" ><asp:TextBox CssClass="form-control c" ID="txtPrakalpPassword" AutoPostBack="true" OnTextChanged="txtPrakalpPassword_TextChanged"  runat="server" TextMode="Password"></asp:TextBox></td>
               </tr>
               <tr>
               ...
               <tr>
                ...
                <tr  style="background-color :#dbd7d7">
                   ...
                   <td style="font-weight: bold; color:gray;font-size :18px" colspan="3" ><asp:TextBox ID="txtnividashakha" CssClass="form-control c" AutoPostBack="true" OnTextChanged="txtnividashakha_TextChanged" runat="server" TextMode="Password"></asp:TextBox></td>
                </tr>
                <tr>
