<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="MasterBudgetMLA.aspx.cs" Inherits="PWdEEBudget.MasterBudgetMLA" %>
     ...
     <table id="Print" class="table table-bordered mar" style="border:2px solid gray">
            ...
            <tr style="text-align:center; background:linear-gradient(gray,white);">
                 <td colspan="23" style="color:black">
                     <asp:Label ID="Label10" runat="server" Text="Master Budget MLA" Font-Bold="True" Height="70px" Font-Size="XX-Large"></asp:Label>
                 </td> 
           </tr>
            <tr>
                 <td>Work_ID</td> 
                 ...
                 <td colspan="4" style="text-align:center;">
                     <asp:Label ID="ddltype" runat="server" Text="MLA FUND"></asp:Label>
                 </td>
           </tr>
             <tr><td >जिल्हा </td>
                 <td colspan="4" >
            ...
            <tr>
             ...
             <tr  style="background-color :#dbd7d7">
                   ...
                   <td ><asp:TextBox ID="txtPrakalpPassword" AutoPostBack="true" OnTextChanged="txtPrakalpPassword_TextChanged" CssClass="form-control c" runat="server" TextMode="Password"></asp:TextBox></td>
               </tr>
               <tr>
                   <td>कामाचे नाव </td>
               ...
               <tr>
                ...
                <tr  style="background-color :#dbd7d7">
                   ...
                   <td ><asp:TextBox ID="txtnividashakha" AutoPostBack="true" OnTextChanged="txtnividashakha_TextChanged" CssClass="form-control c" runat="server" TextMode="Password"></asp:TextBox></td>
                </tr>
                <tr>
                   <td>ठेकेदाराचे नाव
                    </td>
