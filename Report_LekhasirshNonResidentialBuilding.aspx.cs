...
{
    public partial class Report_LekhasirshNonResidentialBuilding : System.Web.UI.Page
    {
        ...
        public void subtype()
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select LekhaShirsh from SettingLekhaShirsh where Type=' NonResidential_Building'", con);
        ...
        public void Upvibhag()
        {
            ...
            {
                sda = new SqlDataAdapter("select  Upvibhag FROM BudgetMasterNonResidentialBuilding Group By Upvibhag", con);
            }
            else
            {
                 sda = new SqlDataAdapter("select a.Upvibhag FROM BudgetMasterNonResidentialBuilding as a join NonResidentialBuildingProvision as b on a.Workid=b.Workid where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'Group By Upvibhag", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void Shakhabhiyanta()
        {
            ...
            if (ddlReportType.Text == "संपूर्ण")
            {
                sda = new SqlDataAdapter("select  UpabhyantaName FROM BudgetMasterNonResidentialBuilding Group By UpabhyantaName", con);
            }
            else
            {
                 sda = new SqlDataAdapter("select a.UpabhyantaName FROM BudgetMasterNonResidentialBuilding as a join NonResidentialBuildingProvision as b on a.Workid=b.Workid where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'Group By UpabhyantaName", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void WorkId()
        {
            ...
            if (ddlReportType.Text == "संपूर्ण")
            {
                sda = new SqlDataAdapter("select WorkId FROM BudgetMasterNonResidentialBuilding ", con);
            }
            else
            {
                sda = new SqlDataAdapter("select a.WorkId FROM BudgetMasterNonResidentialBuilding as a join NonResidentialBuildingProvision as b on a.Workid=b.Workid where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void Tekedar()
        {
            ...
            if (ddlReportType.Text == "संपूर्ण")
            {
                sda = new SqlDataAdapter("select  ThekedaarName FROM BudgetMasterNonResidentialBuilding Group By ThekedaarName", con);
            }
            else
            {
                sda = new SqlDataAdapter("select a.ThekedaarName FROM BudgetMasterNonResidentialBuilding as a join NonResidentialBuildingProvision as b on a.Workid=b.Workid where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "' Group By ThekedaarName", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void Sadyasthithi()
        {
            ...
            if (ddlReportType.Text == "संपूर्ण")
            {
                sda = new SqlDataAdapter("select Sadyasthiti FROM BudgetMasterNonResidentialBuilding Group By Sadyasthiti", con);
            }

            else
            {
               sda = new SqlDataAdapter("select a.Sadyasthiti FROM BudgetMasterNonResidentialBuilding as a join NonResidentialBuildingProvision as b on a.Workid=b.Workid where a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'Group By Sadyasthiti", con);
            }
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
        ...
        public void lekha()
        {
            SqlDataAdapter sda = new SqlDataAdapter("select lekhaShirsh from BudgetMasterNonResidentialBuilding where lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' ", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
        ...
        public void dataload()
        {
            ...
            if (Btnkam == "संपूर्ण")
            {
                ...
                if (ddlReportType.SelectedItem.Text == "संपूर्ण" || ddlkamacheYear.SelectedItem.Text == "संपूर्ण")
                {
                    ...
                    dt = ObjMPRGridBind.MPRBindGrid(ddlkamacheYear.Text, ddlReportType.Text, whereColumn, WhereColumnValue, query, "BudgetMasterNonResidentialBuilding");
                }
            }
            ...
            Session["LekhasirshNonResBuildingRpt"] = GridView1;
        }             
        ...
        protected void BtnExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "NonResBuilding_MPR_Report.xls"));
        ...
        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            ...
            Session["filename"] = "NonResBuilding_MPR_Report.xls";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                {
                    StreamWriter writer = File.AppendText(path + "NonResBuilding_MPR_Report.xls");
