<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="CostWiseReport.aspx.cs" Inherits="PWdEEBudget.CostWiseReport" %>
            ...
            <asp:Label ID="lblsadyProcess" runat="server" Text="Label" Visible="false"></asp:Label>
              ...
              <div id="ListMenu" class="container" style="margin-top: 10px;" runat="server">
                ...
                ErrorMessage="अर्थसंकल्पीय वर्ष निवडा!" InitialValue="Select" ForeColor="red"  Font-Size="Larger" Display="Dynamic" CssClass="blink_me" BackColor="Yellow"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td style="width: 30%">
                            <asp:Label ID="Label2" runat="server" Text="मंजूर अंदाजित किंमत :" Font-Bold="True" ForeColor="Black"></asp:Label>
                            <asp:Label ID="Label4" runat="server" Text="पासुन :" Font-Bold="True" ForeColor="Black" Style="    float: right;"></asp:Label>
                        </td>
                        <td style="width: 40%">
                            <asp:TextBox ID="txtStastCost" runat="server" TextMode="Number" CssClass="form-control p"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldStdate" runat="server" ControlToValidate="txtStastCost"
           ErrorMessage="मंजूर अंदाजित किंमत टाका..!"  ForeColor="red"   Display="Dynamic" CssClass="blink_me" BackColor="Yellow"></asp:RequiredFieldValidator>
                        </td>
                         </tr>
                        <tr>
                        <td style="width: 30%">
                         ...
                         <td style="width: 40%">
                            <asp:TextBox ID="txtEndCost" runat="server" TextMode="Number" CssClass="form-control p"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="RequiredFieldEndDate" runat="server" ControlToValidate="txtEndCost"
              ErrorMessage="मंजूर अंदाजित किंमत टाका..!" ForeColor="red" Display="Dynamic" CssClass="blink_me" BackColor="Yellow"></asp:RequiredFieldValidator>
                        </td>
                        <td style="width: 10%">
