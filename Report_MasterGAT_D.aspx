<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_MasterGAT_D.aspx.cs" Inherits="PWdEEBudget.Report_MasterGAT_D" %>
            ...
            <div style="width: 100%">
                ...
                <div id="Print" runat="server">
                    <div class="col-md-12" style="text-align: center; color: #443030">
                        <h3 style="font-size: 24px;">GAT_D Abstract Report</h3>
                    </div>
                            ...
                            <asp:GridView ID="GridView1" runat="server" RowStyle-VerticalAlign="Top" Width="100%" Caption='' EmptyDataText="No Record Found" AutoGenerateColumns="false" ShowHeader="true" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblUpvibhag" runat="server" Text='<%# Eval("Upvibhag") %>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <b>एकूण</b>
                                        </FooterTemplate>
