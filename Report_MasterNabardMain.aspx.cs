...
{
    public partial class Report_MasterNabardMain : System.Web.UI.Page
    {
        ...
        public void Upvibhag()
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select DISTINCT Upvibhag from BudgetMasterNABARD", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
        ...
        protected void BtnExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "Nabard_Abstract_Report.xls"));
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                ((Label)e.Row.FindControl("lblProvision3")).Text = "Budget Provision in " + ddlExpMonth.SelectedValue.ToString() + " " + ddlArthsankalpiyYear.SelectedValue.Substring(0, 7);
            ...
            //                Label lblC = (Label)e.Row.FindControl("lblC");
            //                Label lbllupvibhag = (Label)e.Row.FindControl("lbllupvibhag");
            //                SqlDataAdapter sda = new SqlDataAdapter("SELECT BR.Sadyasthiti,isnull(COUNT(BR.Sadyasthiti),0) as cnt22 from BudgetMasterNABARD as BR join NABARDProvision as RP on BR.WorkId=RP.WorkId WHERE BR.Upvibhag=N'" + lbllupvibhag.Text + "' AND BR.Type=N'Nabard'  AND BR.Sadyasthiti=N'Completed' group by BR.Sadyasthiti", con);
            //                DataTable dt = new DataTable();
            //                sda.Fill(dt);
            //                foreach (DataRow dr in dt.Rows)
            //                {
            ...
            //                Label lblP = (Label)e.Row.FindControl("lblP");
            //                Label lbllupvibhag = (Label)e.Row.FindControl("lbllupvibhag");
            //                SqlDataAdapter sda = new SqlDataAdapter("SELECT BR.Sadyasthiti,isnull(COUNT(BR.Sadyasthiti),0) as cnt23 from BudgetMasterNABARD as BR join NABARDProvision as RP on BR.WorkId=RP.WorkId WHERE BR.Upvibhag=N'" + lbllupvibhag.Text + "' AND BR.Type=N'Nabard'  AND BR.Sadyasthiti=N'Inprogress' group by BR.Sadyasthiti", con);
            //                DataTable dt = new DataTable();
            //                sda.Fill(dt);
            //                foreach (DataRow dr in dt.Rows)
            //                {
            ...
            //                Label lblNS = (Label)e.Row.FindControl("lblNS");
            //                Label lbllupvibhag = (Label)e.Row.FindControl("lbllupvibhag");
            //                SqlDataAdapter sda = new SqlDataAdapter("SELECT BR.Sadyasthiti,isnull(COUNT(BR.Sadyasthiti),0) as cnt24 from BudgetMasterNABARD as BR join NABARDProvision as RP on BR.WorkId=RP.WorkId WHERE BR.Upvibhag=N'" + lbllupvibhag.Text + "' AND BR.Type=N'Nabard'  AND BR.Sadyasthiti=N'Not Started' group by BR.Sadyasthiti", con);
            //                DataTable dt = new DataTable();
            //                sda.Fill(dt);
            //                foreach (DataRow dr in dt.Rows)
            //                {
            ...
            //                Label lblIncomplete = (Label)e.Row.FindControl("lblIncomplete");
            //                Label lbllupvibhag = (Label)e.Row.FindControl("lbllupvibhag");
            //                SqlDataAdapter sda = new SqlDataAdapter("SELECT BR.Sadyasthiti,isnull(COUNT(BR.Sadyasthiti),0) as cnt39 from BudgetMasterNABARD as BR join NABARDProvision as RP on BR.WorkId=RP.WorkId WHERE BR.Upvibhag=N'" + lbllupvibhag.Text + "' AND BR.Type=N'Nabard' AND BR.Sadyasthiti=N'Incomplete'  group by BR.Sadyasthiti", con);
            //                DataTable dt = new DataTable();
            //                sda.Fill(dt);
            //                foreach (DataRow dr in dt.Rows)
            //                {
            ...
            //                Label lblTenderStage = (Label)e.Row.FindControl("lblTenderStage");
            //                Label lbllupvibhag = (Label)e.Row.FindControl("lbllupvibhag");
            //                SqlDataAdapter sda = new SqlDataAdapter("SELECT BR.Sadyasthiti,isnull(COUNT(BR.Sadyasthiti),0) as cnt40 from BudgetMasterNABARD as BR join NABARDProvision as RP on BR.WorkId=RP.WorkId WHERE BR.Upvibhag=N'" + lbllupvibhag.Text + "' AND BR.Type=N'Nabard' AND BR.Sadyasthiti=N'Tender Stage'  group by BR.Sadyasthiti", con);
            //                DataTable dt = new DataTable();
            //                sda.Fill(dt);
            //                foreach (DataRow dr in dt.Rows)
            //                {
