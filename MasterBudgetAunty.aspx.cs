...
{
    public partial class MasterBudgetAunty : System.Web.UI.Page, IHttpHandler, IRequiresSessionState
    {
       ...
       static SqlQueryOrConnection ObjsqlQueryOrCon = new SqlQueryOrConnection();
        ...
        public void GetID()
        {
            ...
            {
                int i = 1;
                string select = "select top 1 Akrmank from BudgetMasterAunty order by Akrmank desc";
        ...
        public void auditdateset()
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select Arthsankalpiyyear from AuntyProvision where WorkID=N'" + txtWorkID.Text.Trim() + "'", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            if (dt.Rows.Count != 0)
            {
            ...
            {
                SqlDataAdapter sda1 = new SqlDataAdapter("select Arthsankalpiyyear from BudgetMasterAunty where WorkID=N'" + txtWorkID.Text.Trim() + "'", con);
        ...
        public void workidsearch()
        {
            try
            {
                ...
                DataTable dt = new DataTable();
                dt = ObjsqlQueryOrCon.Feach_Master_Data("Annuity", txtWorkID.Text.Trim());
        ...
        {
            return ObjsqlQueryOrCon.GetCompletionListOfWorkID(prefixText, "Annuity");
        }
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter("Select count(*) from AuntyProvision where Arthsankalpiyyear=N'" + AuditDate.Text.Trim() + "' and Workid=N'" + txtWorkID.Text.Trim() + "'", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
        ...
        {
            DataTable dt = new DataTable();
            dt = ObjsqlQueryOrCon.FeachProvisionData("Annuity", AuditDate.Text.Trim(), txtWorkID.Text.Trim());
        ...
        protected void BtnSav_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (conMDB.State != ConnectionState.Open)
                    conMDB.Open();
                SqlDataAdapter sda = new SqlDataAdapter("select Count(*) from BudgetMasterAunty WHERE WorkId='" + txtWorkID.Text.Trim() + "'", con);
                DataTable dt = new DataTable();
                sda.Fill(dt);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    if (cmd.ExecuteNonQuery() > 0 && cmdMDB.ExecuteNonQuery() > 0)
                    {
                        ...
                        message = "WorkId:" + txtWorkID.Text + " Type:2515_GramVikas Inserted Date:" + AddedDate + " Administratative-Date:" + txtprashaskiydinak.Text + " Work-Complition-Date:" + txtkampurndinak.Text + ". This work has been added into DBS Software in which your name has been mentioned.";
                        ...
                        else
                        {
                            ...
                            Server.Transfer("MasterBudgetAunty.aspx", false);
                        }
