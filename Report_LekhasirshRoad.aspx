<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.Master" AutoEventWireup="true" CodeBehind="Report_LekhasirshRoad.aspx.cs" Inherits="PWdEEBudget.Report_LekhasirshRoad" %>
                ...
                <div style="overflow: scroll;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AllowSorting="True" OnSorting="GridView1_Sorting" RowStyle-VerticalAlign="Top" Width="100%" Style="border: 2px solid" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound">
                        <Columns>
                            ...
                            <%--  <asp:BoundField DataField="SrNo" HeaderText="0" ItemStyle-Width ="5%">  </asp:BoundField>--%>
                            <asp:BoundField DataField="पेज क्र" HeaderText="1"></asp:BoundField>
                            <asp:BoundField DataField="बाब क्र" HeaderText="2"></asp:BoundField>
                            <asp:BoundField DataField="जुलै/ बाब क्र./पान क्र." HeaderText="3"></asp:BoundField>
                            <asp:BoundField DataField="कामाचे नाव" HeaderText="3"></asp:BoundField>
                            <asp:BoundField DataField="ManjurAmt" HeaderText="4"></asp:BoundField>
                            <asp:BoundField DataField="MarchEndingExpn" HeaderText="5"></asp:BoundField>
                            <asp:BoundField DataField="UrvaritAmt" HeaderText="6"></asp:BoundField>
                            <asp:BoundField DataField="Takunone" HeaderText="7"></asp:BoundField>
                            <asp:BoundField DataField="Takuntwo" HeaderText="8"></asp:BoundField>
                            ...
                            <asp:BoundField DataField="Magilkharch" HeaderText="11"></asp:BoundField>
                            <asp:BoundField DataField="Magni" HeaderText="12"></asp:BoundField>
                            <asp:BoundField DataField="C" HeaderText="13"></asp:BoundField>
                            <asp:BoundField DataField="P" HeaderText="14"></asp:BoundField>
                            <asp:BoundField DataField="NS" HeaderText="15"></asp:BoundField>
                            <asp:BoundField DataField="शेरा" HeaderText="16"></asp:BoundField>
                            <asp:BoundField HeaderText="17"></asp:BoundField>
