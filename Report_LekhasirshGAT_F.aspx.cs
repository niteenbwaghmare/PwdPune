...
{
    public partial class Report_LekhasirshGAT_F : System.Web.UI.Page
    {
        ...
        public void dataload()
        {
            ...
            Session["LekhasirshGAT_FRpt"] = GridView1;
        ...
        protected void BtnExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "GatF_MPR_Report.xls"));
        ...
        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            ...
            Session["filename"] = "GatF_MPR_Report.xls";
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                {
                    StreamWriter writer = File.AppendText(path + "GatF_MPR_Report.xls");
        ...
        public void Upvibhag()
        {
            ...
            ddlist = ddlReportType.Text == "संपूर्ण" ? "select Upvibhag FROM BudgetMasterGAT_FBC  Group By Upvibhag" : "select a.Upvibhag FROM BudgetMasterGAT_FBC as a join GAT_FBCProvision as b on a.WorkID=b.WorkID where a.[Type]=N'गट एफ' and a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "' Group By a.Upvibhag";
        ...
        public void Shakhabhiyanta()
        {
            ...
            ddlist = ddlReportType.Text == "संपूर्ण" ? "select  UpabhyantaName FROM BudgetMasterGAT_FBC  Group By UpabhyantaName" : "select a.UpabhyantaName FROM BudgetMasterGAT_FBC as a join GAT_FBCProvision as b on a.WorkID=b.WorkID where a.[Type]=N'गट एफ' and a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "' Group By a.UpabhyantaName";
            SqlDataAdapter sda = new SqlDataAdapter(ddlist, con);
            //SqlDataAdapter sda = new SqlDataAdapter("select UpabhyantaName from BudgetMasterGAT_FBC where [Type]=N'गट एफ' and  lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' Group By ShakhaAbhyantaName", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
        ...
        public void WorkId()
        {
            ...
            ddlist = ddlReportType.Text == "संपूर्ण" ? "select WorkId FROM BudgetMasterGAT_FBC" : "select a.WorkId FROM BudgetMasterGAT_FBC as a join GAT_FBCProvision as b on a.WorkID=b.WorkID where a.[Type]=N'गट एफ' and a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "'";
            SqlDataAdapter sda = new SqlDataAdapter(ddlist, con);
           // SqlDataAdapter sda = new SqlDataAdapter("select WorkId from BudgetMasterGAT_FBC where [Type]=N'गट एफ' and  lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' Group By WorkId", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
        ...
        public void Tekedar()
        {
            ...
            ddlist = ddlReportType.Text == "संपूर्ण" ? "select ThekedaarName FROM BudgetMasterGAT_FBC Group By ThekedaarName" : "select a.ThekedaarName FROM BudgetMasterGAT_FBC as a join GAT_FBCProvision as b on a.WorkID=b.WorkID where a.[Type]=N'गट एफ' and a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "' Group By a.ThekedaarName";
            SqlDataAdapter sda = new SqlDataAdapter(ddlist, con);
           // SqlDataAdapter sda = new SqlDataAdapter("select ThekedaarName from BudgetMasterGAT_FBC where [Type]=N'गट एफ' and  lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' Group By ThekedaarName", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
        ...
        public void Sadyasthithi()
        {
            ...
            ddlist = ddlReportType.Text == "संपूर्ण" ? "select  Sadyasthiti FROM BudgetMasterGAT_FBC  Group By Sadyasthiti" : "select a.Sadyasthiti FROM BudgetMasterGAT_FBC as a join GAT_FBCProvision as b on a.WorkID=b.WorkID where a.[Type]=N'गट एफ' and a.lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' and b.Arthsankalpiyyear='" + ddlArthYear.SelectedItem.Text + "' Group By a.Sadyasthiti";
            SqlDataAdapter sda = new SqlDataAdapter(ddlist, con);
            //SqlDataAdapter sda = new SqlDataAdapter("select Sadyasthiti from BudgetMasterGAT_FBC where [Type]=N'गट एफ' and  lekhashirshName=N'" + ddlReportType.SelectedItem.Text + "' Group By Sadyasthiti", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
